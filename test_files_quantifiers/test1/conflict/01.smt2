...
(assert (exists ((B_time_Int_23 Int) (Measure_time_Int_24 Int) (Measure_m1_Int_25 Int)) (and (= B_time_Int_23 Measure_time_Int_24) (and (set.member (tuple Measure_time_Int_24 Measure_m1_Int_25) Measure) (set.member (tuple B_time_Int_23) B)))))
