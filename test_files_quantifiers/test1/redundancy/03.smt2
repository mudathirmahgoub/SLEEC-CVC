...
(assert (exists ((A_time_Int_53 Int)) (and (exists ((Measure_time_Int_54 Int) (Measure_m1_Int_55 Int)) (and (and (not (not (exists ((C_time_Int_56 Int)) (and (and (>= C_time_Int_56 (+ A_time_Int_53 0)) (<= C_time_Int_56 (+ A_time_Int_53 11))) (set.member (tuple C_time_Int_56) C))))) (= A_time_Int_53 Measure_time_Int_54)) (set.member (tuple Measure_time_Int_54 Measure_m1_Int_55) Measure))) (set.member (tuple A_time_Int_53) A))))
