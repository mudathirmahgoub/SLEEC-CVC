...
(assert (exists ((UserFallen_time_Int_260 Int)) (and (exists ((Measure_time_Int_261 Int) (Measure_userUnderDressed_Bool_94 Bool) (Measure_roomTemperature_Int_262 Int) (Measure_assentToSupportCalls_Bool_95 Bool) (Measure_userDistressed_Int_263 Int)) (and (and (and (not (exists ((not_SupportCalled_start_time_Int_265 Int) (not_SupportCalled_end_time_Int_266 Int)) (and (and (= not_SupportCalled_end_time_Int_266 (+ UserFallen_time_Int_260 120)) (= not_SupportCalled_start_time_Int_265 (+ UserFallen_time_Int_260 0))) (set.member (tuple not_SupportCalled_start_time_Int_265 not_SupportCalled_end_time_Int_266) not_SupportCalled)))) Measure_assentToSupportCalls_Bool_95) (= UserFallen_time_Int_260 Measure_time_Int_261)) (set.member (tuple Measure_time_Int_261 Measure_userUnderDressed_Bool_94 Measure_roomTemperature_Int_262 Measure_assentToSupportCalls_Bool_95 Measure_userDistressed_Int_263) Measure))) (set.member (tuple UserFallen_time_Int_260) UserFallen))))
...
(assert (=> (exists ((DressingStarted_time_Int_296 Int)) (and true (set.member (tuple DressingStarted_time_Int_296) DressingStarted))) (and (exists ((DressingStarted_time_Int_299 Int)) (and (forall ((DressingStarted_time_Int_300 Int)) (=> (set.member (tuple DressingStarted_time_Int_300) DressingStarted) (<= DressingStarted_time_Int_300 DressingStarted_time_Int_299))) (set.member (tuple DressingStarted_time_Int_299) DressingStarted))) (exists ((DressingStarted_time_Int_297 Int)) (and (forall ((DressingStarted_time_Int_298 Int)) (=> (set.member (tuple DressingStarted_time_Int_298) DressingStarted) (>= DressingStarted_time_Int_298 DressingStarted_time_Int_297))) (set.member (tuple DressingStarted_time_Int_297) DressingStarted))))))
(assert (=> (exists ((DressingComplete_time_Int_301 Int)) (and true (set.member (tuple DressingComplete_time_Int_301) DressingComplete))) (and (exists ((DressingComplete_time_Int_304 Int)) (and (forall ((DressingComplete_time_Int_305 Int)) (=> (set.member (tuple DressingComplete_time_Int_305) DressingComplete) (<= DressingComplete_time_Int_305 DressingComplete_time_Int_304))) (set.member (tuple DressingComplete_time_Int_304) DressingComplete))) (exists ((DressingComplete_time_Int_302 Int)) (and (forall ((DressingComplete_time_Int_303 Int)) (=> (set.member (tuple DressingComplete_time_Int_303) DressingComplete) (>= DressingComplete_time_Int_303 DressingComplete_time_Int_302))) (set.member (tuple DressingComplete_time_Int_302) DressingComplete))))))
(assert (=> (exists ((DressingAbandoned_time_Int_306 Int)) (and true (set.member (tuple DressingAbandoned_time_Int_306) DressingAbandoned))) (and (exists ((DressingAbandoned_time_Int_309 Int)) (and (forall ((DressingAbandoned_time_Int_310 Int)) (=> (set.member (tuple DressingAbandoned_time_Int_310) DressingAbandoned) (<= DressingAbandoned_time_Int_310 DressingAbandoned_time_Int_309))) (set.member (tuple DressingAbandoned_time_Int_309) DressingAbandoned))) (exists ((DressingAbandoned_time_Int_307 Int)) (and (forall ((DressingAbandoned_time_Int_308 Int)) (=> (set.member (tuple DressingAbandoned_time_Int_308) DressingAbandoned) (>= DressingAbandoned_time_Int_308 DressingAbandoned_time_Int_307))) (set.member (tuple DressingAbandoned_time_Int_307) DressingAbandoned))))))
(assert (=> (exists ((CurtainOpenRqt_time_Int_311 Int)) (and true (set.member (tuple CurtainOpenRqt_time_Int_311) CurtainOpenRqt))) (and (exists ((CurtainOpenRqt_time_Int_314 Int)) (and (forall ((CurtainOpenRqt_time_Int_315 Int)) (=> (set.member (tuple CurtainOpenRqt_time_Int_315) CurtainOpenRqt) (<= CurtainOpenRqt_time_Int_315 CurtainOpenRqt_time_Int_314))) (set.member (tuple CurtainOpenRqt_time_Int_314) CurtainOpenRqt))) (exists ((CurtainOpenRqt_time_Int_312 Int)) (and (forall ((CurtainOpenRqt_time_Int_313 Int)) (=> (set.member (tuple CurtainOpenRqt_time_Int_313) CurtainOpenRqt) (>= CurtainOpenRqt_time_Int_313 CurtainOpenRqt_time_Int_312))) (set.member (tuple CurtainOpenRqt_time_Int_312) CurtainOpenRqt))))))
(assert (=> (exists ((CurtainsOpened_time_Int_316 Int)) (and true (set.member (tuple CurtainsOpened_time_Int_316) CurtainsOpened))) (and (exists ((CurtainsOpened_time_Int_319 Int)) (and (forall ((CurtainsOpened_time_Int_320 Int)) (=> (set.member (tuple CurtainsOpened_time_Int_320) CurtainsOpened) (<= CurtainsOpened_time_Int_320 CurtainsOpened_time_Int_319))) (set.member (tuple CurtainsOpened_time_Int_319) CurtainsOpened))) (exists ((CurtainsOpened_time_Int_317 Int)) (and (forall ((CurtainsOpened_time_Int_318 Int)) (=> (set.member (tuple CurtainsOpened_time_Int_318) CurtainsOpened) (>= CurtainsOpened_time_Int_318 CurtainsOpened_time_Int_317))) (set.member (tuple CurtainsOpened_time_Int_317) CurtainsOpened))))))
(assert (=> (exists ((RefuseRequest_time_Int_321 Int)) (and true (set.member (tuple RefuseRequest_time_Int_321) RefuseRequest))) (and (exists ((RefuseRequest_time_Int_324 Int)) (and (forall ((RefuseRequest_time_Int_325 Int)) (=> (set.member (tuple RefuseRequest_time_Int_325) RefuseRequest) (<= RefuseRequest_time_Int_325 RefuseRequest_time_Int_324))) (set.member (tuple RefuseRequest_time_Int_324) RefuseRequest))) (exists ((RefuseRequest_time_Int_322 Int)) (and (forall ((RefuseRequest_time_Int_323 Int)) (=> (set.member (tuple RefuseRequest_time_Int_323) RefuseRequest) (>= RefuseRequest_time_Int_323 RefuseRequest_time_Int_322))) (set.member (tuple RefuseRequest_time_Int_322) RefuseRequest))))))
(assert (=> (exists ((UserFallen_time_Int_326 Int)) (and true (set.member (tuple UserFallen_time_Int_326) UserFallen))) (and (exists ((UserFallen_time_Int_329 Int)) (and (forall ((UserFallen_time_Int_330 Int)) (=> (set.member (tuple UserFallen_time_Int_330) UserFallen) (<= UserFallen_time_Int_330 UserFallen_time_Int_329))) (set.member (tuple UserFallen_time_Int_329) UserFallen))) (exists ((UserFallen_time_Int_327 Int)) (and (forall ((UserFallen_time_Int_328 Int)) (=> (set.member (tuple UserFallen_time_Int_328) UserFallen) (>= UserFallen_time_Int_328 UserFallen_time_Int_327))) (set.member (tuple UserFallen_time_Int_327) UserFallen))))))
(assert (=> (exists ((SupportCalled_time_Int_331 Int)) (and true (set.member (tuple SupportCalled_time_Int_331) SupportCalled))) (and (exists ((SupportCalled_time_Int_334 Int)) (and (forall ((SupportCalled_time_Int_335 Int)) (=> (set.member (tuple SupportCalled_time_Int_335) SupportCalled) (<= SupportCalled_time_Int_335 SupportCalled_time_Int_334))) (set.member (tuple SupportCalled_time_Int_334) SupportCalled))) (exists ((SupportCalled_time_Int_332 Int)) (and (forall ((SupportCalled_time_Int_333 Int)) (=> (set.member (tuple SupportCalled_time_Int_333) SupportCalled) (>= SupportCalled_time_Int_333 SupportCalled_time_Int_332))) (set.member (tuple SupportCalled_time_Int_332) SupportCalled))))))
(assert (=> (exists ((RetryAgreed_time_Int_336 Int)) (and true (set.member (tuple RetryAgreed_time_Int_336) RetryAgreed))) (and (exists ((RetryAgreed_time_Int_339 Int)) (and (forall ((RetryAgreed_time_Int_340 Int)) (=> (set.member (tuple RetryAgreed_time_Int_340) RetryAgreed) (<= RetryAgreed_time_Int_340 RetryAgreed_time_Int_339))) (set.member (tuple RetryAgreed_time_Int_339) RetryAgreed))) (exists ((RetryAgreed_time_Int_337 Int)) (and (forall ((RetryAgreed_time_Int_338 Int)) (=> (set.member (tuple RetryAgreed_time_Int_338) RetryAgreed) (>= RetryAgreed_time_Int_338 RetryAgreed_time_Int_337))) (set.member (tuple RetryAgreed_time_Int_337) RetryAgreed))))))
