...
(assert (exists ((DressingStarted_time_Int_231 Int)) (and (exists ((Measure_time_Int_232 Int) (Measure_userUnderDressed_Bool_82 Bool) (Measure_roomTemperature_Int_233 Int) (Measure_assentToSupportCalls_Bool_83 Bool) (Measure_userDistressed_Int_234 Int)) (and (and (and (not (or (exists ((DressingComplete_time_Int_236 Int)) (and (and (>= DressingComplete_time_Int_236 (+ DressingStarted_time_Int_231 0)) (<= DressingComplete_time_Int_236 (+ DressingStarted_time_Int_231 60))) (set.member (tuple DressingComplete_time_Int_236) DressingComplete))) (exists ((DressingAbandoned_time_Int_235 Int)) (and (and (>= DressingAbandoned_time_Int_235 (+ DressingStarted_time_Int_231 0)) (<= DressingAbandoned_time_Int_235 (+ DressingStarted_time_Int_231 120))) (set.member (tuple DressingAbandoned_time_Int_235) DressingAbandoned))))) (or Measure_userUnderDressed_Bool_82 (< Measure_roomTemperature_Int_233 16))) (= DressingStarted_time_Int_231 Measure_time_Int_232)) (set.member (tuple Measure_time_Int_232 Measure_userUnderDressed_Bool_82 Measure_roomTemperature_Int_233 Measure_assentToSupportCalls_Bool_83 Measure_userDistressed_Int_234) Measure))) (set.member (tuple DressingStarted_time_Int_231) DressingStarted))))
