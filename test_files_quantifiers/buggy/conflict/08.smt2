...
(assert (exists ((UserFallen_time_Int_193 Int) (Measure_time_Int_194 Int) (Measure_userUnderDressed_Bool_68 Bool) (Measure_roomTemperature_Int_195 Int) (Measure_assentToSupportCalls_Bool_69 Bool) (Measure_userDistressed_Int_196 Int)) (and (= UserFallen_time_Int_193 Measure_time_Int_194) (and (set.member (tuple Measure_time_Int_194 Measure_userUnderDressed_Bool_68 Measure_roomTemperature_Int_195 Measure_assentToSupportCalls_Bool_69 Measure_userDistressed_Int_196) Measure) (set.member (tuple UserFallen_time_Int_193) UserFallen)))))
