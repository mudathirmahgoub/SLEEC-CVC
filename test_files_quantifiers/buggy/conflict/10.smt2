...
(assert (exists ((DressingStarted_time_Int_237 Int) (Measure_time_Int_238 Int) (Measure_userUnderDressed_Bool_84 Bool) (Measure_roomTemperature_Int_239 Int) (Measure_assentToSupportCalls_Bool_85 Bool) (Measure_userDistressed_Int_240 Int)) (and (and (or Measure_userUnderDressed_Bool_84 (< Measure_roomTemperature_Int_239 16)) (= DressingStarted_time_Int_237 Measure_time_Int_238)) (and (set.member (tuple Measure_time_Int_238 Measure_userUnderDressed_Bool_84 Measure_roomTemperature_Int_239 Measure_assentToSupportCalls_Bool_85 Measure_userDistressed_Int_240) Measure) (set.member (tuple DressingStarted_time_Int_237) DressingStarted)))))
...
(assert (and (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_9 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_9) ((_ tuple.select 2) tuple_9)) (<= ((_ tuple.select 1) tuple_9) ((_ tuple.select 0) tuple_9)))))) (rel.product RetryAgreed not_RetryAgreed))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_8 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_8) ((_ tuple.select 2) tuple_8)) (<= ((_ tuple.select 1) tuple_8) ((_ tuple.select 0) tuple_8)))))) (rel.product SupportCalled not_SupportCalled))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_7 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_7) ((_ tuple.select 2) tuple_7)) (<= ((_ tuple.select 1) tuple_7) ((_ tuple.select 0) tuple_7)))))) (rel.product UserFallen not_UserFallen))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_6 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_6) ((_ tuple.select 2) tuple_6)) (<= ((_ tuple.select 1) tuple_6) ((_ tuple.select 0) tuple_6)))))) (rel.product RefuseRequest not_RefuseRequest))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_5 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_5) ((_ tuple.select 2) tuple_5)) (<= ((_ tuple.select 1) tuple_5) ((_ tuple.select 0) tuple_5)))))) (rel.product CurtainsOpened not_CurtainsOpened))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_4 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_4) ((_ tuple.select 2) tuple_4)) (<= ((_ tuple.select 1) tuple_4) ((_ tuple.select 0) tuple_4)))))) (rel.product CurtainOpenRqt not_CurtainOpenRqt))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_3 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_3) ((_ tuple.select 2) tuple_3)) (<= ((_ tuple.select 1) tuple_3) ((_ tuple.select 0) tuple_3)))))) (rel.product DressingAbandoned not_DressingAbandoned))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_2 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_2) ((_ tuple.select 2) tuple_2)) (<= ((_ tuple.select 1) tuple_2) ((_ tuple.select 0) tuple_2)))))) (rel.product DressingComplete not_DressingComplete))) (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_1 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_1) ((_ tuple.select 2) tuple_1)) (<= ((_ tuple.select 1) tuple_1) ((_ tuple.select 0) tuple_1)))))) (rel.product DressingStarted not_DressingStarted))))))))))) (forall ((Measure_time_Int_326 Int) (Measure_userUnderDressed_Bool_106 Bool) (Measure_roomTemperature_Int_327 Int) (Measure_assentToSupportCalls_Bool_107 Bool) (Measure_userDistressed_Int_328 Int) (Measure_time_Int_329 Int) (Measure_userUnderDressed_Bool_108 Bool) (Measure_roomTemperature_Int_330 Int) (Measure_assentToSupportCalls_Bool_109 Bool) (Measure_userDistressed_Int_331 Int)) (=> (and (set.member (tuple Measure_time_Int_329 Measure_userUnderDressed_Bool_108 Measure_roomTemperature_Int_330 Measure_assentToSupportCalls_Bool_109 Measure_userDistressed_Int_331) Measure) (set.member (tuple Measure_time_Int_326 Measure_userUnderDressed_Bool_106 Measure_roomTemperature_Int_327 Measure_assentToSupportCalls_Bool_107 Measure_userDistressed_Int_328) Measure)) (=> (= Measure_time_Int_326 Measure_time_Int_329) (and (= Measure_userDistressed_Int_328 Measure_userDistressed_Int_331) (and (= Measure_assentToSupportCalls_Bool_107 Measure_assentToSupportCalls_Bool_109) (and (= Measure_roomTemperature_Int_327 Measure_roomTemperature_Int_330) (and (= Measure_userUnderDressed_Bool_106 Measure_userUnderDressed_Bool_108) (= Measure_time_Int_326 Measure_time_Int_329))))))))))
(assert (forall ((DressingStarted_time_Int_290 Int)) (=> (set.member (tuple DressingStarted_time_Int_290) DressingStarted) (or (exists ((DressingStarted_time_Int_292 Int)) (and (and (forall ((DressingStarted_time_Int_293 Int)) (=> (set.member (tuple DressingStarted_time_Int_293) DressingStarted) (<= DressingStarted_time_Int_293 DressingStarted_time_Int_290))) (> DressingStarted_time_Int_292 DressingStarted_time_Int_290)) (set.member (tuple DressingStarted_time_Int_292) DressingStarted))) (forall ((DressingStarted_time_Int_291 Int)) (=> (set.member (tuple DressingStarted_time_Int_291) DressingStarted) (<= DressingStarted_time_Int_291 DressingStarted_time_Int_290)))))))
(assert (forall ((DressingComplete_time_Int_294 Int)) (=> (set.member (tuple DressingComplete_time_Int_294) DressingComplete) (or (exists ((DressingComplete_time_Int_296 Int)) (and (and (forall ((DressingComplete_time_Int_297 Int)) (=> (set.member (tuple DressingComplete_time_Int_297) DressingComplete) (<= DressingComplete_time_Int_297 DressingComplete_time_Int_294))) (> DressingComplete_time_Int_296 DressingComplete_time_Int_294)) (set.member (tuple DressingComplete_time_Int_296) DressingComplete))) (forall ((DressingComplete_time_Int_295 Int)) (=> (set.member (tuple DressingComplete_time_Int_295) DressingComplete) (<= DressingComplete_time_Int_295 DressingComplete_time_Int_294)))))))
(assert (forall ((DressingAbandoned_time_Int_298 Int)) (=> (set.member (tuple DressingAbandoned_time_Int_298) DressingAbandoned) (or (exists ((DressingAbandoned_time_Int_300 Int)) (and (and (forall ((DressingAbandoned_time_Int_301 Int)) (=> (set.member (tuple DressingAbandoned_time_Int_301) DressingAbandoned) (<= DressingAbandoned_time_Int_301 DressingAbandoned_time_Int_298))) (> DressingAbandoned_time_Int_300 DressingAbandoned_time_Int_298)) (set.member (tuple DressingAbandoned_time_Int_300) DressingAbandoned))) (forall ((DressingAbandoned_time_Int_299 Int)) (=> (set.member (tuple DressingAbandoned_time_Int_299) DressingAbandoned) (<= DressingAbandoned_time_Int_299 DressingAbandoned_time_Int_298)))))))
(assert (forall ((CurtainOpenRqt_time_Int_302 Int)) (=> (set.member (tuple CurtainOpenRqt_time_Int_302) CurtainOpenRqt) (or (exists ((CurtainOpenRqt_time_Int_304 Int)) (and (and (forall ((CurtainOpenRqt_time_Int_305 Int)) (=> (set.member (tuple CurtainOpenRqt_time_Int_305) CurtainOpenRqt) (<= CurtainOpenRqt_time_Int_305 CurtainOpenRqt_time_Int_302))) (> CurtainOpenRqt_time_Int_304 CurtainOpenRqt_time_Int_302)) (set.member (tuple CurtainOpenRqt_time_Int_304) CurtainOpenRqt))) (forall ((CurtainOpenRqt_time_Int_303 Int)) (=> (set.member (tuple CurtainOpenRqt_time_Int_303) CurtainOpenRqt) (<= CurtainOpenRqt_time_Int_303 CurtainOpenRqt_time_Int_302)))))))
(assert (forall ((CurtainsOpened_time_Int_306 Int)) (=> (set.member (tuple CurtainsOpened_time_Int_306) CurtainsOpened) (or (exists ((CurtainsOpened_time_Int_308 Int)) (and (and (forall ((CurtainsOpened_time_Int_309 Int)) (=> (set.member (tuple CurtainsOpened_time_Int_309) CurtainsOpened) (<= CurtainsOpened_time_Int_309 CurtainsOpened_time_Int_306))) (> CurtainsOpened_time_Int_308 CurtainsOpened_time_Int_306)) (set.member (tuple CurtainsOpened_time_Int_308) CurtainsOpened))) (forall ((CurtainsOpened_time_Int_307 Int)) (=> (set.member (tuple CurtainsOpened_time_Int_307) CurtainsOpened) (<= CurtainsOpened_time_Int_307 CurtainsOpened_time_Int_306)))))))
(assert (forall ((RefuseRequest_time_Int_310 Int)) (=> (set.member (tuple RefuseRequest_time_Int_310) RefuseRequest) (or (exists ((RefuseRequest_time_Int_312 Int)) (and (and (forall ((RefuseRequest_time_Int_313 Int)) (=> (set.member (tuple RefuseRequest_time_Int_313) RefuseRequest) (<= RefuseRequest_time_Int_313 RefuseRequest_time_Int_310))) (> RefuseRequest_time_Int_312 RefuseRequest_time_Int_310)) (set.member (tuple RefuseRequest_time_Int_312) RefuseRequest))) (forall ((RefuseRequest_time_Int_311 Int)) (=> (set.member (tuple RefuseRequest_time_Int_311) RefuseRequest) (<= RefuseRequest_time_Int_311 RefuseRequest_time_Int_310)))))))
(assert (forall ((UserFallen_time_Int_314 Int)) (=> (set.member (tuple UserFallen_time_Int_314) UserFallen) (or (exists ((UserFallen_time_Int_316 Int)) (and (and (forall ((UserFallen_time_Int_317 Int)) (=> (set.member (tuple UserFallen_time_Int_317) UserFallen) (<= UserFallen_time_Int_317 UserFallen_time_Int_314))) (> UserFallen_time_Int_316 UserFallen_time_Int_314)) (set.member (tuple UserFallen_time_Int_316) UserFallen))) (forall ((UserFallen_time_Int_315 Int)) (=> (set.member (tuple UserFallen_time_Int_315) UserFallen) (<= UserFallen_time_Int_315 UserFallen_time_Int_314)))))))
(assert (forall ((SupportCalled_time_Int_318 Int)) (=> (set.member (tuple SupportCalled_time_Int_318) SupportCalled) (or (exists ((SupportCalled_time_Int_320 Int)) (and (and (forall ((SupportCalled_time_Int_321 Int)) (=> (set.member (tuple SupportCalled_time_Int_321) SupportCalled) (<= SupportCalled_time_Int_321 SupportCalled_time_Int_318))) (> SupportCalled_time_Int_320 SupportCalled_time_Int_318)) (set.member (tuple SupportCalled_time_Int_320) SupportCalled))) (forall ((SupportCalled_time_Int_319 Int)) (=> (set.member (tuple SupportCalled_time_Int_319) SupportCalled) (<= SupportCalled_time_Int_319 SupportCalled_time_Int_318)))))))
(assert (forall ((RetryAgreed_time_Int_322 Int)) (=> (set.member (tuple RetryAgreed_time_Int_322) RetryAgreed) (or (exists ((RetryAgreed_time_Int_324 Int)) (and (and (forall ((RetryAgreed_time_Int_325 Int)) (=> (set.member (tuple RetryAgreed_time_Int_325) RetryAgreed) (<= RetryAgreed_time_Int_325 RetryAgreed_time_Int_322))) (> RetryAgreed_time_Int_324 RetryAgreed_time_Int_322)) (set.member (tuple RetryAgreed_time_Int_324) RetryAgreed))) (forall ((RetryAgreed_time_Int_323 Int)) (=> (set.member (tuple RetryAgreed_time_Int_323) RetryAgreed) (<= RetryAgreed_time_Int_323 RetryAgreed_time_Int_322)))))))
