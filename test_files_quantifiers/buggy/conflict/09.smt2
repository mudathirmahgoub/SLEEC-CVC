...
(assert (exists ((DressingAbandoned_time_Int_218 Int) (Measure_time_Int_219 Int) (Measure_userUnderDressed_Bool_78 Bool) (Measure_roomTemperature_Int_220 Int) (Measure_assentToSupportCalls_Bool_79 Bool) (Measure_userDistressed_Int_221 Int)) (and (= DressingAbandoned_time_Int_218 Measure_time_Int_219) (and (set.member (tuple Measure_time_Int_219 Measure_userUnderDressed_Bool_78 Measure_roomTemperature_Int_220 Measure_assentToSupportCalls_Bool_79 Measure_userDistressed_Int_221) Measure) (set.member (tuple DressingAbandoned_time_Int_218) DressingAbandoned)))))
