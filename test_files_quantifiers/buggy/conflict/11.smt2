...
(assert (exists ((UserFallen_time_Int_267 Int) (Measure_time_Int_268 Int) (Measure_userUnderDressed_Bool_96 Bool) (Measure_roomTemperature_Int_269 Int) (Measure_assentToSupportCalls_Bool_97 Bool) (Measure_userDistressed_Int_270 Int)) (and (and Measure_assentToSupportCalls_Bool_97 (= UserFallen_time_Int_267 Measure_time_Int_268)) (and (set.member (tuple Measure_time_Int_268 Measure_userUnderDressed_Bool_96 Measure_roomTemperature_Int_269 Measure_assentToSupportCalls_Bool_97 Measure_userDistressed_Int_270) Measure) (set.member (tuple UserFallen_time_Int_267) UserFallen)))))
