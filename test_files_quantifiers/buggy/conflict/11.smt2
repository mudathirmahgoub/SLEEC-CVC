...
(assert (exists ((UserFallen_time_Int_263 Int) (Measure_time_Int_264 Int) (Measure_userUnderDressed_Bool_96 Bool) (Measure_roomTemperature_Int_265 Int) (Measure_assentToSupportCalls_Bool_97 Bool) (Measure_userDistressed_Int_266 Int)) (and (and Measure_assentToSupportCalls_Bool_97 (= UserFallen_time_Int_263 Measure_time_Int_264)) (and (set.member (tuple Measure_time_Int_264 Measure_userUnderDressed_Bool_96 Measure_roomTemperature_Int_265 Measure_assentToSupportCalls_Bool_97 Measure_userDistressed_Int_266) Measure) (set.member (tuple UserFallen_time_Int_263) UserFallen)))))
...
(assert (forall ((UserFallen_time_Int_253 Int)) (=> (set.member (tuple UserFallen_time_Int_253) UserFallen) (exists ((Measure_time_Int_254 Int) (Measure_userUnderDressed_Bool_92 Bool) (Measure_roomTemperature_Int_255 Int) (Measure_assentToSupportCalls_Bool_93 Bool) (Measure_userDistressed_Int_256 Int)) (and (and (or (not (exists ((SupportCalled_time_Int_257 Int)) (and (and (>= SupportCalled_time_Int_257 (+ UserFallen_time_Int_253 0)) (<= SupportCalled_time_Int_257 (+ UserFallen_time_Int_253 120))) (set.member (tuple SupportCalled_time_Int_257) SupportCalled)))) (not Measure_assentToSupportCalls_Bool_93)) (= UserFallen_time_Int_253 Measure_time_Int_254)) (set.member (tuple Measure_time_Int_254 Measure_userUnderDressed_Bool_92 Measure_roomTemperature_Int_255 Measure_assentToSupportCalls_Bool_93 Measure_userDistressed_Int_256) Measure))))))
(assert (forall ((Measure_time_Int_329 Int) (Measure_userUnderDressed_Bool_106 Bool) (Measure_roomTemperature_Int_330 Int) (Measure_assentToSupportCalls_Bool_107 Bool) (Measure_userDistressed_Int_331 Int) (Measure_time_Int_332 Int) (Measure_userUnderDressed_Bool_108 Bool) (Measure_roomTemperature_Int_333 Int) (Measure_assentToSupportCalls_Bool_109 Bool) (Measure_userDistressed_Int_334 Int)) (=> (and (set.member (tuple Measure_time_Int_332 Measure_userUnderDressed_Bool_108 Measure_roomTemperature_Int_333 Measure_assentToSupportCalls_Bool_109 Measure_userDistressed_Int_334) Measure) (set.member (tuple Measure_time_Int_329 Measure_userUnderDressed_Bool_106 Measure_roomTemperature_Int_330 Measure_assentToSupportCalls_Bool_107 Measure_userDistressed_Int_331) Measure)) (=> (= Measure_time_Int_329 Measure_time_Int_332) (and (= Measure_userDistressed_Int_331 Measure_userDistressed_Int_334) (and (= Measure_assentToSupportCalls_Bool_107 Measure_assentToSupportCalls_Bool_109) (and (= Measure_roomTemperature_Int_330 Measure_roomTemperature_Int_333) (and (= Measure_userUnderDressed_Bool_106 Measure_userUnderDressed_Bool_108) (= Measure_time_Int_329 Measure_time_Int_332)))))))))
(assert (=> (exists ((DressingStarted_time_Int_284 Int)) (and true (set.member (tuple DressingStarted_time_Int_284) DressingStarted))) (and (exists ((DressingStarted_time_Int_287 Int)) (and (forall ((DressingStarted_time_Int_288 Int)) (=> (set.member (tuple DressingStarted_time_Int_288) DressingStarted) (<= DressingStarted_time_Int_288 DressingStarted_time_Int_287))) (set.member (tuple DressingStarted_time_Int_287) DressingStarted))) (exists ((DressingStarted_time_Int_285 Int)) (and (forall ((DressingStarted_time_Int_286 Int)) (=> (set.member (tuple DressingStarted_time_Int_286) DressingStarted) (>= DressingStarted_time_Int_286 DressingStarted_time_Int_285))) (set.member (tuple DressingStarted_time_Int_285) DressingStarted))))))
(assert (=> (exists ((DressingComplete_time_Int_289 Int)) (and true (set.member (tuple DressingComplete_time_Int_289) DressingComplete))) (and (exists ((DressingComplete_time_Int_292 Int)) (and (forall ((DressingComplete_time_Int_293 Int)) (=> (set.member (tuple DressingComplete_time_Int_293) DressingComplete) (<= DressingComplete_time_Int_293 DressingComplete_time_Int_292))) (set.member (tuple DressingComplete_time_Int_292) DressingComplete))) (exists ((DressingComplete_time_Int_290 Int)) (and (forall ((DressingComplete_time_Int_291 Int)) (=> (set.member (tuple DressingComplete_time_Int_291) DressingComplete) (>= DressingComplete_time_Int_291 DressingComplete_time_Int_290))) (set.member (tuple DressingComplete_time_Int_290) DressingComplete))))))
(assert (=> (exists ((DressingAbandoned_time_Int_294 Int)) (and true (set.member (tuple DressingAbandoned_time_Int_294) DressingAbandoned))) (and (exists ((DressingAbandoned_time_Int_297 Int)) (and (forall ((DressingAbandoned_time_Int_298 Int)) (=> (set.member (tuple DressingAbandoned_time_Int_298) DressingAbandoned) (<= DressingAbandoned_time_Int_298 DressingAbandoned_time_Int_297))) (set.member (tuple DressingAbandoned_time_Int_297) DressingAbandoned))) (exists ((DressingAbandoned_time_Int_295 Int)) (and (forall ((DressingAbandoned_time_Int_296 Int)) (=> (set.member (tuple DressingAbandoned_time_Int_296) DressingAbandoned) (>= DressingAbandoned_time_Int_296 DressingAbandoned_time_Int_295))) (set.member (tuple DressingAbandoned_time_Int_295) DressingAbandoned))))))
(assert (=> (exists ((CurtainOpenRqt_time_Int_299 Int)) (and true (set.member (tuple CurtainOpenRqt_time_Int_299) CurtainOpenRqt))) (and (exists ((CurtainOpenRqt_time_Int_302 Int)) (and (forall ((CurtainOpenRqt_time_Int_303 Int)) (=> (set.member (tuple CurtainOpenRqt_time_Int_303) CurtainOpenRqt) (<= CurtainOpenRqt_time_Int_303 CurtainOpenRqt_time_Int_302))) (set.member (tuple CurtainOpenRqt_time_Int_302) CurtainOpenRqt))) (exists ((CurtainOpenRqt_time_Int_300 Int)) (and (forall ((CurtainOpenRqt_time_Int_301 Int)) (=> (set.member (tuple CurtainOpenRqt_time_Int_301) CurtainOpenRqt) (>= CurtainOpenRqt_time_Int_301 CurtainOpenRqt_time_Int_300))) (set.member (tuple CurtainOpenRqt_time_Int_300) CurtainOpenRqt))))))
(assert (=> (exists ((CurtainsOpened_time_Int_304 Int)) (and true (set.member (tuple CurtainsOpened_time_Int_304) CurtainsOpened))) (and (exists ((CurtainsOpened_time_Int_307 Int)) (and (forall ((CurtainsOpened_time_Int_308 Int)) (=> (set.member (tuple CurtainsOpened_time_Int_308) CurtainsOpened) (<= CurtainsOpened_time_Int_308 CurtainsOpened_time_Int_307))) (set.member (tuple CurtainsOpened_time_Int_307) CurtainsOpened))) (exists ((CurtainsOpened_time_Int_305 Int)) (and (forall ((CurtainsOpened_time_Int_306 Int)) (=> (set.member (tuple CurtainsOpened_time_Int_306) CurtainsOpened) (>= CurtainsOpened_time_Int_306 CurtainsOpened_time_Int_305))) (set.member (tuple CurtainsOpened_time_Int_305) CurtainsOpened))))))
(assert (=> (exists ((RefuseRequest_time_Int_309 Int)) (and true (set.member (tuple RefuseRequest_time_Int_309) RefuseRequest))) (and (exists ((RefuseRequest_time_Int_312 Int)) (and (forall ((RefuseRequest_time_Int_313 Int)) (=> (set.member (tuple RefuseRequest_time_Int_313) RefuseRequest) (<= RefuseRequest_time_Int_313 RefuseRequest_time_Int_312))) (set.member (tuple RefuseRequest_time_Int_312) RefuseRequest))) (exists ((RefuseRequest_time_Int_310 Int)) (and (forall ((RefuseRequest_time_Int_311 Int)) (=> (set.member (tuple RefuseRequest_time_Int_311) RefuseRequest) (>= RefuseRequest_time_Int_311 RefuseRequest_time_Int_310))) (set.member (tuple RefuseRequest_time_Int_310) RefuseRequest))))))
(assert (=> (exists ((UserFallen_time_Int_314 Int)) (and true (set.member (tuple UserFallen_time_Int_314) UserFallen))) (and (exists ((UserFallen_time_Int_317 Int)) (and (forall ((UserFallen_time_Int_318 Int)) (=> (set.member (tuple UserFallen_time_Int_318) UserFallen) (<= UserFallen_time_Int_318 UserFallen_time_Int_317))) (set.member (tuple UserFallen_time_Int_317) UserFallen))) (exists ((UserFallen_time_Int_315 Int)) (and (forall ((UserFallen_time_Int_316 Int)) (=> (set.member (tuple UserFallen_time_Int_316) UserFallen) (>= UserFallen_time_Int_316 UserFallen_time_Int_315))) (set.member (tuple UserFallen_time_Int_315) UserFallen))))))
(assert (=> (exists ((SupportCalled_time_Int_319 Int)) (and true (set.member (tuple SupportCalled_time_Int_319) SupportCalled))) (and (exists ((SupportCalled_time_Int_322 Int)) (and (forall ((SupportCalled_time_Int_323 Int)) (=> (set.member (tuple SupportCalled_time_Int_323) SupportCalled) (<= SupportCalled_time_Int_323 SupportCalled_time_Int_322))) (set.member (tuple SupportCalled_time_Int_322) SupportCalled))) (exists ((SupportCalled_time_Int_320 Int)) (and (forall ((SupportCalled_time_Int_321 Int)) (=> (set.member (tuple SupportCalled_time_Int_321) SupportCalled) (>= SupportCalled_time_Int_321 SupportCalled_time_Int_320))) (set.member (tuple SupportCalled_time_Int_320) SupportCalled))))))
(assert (=> (exists ((RetryAgreed_time_Int_324 Int)) (and true (set.member (tuple RetryAgreed_time_Int_324) RetryAgreed))) (and (exists ((RetryAgreed_time_Int_327 Int)) (and (forall ((RetryAgreed_time_Int_328 Int)) (=> (set.member (tuple RetryAgreed_time_Int_328) RetryAgreed) (<= RetryAgreed_time_Int_328 RetryAgreed_time_Int_327))) (set.member (tuple RetryAgreed_time_Int_327) RetryAgreed))) (exists ((RetryAgreed_time_Int_325 Int)) (and (forall ((RetryAgreed_time_Int_326 Int)) (=> (set.member (tuple RetryAgreed_time_Int_326) RetryAgreed) (>= RetryAgreed_time_Int_326 RetryAgreed_time_Int_325))) (set.member (tuple RetryAgreed_time_Int_325) RetryAgreed))))))
...
(assert true)
(assert true)
(assert (forall ((Measure_time_Int_335 Int) (Measure_userUnderDressed_Bool_110 Bool) (Measure_roomTemperature_Int_336 Int) (Measure_assentToSupportCalls_Bool_111 Bool) (Measure_userDistressed_Int_337 Int)) (=> (set.member (tuple Measure_time_Int_335 Measure_userUnderDressed_Bool_110 Measure_roomTemperature_Int_336 Measure_assentToSupportCalls_Bool_111 Measure_userDistressed_Int_337) Measure) (exists ((time_val_Int_338 Int)) (and (= time_val_Int_338 Measure_time_Int_335) (set.member (tuple time_val_Int_338) time))))))
(check-sat)
