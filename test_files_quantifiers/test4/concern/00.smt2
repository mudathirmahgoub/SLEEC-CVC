...
(assert (exists ((C_time_Int_55 Int)) (and (exists ((Measure_time_Int_56 Int) (Measure_m1_Int_57 Int)) (and (and (not (exists ((D_time_Int_58 Int)) (and (and (>= D_time_Int_58 (+ C_time_Int_55 1)) (<= D_time_Int_58 (+ C_time_Int_55 30))) (set.member (tuple D_time_Int_58) D)))) (= C_time_Int_55 Measure_time_Int_56)) (set.member (tuple Measure_time_Int_56 Measure_m1_Int_57) Measure))) (set.member (tuple C_time_Int_55) C))))
