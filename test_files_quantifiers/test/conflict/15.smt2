...
(assert (exists ((E_time_Int_313 Int) (Measure_time_Int_314 Int) (Measure_ba_Bool_152 Bool) (Measure_na_Int_315 Int) (Measure_bb_Bool_153 Bool)) (and (and Measure_ba_Bool_152 (= E_time_Int_313 Measure_time_Int_314)) (and (set.member (tuple Measure_time_Int_314 Measure_ba_Bool_152 Measure_na_Int_315 Measure_bb_Bool_153) Measure) (set.member (tuple E_time_Int_313) E)))))
