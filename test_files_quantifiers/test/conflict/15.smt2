...
(assert (exists ((E_time_Int_301 Int) (Measure_time_Int_302 Int) (Measure_ba_Bool_152 Bool) (Measure_na_Int_303 Int) (Measure_bb_Bool_153 Bool)) (and (and Measure_ba_Bool_152 (= E_time_Int_301 Measure_time_Int_302)) (and (set.member (tuple Measure_time_Int_302 Measure_ba_Bool_152 Measure_na_Int_303 Measure_bb_Bool_153) Measure) (set.member (tuple E_time_Int_301) E)))))
