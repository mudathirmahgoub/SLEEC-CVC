...
(assert (exists ((C_time_Int_217 Int) (Measure_time_Int_218 Int) (Measure_ba_Bool_114 Bool) (Measure_na_Int_219 Int) (Measure_bb_Bool_115 Bool)) (and (= C_time_Int_217 Measure_time_Int_218) (and (set.member (tuple Measure_time_Int_218 Measure_ba_Bool_114 Measure_na_Int_219 Measure_bb_Bool_115) Measure) (set.member (tuple C_time_Int_217) C)))))
