...
(assert (and (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_8 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_8) ((_ tuple.select 2) tuple_8)) (<= ((_ tuple.select 1) tuple_8) ((_ tuple.select 0) tuple_8)))))) (rel.product H not_H))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_7 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_7) ((_ tuple.select 2) tuple_7)) (<= ((_ tuple.select 1) tuple_7) ((_ tuple.select 0) tuple_7)))))) (rel.product G not_G))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_6 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_6) ((_ tuple.select 2) tuple_6)) (<= ((_ tuple.select 1) tuple_6) ((_ tuple.select 0) tuple_6)))))) (rel.product F not_F))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_5 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_5) ((_ tuple.select 2) tuple_5)) (<= ((_ tuple.select 1) tuple_5) ((_ tuple.select 0) tuple_5)))))) (rel.product E not_E))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_4 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_4) ((_ tuple.select 2) tuple_4)) (<= ((_ tuple.select 1) tuple_4) ((_ tuple.select 0) tuple_4)))))) (rel.product D not_D))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_3 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_3) ((_ tuple.select 2) tuple_3)) (<= ((_ tuple.select 1) tuple_3) ((_ tuple.select 0) tuple_3)))))) (rel.product C not_C))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_2 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_2) ((_ tuple.select 2) tuple_2)) (<= ((_ tuple.select 1) tuple_2) ((_ tuple.select 0) tuple_2)))))) (rel.product B not_B))) (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_1 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_1) ((_ tuple.select 2) tuple_1)) (<= ((_ tuple.select 1) tuple_1) ((_ tuple.select 0) tuple_1)))))) (rel.product A not_A)))))))))) (forall ((Measure_time_Int_445 Int) (Measure_ba_Bool_196 Bool) (Measure_na_Int_446 Int) (Measure_bb_Bool_197 Bool) (Measure_time_Int_447 Int) (Measure_ba_Bool_198 Bool) (Measure_na_Int_448 Int) (Measure_bb_Bool_199 Bool)) (=> (and (set.member (tuple Measure_time_Int_447 Measure_ba_Bool_198 Measure_na_Int_448 Measure_bb_Bool_199) Measure) (set.member (tuple Measure_time_Int_445 Measure_ba_Bool_196 Measure_na_Int_446 Measure_bb_Bool_197) Measure)) (=> (= Measure_time_Int_445 Measure_time_Int_447) (and (= Measure_bb_Bool_197 Measure_bb_Bool_199) (and (= Measure_na_Int_446 Measure_na_Int_448) (and (= Measure_ba_Bool_196 Measure_ba_Bool_198) (= Measure_time_Int_445 Measure_time_Int_447)))))))))
(assert (forall ((A_time_Int_413 Int)) (=> (set.member (tuple A_time_Int_413) A) (or (exists ((A_time_Int_415 Int)) (and (and (forall ((A_time_Int_416 Int)) (=> (set.member (tuple A_time_Int_416) A) (<= A_time_Int_416 A_time_Int_413))) (> A_time_Int_415 A_time_Int_413)) (set.member (tuple A_time_Int_415) A))) (forall ((A_time_Int_414 Int)) (=> (set.member (tuple A_time_Int_414) A) (<= A_time_Int_414 A_time_Int_413)))))))
(assert (forall ((B_time_Int_417 Int)) (=> (set.member (tuple B_time_Int_417) B) (or (exists ((B_time_Int_419 Int)) (and (and (forall ((B_time_Int_420 Int)) (=> (set.member (tuple B_time_Int_420) B) (<= B_time_Int_420 B_time_Int_417))) (> B_time_Int_419 B_time_Int_417)) (set.member (tuple B_time_Int_419) B))) (forall ((B_time_Int_418 Int)) (=> (set.member (tuple B_time_Int_418) B) (<= B_time_Int_418 B_time_Int_417)))))))
(assert (forall ((C_time_Int_421 Int)) (=> (set.member (tuple C_time_Int_421) C) (or (exists ((C_time_Int_423 Int)) (and (and (forall ((C_time_Int_424 Int)) (=> (set.member (tuple C_time_Int_424) C) (<= C_time_Int_424 C_time_Int_421))) (> C_time_Int_423 C_time_Int_421)) (set.member (tuple C_time_Int_423) C))) (forall ((C_time_Int_422 Int)) (=> (set.member (tuple C_time_Int_422) C) (<= C_time_Int_422 C_time_Int_421)))))))
(assert (forall ((D_time_Int_425 Int)) (=> (set.member (tuple D_time_Int_425) D) (or (exists ((D_time_Int_427 Int)) (and (and (forall ((D_time_Int_428 Int)) (=> (set.member (tuple D_time_Int_428) D) (<= D_time_Int_428 D_time_Int_425))) (> D_time_Int_427 D_time_Int_425)) (set.member (tuple D_time_Int_427) D))) (forall ((D_time_Int_426 Int)) (=> (set.member (tuple D_time_Int_426) D) (<= D_time_Int_426 D_time_Int_425)))))))
(assert (forall ((E_time_Int_429 Int)) (=> (set.member (tuple E_time_Int_429) E) (or (exists ((E_time_Int_431 Int)) (and (and (forall ((E_time_Int_432 Int)) (=> (set.member (tuple E_time_Int_432) E) (<= E_time_Int_432 E_time_Int_429))) (> E_time_Int_431 E_time_Int_429)) (set.member (tuple E_time_Int_431) E))) (forall ((E_time_Int_430 Int)) (=> (set.member (tuple E_time_Int_430) E) (<= E_time_Int_430 E_time_Int_429)))))))
(assert (forall ((F_time_Int_433 Int)) (=> (set.member (tuple F_time_Int_433) F) (or (exists ((F_time_Int_435 Int)) (and (and (forall ((F_time_Int_436 Int)) (=> (set.member (tuple F_time_Int_436) F) (<= F_time_Int_436 F_time_Int_433))) (> F_time_Int_435 F_time_Int_433)) (set.member (tuple F_time_Int_435) F))) (forall ((F_time_Int_434 Int)) (=> (set.member (tuple F_time_Int_434) F) (<= F_time_Int_434 F_time_Int_433)))))))
(assert (forall ((G_time_Int_437 Int)) (=> (set.member (tuple G_time_Int_437) G) (or (exists ((G_time_Int_439 Int)) (and (and (forall ((G_time_Int_440 Int)) (=> (set.member (tuple G_time_Int_440) G) (<= G_time_Int_440 G_time_Int_437))) (> G_time_Int_439 G_time_Int_437)) (set.member (tuple G_time_Int_439) G))) (forall ((G_time_Int_438 Int)) (=> (set.member (tuple G_time_Int_438) G) (<= G_time_Int_438 G_time_Int_437)))))))
(assert (forall ((H_time_Int_441 Int)) (=> (set.member (tuple H_time_Int_441) H) (or (exists ((H_time_Int_443 Int)) (and (and (forall ((H_time_Int_444 Int)) (=> (set.member (tuple H_time_Int_444) H) (<= H_time_Int_444 H_time_Int_441))) (> H_time_Int_443 H_time_Int_441)) (set.member (tuple H_time_Int_443) H))) (forall ((H_time_Int_442 Int)) (=> (set.member (tuple H_time_Int_442) H) (<= H_time_Int_442 H_time_Int_441)))))))
