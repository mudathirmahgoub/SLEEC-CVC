...
(assert (exists ((E_time_Int_287 Int) (Measure_time_Int_288 Int) (Measure_ba_Bool_140 Bool) (Measure_na_Int_289 Int) (Measure_bb_Bool_141 Bool)) (and (and Measure_ba_Bool_140 (= E_time_Int_287 Measure_time_Int_288)) (and (set.member (tuple Measure_time_Int_288 Measure_ba_Bool_140 Measure_na_Int_289 Measure_bb_Bool_141) Measure) (set.member (tuple E_time_Int_287) E)))))
...
(assert (and (and (forall ((H_time_Int_478 Int) (not_H_start_time_Int_479 Int) (not_H_end_time_Int_480 Int)) (=> (and (set.member (tuple not_H_start_time_Int_479 not_H_end_time_Int_480) not_H) (set.member (tuple H_time_Int_478) H)) (not (and (<= H_time_Int_478 not_H_end_time_Int_480) (<= not_H_start_time_Int_479 H_time_Int_478))))) (and (forall ((G_time_Int_475 Int) (not_G_start_time_Int_476 Int) (not_G_end_time_Int_477 Int)) (=> (and (set.member (tuple not_G_start_time_Int_476 not_G_end_time_Int_477) not_G) (set.member (tuple G_time_Int_475) G)) (not (and (<= G_time_Int_475 not_G_end_time_Int_477) (<= not_G_start_time_Int_476 G_time_Int_475))))) (and (forall ((F_time_Int_472 Int) (not_F_start_time_Int_473 Int) (not_F_end_time_Int_474 Int)) (=> (and (set.member (tuple not_F_start_time_Int_473 not_F_end_time_Int_474) not_F) (set.member (tuple F_time_Int_472) F)) (not (and (<= F_time_Int_472 not_F_end_time_Int_474) (<= not_F_start_time_Int_473 F_time_Int_472))))) (and (forall ((E_time_Int_469 Int) (not_E_start_time_Int_470 Int) (not_E_end_time_Int_471 Int)) (=> (and (set.member (tuple not_E_start_time_Int_470 not_E_end_time_Int_471) not_E) (set.member (tuple E_time_Int_469) E)) (not (and (<= E_time_Int_469 not_E_end_time_Int_471) (<= not_E_start_time_Int_470 E_time_Int_469))))) (and (forall ((D_time_Int_466 Int) (not_D_start_time_Int_467 Int) (not_D_end_time_Int_468 Int)) (=> (and (set.member (tuple not_D_start_time_Int_467 not_D_end_time_Int_468) not_D) (set.member (tuple D_time_Int_466) D)) (not (and (<= D_time_Int_466 not_D_end_time_Int_468) (<= not_D_start_time_Int_467 D_time_Int_466))))) (and (forall ((C_time_Int_463 Int) (not_C_start_time_Int_464 Int) (not_C_end_time_Int_465 Int)) (=> (and (set.member (tuple not_C_start_time_Int_464 not_C_end_time_Int_465) not_C) (set.member (tuple C_time_Int_463) C)) (not (and (<= C_time_Int_463 not_C_end_time_Int_465) (<= not_C_start_time_Int_464 C_time_Int_463))))) (and (forall ((B_time_Int_460 Int) (not_B_start_time_Int_461 Int) (not_B_end_time_Int_462 Int)) (=> (and (set.member (tuple not_B_start_time_Int_461 not_B_end_time_Int_462) not_B) (set.member (tuple B_time_Int_460) B)) (not (and (<= B_time_Int_460 not_B_end_time_Int_462) (<= not_B_start_time_Int_461 B_time_Int_460))))) (forall ((A_time_Int_457 Int) (not_A_start_time_Int_458 Int) (not_A_end_time_Int_459 Int)) (=> (and (set.member (tuple not_A_start_time_Int_458 not_A_end_time_Int_459) not_A) (set.member (tuple A_time_Int_457) A)) (not (and (<= A_time_Int_457 not_A_end_time_Int_459) (<= not_A_start_time_Int_458 A_time_Int_457)))))))))))) (forall ((Measure_time_Int_453 Int) (Measure_ba_Bool_196 Bool) (Measure_na_Int_454 Int) (Measure_bb_Bool_197 Bool) (Measure_time_Int_455 Int) (Measure_ba_Bool_198 Bool) (Measure_na_Int_456 Int) (Measure_bb_Bool_199 Bool)) (=> (and (set.member (tuple Measure_time_Int_455 Measure_ba_Bool_198 Measure_na_Int_456 Measure_bb_Bool_199) Measure) (set.member (tuple Measure_time_Int_453 Measure_ba_Bool_196 Measure_na_Int_454 Measure_bb_Bool_197) Measure)) (=> (= Measure_time_Int_453 Measure_time_Int_455) (and (= Measure_bb_Bool_197 Measure_bb_Bool_199) (and (= Measure_na_Int_454 Measure_na_Int_456) (and (= Measure_ba_Bool_196 Measure_ba_Bool_198) (= Measure_time_Int_453 Measure_time_Int_455)))))))))
(assert (=> (exists ((A_time_Int_413 Int)) (and true (set.member (tuple A_time_Int_413) A))) (and (exists ((A_time_Int_416 Int)) (and (forall ((A_time_Int_417 Int)) (=> (set.member (tuple A_time_Int_417) A) (<= A_time_Int_417 A_time_Int_416))) (set.member (tuple A_time_Int_416) A))) (exists ((A_time_Int_414 Int)) (and (forall ((A_time_Int_415 Int)) (=> (set.member (tuple A_time_Int_415) A) (>= A_time_Int_415 A_time_Int_414))) (set.member (tuple A_time_Int_414) A))))))
(assert (=> (exists ((B_time_Int_418 Int)) (and true (set.member (tuple B_time_Int_418) B))) (and (exists ((B_time_Int_421 Int)) (and (forall ((B_time_Int_422 Int)) (=> (set.member (tuple B_time_Int_422) B) (<= B_time_Int_422 B_time_Int_421))) (set.member (tuple B_time_Int_421) B))) (exists ((B_time_Int_419 Int)) (and (forall ((B_time_Int_420 Int)) (=> (set.member (tuple B_time_Int_420) B) (>= B_time_Int_420 B_time_Int_419))) (set.member (tuple B_time_Int_419) B))))))
(assert (=> (exists ((C_time_Int_423 Int)) (and true (set.member (tuple C_time_Int_423) C))) (and (exists ((C_time_Int_426 Int)) (and (forall ((C_time_Int_427 Int)) (=> (set.member (tuple C_time_Int_427) C) (<= C_time_Int_427 C_time_Int_426))) (set.member (tuple C_time_Int_426) C))) (exists ((C_time_Int_424 Int)) (and (forall ((C_time_Int_425 Int)) (=> (set.member (tuple C_time_Int_425) C) (>= C_time_Int_425 C_time_Int_424))) (set.member (tuple C_time_Int_424) C))))))
(assert (=> (exists ((D_time_Int_428 Int)) (and true (set.member (tuple D_time_Int_428) D))) (and (exists ((D_time_Int_431 Int)) (and (forall ((D_time_Int_432 Int)) (=> (set.member (tuple D_time_Int_432) D) (<= D_time_Int_432 D_time_Int_431))) (set.member (tuple D_time_Int_431) D))) (exists ((D_time_Int_429 Int)) (and (forall ((D_time_Int_430 Int)) (=> (set.member (tuple D_time_Int_430) D) (>= D_time_Int_430 D_time_Int_429))) (set.member (tuple D_time_Int_429) D))))))
(assert (=> (exists ((E_time_Int_433 Int)) (and true (set.member (tuple E_time_Int_433) E))) (and (exists ((E_time_Int_436 Int)) (and (forall ((E_time_Int_437 Int)) (=> (set.member (tuple E_time_Int_437) E) (<= E_time_Int_437 E_time_Int_436))) (set.member (tuple E_time_Int_436) E))) (exists ((E_time_Int_434 Int)) (and (forall ((E_time_Int_435 Int)) (=> (set.member (tuple E_time_Int_435) E) (>= E_time_Int_435 E_time_Int_434))) (set.member (tuple E_time_Int_434) E))))))
(assert (=> (exists ((F_time_Int_438 Int)) (and true (set.member (tuple F_time_Int_438) F))) (and (exists ((F_time_Int_441 Int)) (and (forall ((F_time_Int_442 Int)) (=> (set.member (tuple F_time_Int_442) F) (<= F_time_Int_442 F_time_Int_441))) (set.member (tuple F_time_Int_441) F))) (exists ((F_time_Int_439 Int)) (and (forall ((F_time_Int_440 Int)) (=> (set.member (tuple F_time_Int_440) F) (>= F_time_Int_440 F_time_Int_439))) (set.member (tuple F_time_Int_439) F))))))
(assert (=> (exists ((G_time_Int_443 Int)) (and true (set.member (tuple G_time_Int_443) G))) (and (exists ((G_time_Int_446 Int)) (and (forall ((G_time_Int_447 Int)) (=> (set.member (tuple G_time_Int_447) G) (<= G_time_Int_447 G_time_Int_446))) (set.member (tuple G_time_Int_446) G))) (exists ((G_time_Int_444 Int)) (and (forall ((G_time_Int_445 Int)) (=> (set.member (tuple G_time_Int_445) G) (>= G_time_Int_445 G_time_Int_444))) (set.member (tuple G_time_Int_444) G))))))
(assert (=> (exists ((H_time_Int_448 Int)) (and true (set.member (tuple H_time_Int_448) H))) (and (exists ((H_time_Int_451 Int)) (and (forall ((H_time_Int_452 Int)) (=> (set.member (tuple H_time_Int_452) H) (<= H_time_Int_452 H_time_Int_451))) (set.member (tuple H_time_Int_451) H))) (exists ((H_time_Int_449 Int)) (and (forall ((H_time_Int_450 Int)) (=> (set.member (tuple H_time_Int_450) H) (>= H_time_Int_450 H_time_Int_449))) (set.member (tuple H_time_Int_449) H))))))
