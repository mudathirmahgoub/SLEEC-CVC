...
(assert (exists ((E_time_Int_279 Int) (Measure_time_Int_280 Int) (Measure_ba_Bool_140 Bool) (Measure_na_Int_281 Int) (Measure_bb_Bool_141 Bool)) (and (and Measure_ba_Bool_140 (= E_time_Int_279 Measure_time_Int_280)) (and (set.member (tuple Measure_time_Int_280 Measure_ba_Bool_140 Measure_na_Int_281 Measure_bb_Bool_141) Measure) (set.member (tuple E_time_Int_279) E)))))
...
(assert (forall ((Measure_time_Int_433 Int) (Measure_ba_Bool_196 Bool) (Measure_na_Int_434 Int) (Measure_bb_Bool_197 Bool) (Measure_time_Int_435 Int) (Measure_ba_Bool_198 Bool) (Measure_na_Int_436 Int) (Measure_bb_Bool_199 Bool)) (=> (and (set.member (tuple Measure_time_Int_435 Measure_ba_Bool_198 Measure_na_Int_436 Measure_bb_Bool_199) Measure) (set.member (tuple Measure_time_Int_433 Measure_ba_Bool_196 Measure_na_Int_434 Measure_bb_Bool_197) Measure)) (=> (= Measure_time_Int_433 Measure_time_Int_435) (and (= Measure_bb_Bool_197 Measure_bb_Bool_199) (and (= Measure_na_Int_434 Measure_na_Int_436) (and (= Measure_ba_Bool_196 Measure_ba_Bool_198) (= Measure_time_Int_433 Measure_time_Int_435))))))))
(assert (=> (exists ((A_time_Int_393 Int)) (and true (set.member (tuple A_time_Int_393) A))) (and (exists ((A_time_Int_396 Int)) (and (forall ((A_time_Int_397 Int)) (=> (set.member (tuple A_time_Int_397) A) (<= A_time_Int_397 A_time_Int_396))) (set.member (tuple A_time_Int_396) A))) (exists ((A_time_Int_394 Int)) (and (forall ((A_time_Int_395 Int)) (=> (set.member (tuple A_time_Int_395) A) (>= A_time_Int_395 A_time_Int_394))) (set.member (tuple A_time_Int_394) A))))))
(assert (=> (exists ((B_time_Int_398 Int)) (and true (set.member (tuple B_time_Int_398) B))) (and (exists ((B_time_Int_401 Int)) (and (forall ((B_time_Int_402 Int)) (=> (set.member (tuple B_time_Int_402) B) (<= B_time_Int_402 B_time_Int_401))) (set.member (tuple B_time_Int_401) B))) (exists ((B_time_Int_399 Int)) (and (forall ((B_time_Int_400 Int)) (=> (set.member (tuple B_time_Int_400) B) (>= B_time_Int_400 B_time_Int_399))) (set.member (tuple B_time_Int_399) B))))))
(assert (=> (exists ((C_time_Int_403 Int)) (and true (set.member (tuple C_time_Int_403) C))) (and (exists ((C_time_Int_406 Int)) (and (forall ((C_time_Int_407 Int)) (=> (set.member (tuple C_time_Int_407) C) (<= C_time_Int_407 C_time_Int_406))) (set.member (tuple C_time_Int_406) C))) (exists ((C_time_Int_404 Int)) (and (forall ((C_time_Int_405 Int)) (=> (set.member (tuple C_time_Int_405) C) (>= C_time_Int_405 C_time_Int_404))) (set.member (tuple C_time_Int_404) C))))))
(assert (=> (exists ((D_time_Int_408 Int)) (and true (set.member (tuple D_time_Int_408) D))) (and (exists ((D_time_Int_411 Int)) (and (forall ((D_time_Int_412 Int)) (=> (set.member (tuple D_time_Int_412) D) (<= D_time_Int_412 D_time_Int_411))) (set.member (tuple D_time_Int_411) D))) (exists ((D_time_Int_409 Int)) (and (forall ((D_time_Int_410 Int)) (=> (set.member (tuple D_time_Int_410) D) (>= D_time_Int_410 D_time_Int_409))) (set.member (tuple D_time_Int_409) D))))))
(assert (=> (exists ((E_time_Int_413 Int)) (and true (set.member (tuple E_time_Int_413) E))) (and (exists ((E_time_Int_416 Int)) (and (forall ((E_time_Int_417 Int)) (=> (set.member (tuple E_time_Int_417) E) (<= E_time_Int_417 E_time_Int_416))) (set.member (tuple E_time_Int_416) E))) (exists ((E_time_Int_414 Int)) (and (forall ((E_time_Int_415 Int)) (=> (set.member (tuple E_time_Int_415) E) (>= E_time_Int_415 E_time_Int_414))) (set.member (tuple E_time_Int_414) E))))))
(assert (=> (exists ((F_time_Int_418 Int)) (and true (set.member (tuple F_time_Int_418) F))) (and (exists ((F_time_Int_421 Int)) (and (forall ((F_time_Int_422 Int)) (=> (set.member (tuple F_time_Int_422) F) (<= F_time_Int_422 F_time_Int_421))) (set.member (tuple F_time_Int_421) F))) (exists ((F_time_Int_419 Int)) (and (forall ((F_time_Int_420 Int)) (=> (set.member (tuple F_time_Int_420) F) (>= F_time_Int_420 F_time_Int_419))) (set.member (tuple F_time_Int_419) F))))))
(assert (=> (exists ((G_time_Int_423 Int)) (and true (set.member (tuple G_time_Int_423) G))) (and (exists ((G_time_Int_426 Int)) (and (forall ((G_time_Int_427 Int)) (=> (set.member (tuple G_time_Int_427) G) (<= G_time_Int_427 G_time_Int_426))) (set.member (tuple G_time_Int_426) G))) (exists ((G_time_Int_424 Int)) (and (forall ((G_time_Int_425 Int)) (=> (set.member (tuple G_time_Int_425) G) (>= G_time_Int_425 G_time_Int_424))) (set.member (tuple G_time_Int_424) G))))))
(assert (=> (exists ((H_time_Int_428 Int)) (and true (set.member (tuple H_time_Int_428) H))) (and (exists ((H_time_Int_431 Int)) (and (forall ((H_time_Int_432 Int)) (=> (set.member (tuple H_time_Int_432) H) (<= H_time_Int_432 H_time_Int_431))) (set.member (tuple H_time_Int_431) H))) (exists ((H_time_Int_429 Int)) (and (forall ((H_time_Int_430 Int)) (=> (set.member (tuple H_time_Int_430) H) (>= H_time_Int_430 H_time_Int_429))) (set.member (tuple H_time_Int_429) H))))))
