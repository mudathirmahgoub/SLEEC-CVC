...
(assert (exists ((C_time_Int_203 Int) (Measure_time_Int_204 Int) (Measure_ba_Bool_108 Bool) (Measure_na_Int_205 Int) (Measure_bb_Bool_109 Bool)) (and (= C_time_Int_203 Measure_time_Int_204) (and (set.member (tuple Measure_time_Int_204 Measure_ba_Bool_108 Measure_na_Int_205 Measure_bb_Bool_109) Measure) (set.member (tuple C_time_Int_203) C)))))
