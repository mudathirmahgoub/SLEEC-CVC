...
(assert (exists ((E_time_Int_323 Int) (Measure_time_Int_324 Int) (Measure_ba_Bool_164 Bool) (Measure_na_Int_325 Int) (Measure_bb_Bool_165 Bool)) (and (and Measure_ba_Bool_164 (= E_time_Int_323 Measure_time_Int_324)) (and (set.member (tuple Measure_time_Int_324 Measure_ba_Bool_164 Measure_na_Int_325 Measure_bb_Bool_165) Measure) (set.member (tuple E_time_Int_323) E)))))
