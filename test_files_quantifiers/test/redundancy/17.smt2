...
(assert (exists ((F_time_Int_356 Int)) (and (exists ((Measure_time_Int_357 Int) (Measure_ba_Bool_174 Bool) (Measure_na_Int_358 Int) (Measure_bb_Bool_175 Bool)) (and (and (not (and (=> (and true (and (not Measure_bb_Bool_175) true)) (exists ((G_time_Int_359 Int)) (and (and (>= G_time_Int_359 (+ F_time_Int_356 0)) (<= G_time_Int_359 (+ F_time_Int_356 5))) (set.member (tuple G_time_Int_359) G)))) (=> (and Measure_bb_Bool_175 true) (exists ((H_time_Int_360 Int)) (and (and (>= H_time_Int_360 (+ F_time_Int_356 0)) (<= H_time_Int_360 (+ F_time_Int_356 10))) (set.member (tuple H_time_Int_360) H)))))) (= F_time_Int_356 Measure_time_Int_357)) (set.member (tuple Measure_time_Int_357 Measure_ba_Bool_174 Measure_na_Int_358 Measure_bb_Bool_175) Measure))) (set.member (tuple F_time_Int_356) F))))
