...
(assert (exists ((F_time_Int_340 Int)) (and (exists ((Measure_time_Int_341 Int) (Measure_ba_Bool_174 Bool) (Measure_na_Int_342 Int) (Measure_bb_Bool_175 Bool)) (and (and (not (and (=> (and true (and (not Measure_bb_Bool_175) true)) (exists ((G_time_Int_343 Int)) (and (and (>= G_time_Int_343 (+ F_time_Int_340 0)) (<= G_time_Int_343 (+ F_time_Int_340 5))) (set.member (tuple G_time_Int_343) G)))) (=> (and Measure_bb_Bool_175 true) (exists ((H_time_Int_344 Int)) (and (and (>= H_time_Int_344 (+ F_time_Int_340 0)) (<= H_time_Int_344 (+ F_time_Int_340 10))) (set.member (tuple H_time_Int_344) H)))))) (= F_time_Int_340 Measure_time_Int_341)) (set.member (tuple Measure_time_Int_341 Measure_ba_Bool_174 Measure_na_Int_342 Measure_bb_Bool_175) Measure))) (set.member (tuple F_time_Int_340) F))))
