...
(assert (exists ((H_time_Int_371 Int)) (and (exists ((Measure_time_Int_372 Int) (Measure_ba_Bool_180 Bool) (Measure_na_Int_373 Int) (Measure_bb_Bool_181 Bool)) (and (and (not (exists ((F_time_Int_374 Int)) (and (and (>= F_time_Int_374 (+ H_time_Int_371 0)) (<= F_time_Int_374 (+ H_time_Int_371 10))) (set.member (tuple F_time_Int_374) F)))) (= H_time_Int_371 Measure_time_Int_372)) (set.member (tuple Measure_time_Int_372 Measure_ba_Bool_180 Measure_na_Int_373 Measure_bb_Bool_181) Measure))) (set.member (tuple H_time_Int_371) H))))
