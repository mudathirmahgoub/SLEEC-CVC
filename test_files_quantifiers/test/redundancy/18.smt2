...
(assert (exists ((H_time_Int_355 Int)) (and (exists ((Measure_time_Int_356 Int) (Measure_ba_Bool_180 Bool) (Measure_na_Int_357 Int) (Measure_bb_Bool_181 Bool)) (and (and (not (exists ((F_time_Int_358 Int)) (and (and (>= F_time_Int_358 (+ H_time_Int_355 0)) (<= F_time_Int_358 (+ H_time_Int_355 10))) (set.member (tuple F_time_Int_358) F)))) (= H_time_Int_355 Measure_time_Int_356)) (set.member (tuple Measure_time_Int_356 Measure_ba_Bool_180 Measure_na_Int_357 Measure_bb_Bool_181) Measure))) (set.member (tuple H_time_Int_355) H))))
