...
(assert (=> (exists ((A_time_Int_417 Int)) (and true (set.member (tuple A_time_Int_417) A))) (and (exists ((A_time_Int_420 Int)) (and (forall ((A_time_Int_421 Int)) (=> (set.member (tuple A_time_Int_421) A) (<= A_time_Int_421 A_time_Int_420))) (set.member (tuple A_time_Int_420) A))) (exists ((A_time_Int_418 Int)) (and (forall ((A_time_Int_419 Int)) (=> (set.member (tuple A_time_Int_419) A) (>= A_time_Int_419 A_time_Int_418))) (set.member (tuple A_time_Int_418) A))))))
(assert (=> (exists ((B_time_Int_422 Int)) (and true (set.member (tuple B_time_Int_422) B))) (and (exists ((B_time_Int_425 Int)) (and (forall ((B_time_Int_426 Int)) (=> (set.member (tuple B_time_Int_426) B) (<= B_time_Int_426 B_time_Int_425))) (set.member (tuple B_time_Int_425) B))) (exists ((B_time_Int_423 Int)) (and (forall ((B_time_Int_424 Int)) (=> (set.member (tuple B_time_Int_424) B) (>= B_time_Int_424 B_time_Int_423))) (set.member (tuple B_time_Int_423) B))))))
(assert (=> (exists ((C_time_Int_427 Int)) (and true (set.member (tuple C_time_Int_427) C))) (and (exists ((C_time_Int_430 Int)) (and (forall ((C_time_Int_431 Int)) (=> (set.member (tuple C_time_Int_431) C) (<= C_time_Int_431 C_time_Int_430))) (set.member (tuple C_time_Int_430) C))) (exists ((C_time_Int_428 Int)) (and (forall ((C_time_Int_429 Int)) (=> (set.member (tuple C_time_Int_429) C) (>= C_time_Int_429 C_time_Int_428))) (set.member (tuple C_time_Int_428) C))))))
(assert (=> (exists ((D_time_Int_432 Int)) (and true (set.member (tuple D_time_Int_432) D))) (and (exists ((D_time_Int_435 Int)) (and (forall ((D_time_Int_436 Int)) (=> (set.member (tuple D_time_Int_436) D) (<= D_time_Int_436 D_time_Int_435))) (set.member (tuple D_time_Int_435) D))) (exists ((D_time_Int_433 Int)) (and (forall ((D_time_Int_434 Int)) (=> (set.member (tuple D_time_Int_434) D) (>= D_time_Int_434 D_time_Int_433))) (set.member (tuple D_time_Int_433) D))))))
(assert (=> (exists ((E_time_Int_437 Int)) (and true (set.member (tuple E_time_Int_437) E))) (and (exists ((E_time_Int_440 Int)) (and (forall ((E_time_Int_441 Int)) (=> (set.member (tuple E_time_Int_441) E) (<= E_time_Int_441 E_time_Int_440))) (set.member (tuple E_time_Int_440) E))) (exists ((E_time_Int_438 Int)) (and (forall ((E_time_Int_439 Int)) (=> (set.member (tuple E_time_Int_439) E) (>= E_time_Int_439 E_time_Int_438))) (set.member (tuple E_time_Int_438) E))))))
(assert (=> (exists ((F_time_Int_442 Int)) (and true (set.member (tuple F_time_Int_442) F))) (and (exists ((F_time_Int_445 Int)) (and (forall ((F_time_Int_446 Int)) (=> (set.member (tuple F_time_Int_446) F) (<= F_time_Int_446 F_time_Int_445))) (set.member (tuple F_time_Int_445) F))) (exists ((F_time_Int_443 Int)) (and (forall ((F_time_Int_444 Int)) (=> (set.member (tuple F_time_Int_444) F) (>= F_time_Int_444 F_time_Int_443))) (set.member (tuple F_time_Int_443) F))))))
(assert (=> (exists ((G_time_Int_447 Int)) (and true (set.member (tuple G_time_Int_447) G))) (and (exists ((G_time_Int_450 Int)) (and (forall ((G_time_Int_451 Int)) (=> (set.member (tuple G_time_Int_451) G) (<= G_time_Int_451 G_time_Int_450))) (set.member (tuple G_time_Int_450) G))) (exists ((G_time_Int_448 Int)) (and (forall ((G_time_Int_449 Int)) (=> (set.member (tuple G_time_Int_449) G) (>= G_time_Int_449 G_time_Int_448))) (set.member (tuple G_time_Int_448) G))))))
(assert (=> (exists ((H_time_Int_452 Int)) (and true (set.member (tuple H_time_Int_452) H))) (and (exists ((H_time_Int_455 Int)) (and (forall ((H_time_Int_456 Int)) (=> (set.member (tuple H_time_Int_456) H) (<= H_time_Int_456 H_time_Int_455))) (set.member (tuple H_time_Int_455) H))) (exists ((H_time_Int_453 Int)) (and (forall ((H_time_Int_454 Int)) (=> (set.member (tuple H_time_Int_454) H) (>= H_time_Int_454 H_time_Int_453))) (set.member (tuple H_time_Int_453) H))))))
...
(assert true)
(assert true)
(assert (forall ((Measure_time_Int_457 Int) (Measure_ba_Bool_200 Bool) (Measure_na_Int_458 Int) (Measure_bb_Bool_201 Bool)) (=> (set.member (tuple Measure_time_Int_457 Measure_ba_Bool_200 Measure_na_Int_458 Measure_bb_Bool_201) Measure) (exists ((time_val_Int_459 Int)) (and (= time_val_Int_459 Measure_time_Int_457) (set.member (tuple time_val_Int_459) time))))))
(check-sat)
(get-model)
