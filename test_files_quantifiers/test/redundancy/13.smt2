...
(assert (exists ((E_time_Int_259 Int)) (and (exists ((Measure_time_Int_260 Int) (Measure_ba_Bool_132 Bool) (Measure_na_Int_261 Int) (Measure_bb_Bool_133 Bool)) (and (and (not (and (=> (and true (and (not Measure_ba_Bool_132) (and (not (> Measure_na_Int_261 2)) true))) (exists ((F_time_Int_262 Int)) (and (and (>= F_time_Int_262 (+ E_time_Int_259 0)) (<= F_time_Int_262 (+ E_time_Int_259 5))) (set.member (tuple F_time_Int_262) F)))) (and (=> (and Measure_ba_Bool_132 (and (not (> Measure_na_Int_261 2)) true)) (exists ((G_time_Int_263 Int)) (and (and (>= G_time_Int_263 (+ E_time_Int_259 0)) (<= G_time_Int_263 (+ E_time_Int_259 10))) (set.member (tuple G_time_Int_263) G)))) (=> (and (> Measure_na_Int_261 2) true) (exists ((not_G_start_time_Int_265 Int) (not_G_end_time_Int_266 Int)) (and (and (= not_G_end_time_Int_266 (+ E_time_Int_259 20)) (= not_G_start_time_Int_265 (+ E_time_Int_259 0))) (set.member (tuple not_G_start_time_Int_265 not_G_end_time_Int_266) not_G))))))) (= E_time_Int_259 Measure_time_Int_260)) (set.member (tuple Measure_time_Int_260 Measure_ba_Bool_132 Measure_na_Int_261 Measure_bb_Bool_133) Measure))) (set.member (tuple E_time_Int_259) E))))
