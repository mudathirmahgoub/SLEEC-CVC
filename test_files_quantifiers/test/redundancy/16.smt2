...
(assert (exists ((E_time_Int_332 Int)) (and (exists ((Measure_time_Int_333 Int) (Measure_ba_Bool_162 Bool) (Measure_na_Int_334 Int) (Measure_bb_Bool_163 Bool)) (and (and (and (not (and (=> (and true (and (not (> Measure_na_Int_334 1)) true)) (exists ((G_time_Int_335 Int)) (and (and (>= G_time_Int_335 (+ E_time_Int_332 0)) (<= G_time_Int_335 (+ E_time_Int_332 10))) (set.member (tuple G_time_Int_335) G)))) (=> (and (> Measure_na_Int_334 1) true) (exists ((not_G_start_time_Int_337 Int) (not_G_end_time_Int_338 Int)) (and (and (= not_G_end_time_Int_338 (+ E_time_Int_332 10)) (= not_G_start_time_Int_337 (+ E_time_Int_332 0))) (set.member (tuple not_G_start_time_Int_337 not_G_end_time_Int_338) not_G)))))) Measure_ba_Bool_162) (= E_time_Int_332 Measure_time_Int_333)) (set.member (tuple Measure_time_Int_333 Measure_ba_Bool_162 Measure_na_Int_334 Measure_bb_Bool_163) Measure))) (set.member (tuple E_time_Int_332) E))))
