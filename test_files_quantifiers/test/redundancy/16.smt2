...
(assert (exists ((E_time_Int_318 Int)) (and (exists ((Measure_time_Int_319 Int) (Measure_ba_Bool_162 Bool) (Measure_na_Int_320 Int) (Measure_bb_Bool_163 Bool)) (and (and (and (not (and (=> (and true (and (not (> Measure_na_Int_320 1)) true)) (exists ((G_time_Int_321 Int)) (and (and (>= G_time_Int_321 (+ E_time_Int_318 0)) (<= G_time_Int_321 (+ E_time_Int_318 10))) (set.member (tuple G_time_Int_321) G)))) (=> (and (> Measure_na_Int_320 1) true) (not (exists ((G_time_Int_322 Int)) (and (and (>= G_time_Int_322 (+ E_time_Int_318 0)) (<= G_time_Int_322 (+ E_time_Int_318 10))) (set.member (tuple G_time_Int_322) G))))))) Measure_ba_Bool_162) (= E_time_Int_318 Measure_time_Int_319)) (set.member (tuple Measure_time_Int_319 Measure_ba_Bool_162 Measure_na_Int_320 Measure_bb_Bool_163) Measure))) (set.member (tuple E_time_Int_318) E))))
