...
(assert (exists ((E_time_Int_306 Int)) (and (exists ((Measure_time_Int_307 Int) (Measure_ba_Bool_150 Bool) (Measure_na_Int_308 Int) (Measure_bb_Bool_151 Bool)) (and (and (and (not (and (=> (and true (and (not (> Measure_na_Int_308 3)) true)) (exists ((G_time_Int_309 Int)) (and (and (>= G_time_Int_309 (+ E_time_Int_306 0)) (<= G_time_Int_309 (+ E_time_Int_306 10))) (set.member (tuple G_time_Int_309) G)))) (=> (and (> Measure_na_Int_308 3) true) (exists ((not_G_start_time_Int_311 Int) (not_G_end_time_Int_312 Int)) (and (and (= not_G_end_time_Int_312 (+ E_time_Int_306 10)) (= not_G_start_time_Int_311 (+ E_time_Int_306 0))) (set.member (tuple not_G_start_time_Int_311 not_G_end_time_Int_312) not_G)))))) Measure_ba_Bool_150) (= E_time_Int_306 Measure_time_Int_307)) (set.member (tuple Measure_time_Int_307 Measure_ba_Bool_150 Measure_na_Int_308 Measure_bb_Bool_151) Measure))) (set.member (tuple E_time_Int_306) E))))
