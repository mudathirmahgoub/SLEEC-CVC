...
(assert (exists ((E_time_Int_296 Int)) (and (exists ((Measure_time_Int_297 Int) (Measure_ba_Bool_150 Bool) (Measure_na_Int_298 Int) (Measure_bb_Bool_151 Bool)) (and (and (and (not (and (=> (and true (and (not (> Measure_na_Int_298 3)) true)) (exists ((G_time_Int_299 Int)) (and (and (>= G_time_Int_299 (+ E_time_Int_296 0)) (<= G_time_Int_299 (+ E_time_Int_296 10))) (set.member (tuple G_time_Int_299) G)))) (=> (and (> Measure_na_Int_298 3) true) (not (exists ((G_time_Int_300 Int)) (and (and (>= G_time_Int_300 (+ E_time_Int_296 0)) (<= G_time_Int_300 (+ E_time_Int_296 10))) (set.member (tuple G_time_Int_300) G))))))) Measure_ba_Bool_150) (= E_time_Int_296 Measure_time_Int_297)) (set.member (tuple Measure_time_Int_297 Measure_ba_Bool_150 Measure_na_Int_298 Measure_bb_Bool_151) Measure))) (set.member (tuple E_time_Int_296) E))))
