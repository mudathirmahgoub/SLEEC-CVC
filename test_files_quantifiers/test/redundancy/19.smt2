...
(assert (exists ((H_time_Int_387 Int)) (and (exists ((Measure_time_Int_388 Int) (Measure_ba_Bool_186 Bool) (Measure_na_Int_389 Int) (Measure_bb_Bool_187 Bool)) (and (and (not (exists ((not_F_start_time_Int_391 Int) (not_F_end_time_Int_392 Int)) (and (and (= not_F_end_time_Int_392 (+ H_time_Int_387 0)) (= not_F_start_time_Int_391 (+ H_time_Int_387 0))) (set.member (tuple not_F_start_time_Int_391 not_F_end_time_Int_392) not_F)))) (= H_time_Int_387 Measure_time_Int_388)) (set.member (tuple Measure_time_Int_388 Measure_ba_Bool_186 Measure_na_Int_389 Measure_bb_Bool_187) Measure))) (set.member (tuple H_time_Int_387) H))))
