...
(assert (exists ((H_time_Int_369 Int)) (and (exists ((Measure_time_Int_370 Int) (Measure_ba_Bool_186 Bool) (Measure_na_Int_371 Int) (Measure_bb_Bool_187 Bool)) (and (and (not (not (exists ((F_time_Int_372 Int)) (and (and (>= F_time_Int_372 (+ H_time_Int_369 0)) (<= F_time_Int_372 (+ H_time_Int_369 0))) (set.member (tuple F_time_Int_372) F))))) (= H_time_Int_369 Measure_time_Int_370)) (set.member (tuple Measure_time_Int_370 Measure_ba_Bool_186 Measure_na_Int_371 Measure_bb_Bool_187) Measure))) (set.member (tuple H_time_Int_369) H))))
