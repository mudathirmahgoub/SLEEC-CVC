...
(assert (exists ((E_time_Int_274 Int)) (and (exists ((Measure_time_Int_275 Int) (Measure_ba_Bool_138 Bool) (Measure_na_Int_276 Int) (Measure_bb_Bool_139 Bool)) (and (and (and (not (and (=> (and true (and (not (> Measure_na_Int_276 2)) true)) (exists ((G_time_Int_277 Int)) (and (and (>= G_time_Int_277 (+ E_time_Int_274 0)) (<= G_time_Int_277 (+ E_time_Int_274 10))) (set.member (tuple G_time_Int_277) G)))) (=> (and (> Measure_na_Int_276 2) true) (not (exists ((G_time_Int_278 Int)) (and (and (>= G_time_Int_278 (+ E_time_Int_274 0)) (<= G_time_Int_278 (+ E_time_Int_274 10))) (set.member (tuple G_time_Int_278) G))))))) Measure_ba_Bool_138) (= E_time_Int_274 Measure_time_Int_275)) (set.member (tuple Measure_time_Int_275 Measure_ba_Bool_138 Measure_na_Int_276 Measure_bb_Bool_139) Measure))) (set.member (tuple E_time_Int_274) E))))
