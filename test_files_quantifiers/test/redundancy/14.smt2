...
(assert (exists ((E_time_Int_280 Int)) (and (exists ((Measure_time_Int_281 Int) (Measure_ba_Bool_138 Bool) (Measure_na_Int_282 Int) (Measure_bb_Bool_139 Bool)) (and (and (and (not (and (=> (and true (and (not (> Measure_na_Int_282 2)) true)) (exists ((G_time_Int_283 Int)) (and (and (>= G_time_Int_283 (+ E_time_Int_280 0)) (<= G_time_Int_283 (+ E_time_Int_280 10))) (set.member (tuple G_time_Int_283) G)))) (=> (and (> Measure_na_Int_282 2) true) (exists ((not_G_start_time_Int_285 Int) (not_G_end_time_Int_286 Int)) (and (and (= not_G_end_time_Int_286 (+ E_time_Int_280 10)) (= not_G_start_time_Int_285 (+ E_time_Int_280 0))) (set.member (tuple not_G_start_time_Int_285 not_G_end_time_Int_286) not_G)))))) Measure_ba_Bool_138) (= E_time_Int_280 Measure_time_Int_281)) (set.member (tuple Measure_time_Int_281 Measure_ba_Bool_138 Measure_na_Int_282 Measure_bb_Bool_139) Measure))) (set.member (tuple E_time_Int_280) E))))
