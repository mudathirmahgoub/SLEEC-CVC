...
(assert (exists ((F_time_Int_403 Int)) (and (exists ((Measure_time_Int_404 Int) (Measure_ba_Bool_192 Bool) (Measure_na_Int_405 Int) (Measure_bb_Bool_193 Bool)) (and (and (not (exists ((G_time_Int_406 Int)) (and (>= G_time_Int_406 F_time_Int_403) (set.member (tuple G_time_Int_406) G)))) (= F_time_Int_403 Measure_time_Int_404)) (set.member (tuple Measure_time_Int_404 Measure_ba_Bool_192 Measure_na_Int_405 Measure_bb_Bool_193) Measure))) (set.member (tuple F_time_Int_403) F))))
