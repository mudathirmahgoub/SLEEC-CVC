...
(assert (= (as set.empty (Set (Tuple Int Int Int Int))) (set.filter (lambda ((tuple_59 (Tuple Int Int Int Int))) (not (=> (= ((_ tuple.select 0) tuple_59) ((_ tuple.select 2) tuple_59)) (and (= ((_ tuple.select 1) tuple_59) ((_ tuple.select 3) tuple_59)) (= ((_ tuple.select 0) tuple_59) ((_ tuple.select 2) tuple_59)))))) (rel.product Measure Measure))))
...
(assert true)
(assert true)
(assert (= (as set.empty (Set (Tuple Int Int))) (set.filter (lambda ((tuple_60 (Tuple Int Int))) (not (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_61 (Tuple Int))) (= ((_ tuple.select 0) tuple_61) ((_ tuple.select 0) tuple_60))) time))))) Measure)))
(check-sat)
(get-model)
