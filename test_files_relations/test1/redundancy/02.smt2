...
(assert (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_51 (Tuple Int))) (not (or (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_53 (Tuple Int))) (and (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_54 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_54) ((_ tuple.select 0) tuple_51)))) A)) (> ((_ tuple.select 0) tuple_53) ((_ tuple.select 0) tuple_51)))) A))) (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_52 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_52) ((_ tuple.select 0) tuple_51)))) A))))) A)))
(assert (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_55 (Tuple Int))) (not (or (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_57 (Tuple Int))) (and (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_58 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_58) ((_ tuple.select 0) tuple_55)))) B)) (> ((_ tuple.select 0) tuple_57) ((_ tuple.select 0) tuple_55)))) B))) (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_56 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_56) ((_ tuple.select 0) tuple_55)))) B))))) B)))
(assert (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_59 (Tuple Int))) (not (or (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_61 (Tuple Int))) (and (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_62 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_62) ((_ tuple.select 0) tuple_59)))) C)) (> ((_ tuple.select 0) tuple_61) ((_ tuple.select 0) tuple_59)))) C))) (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_60 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_60) ((_ tuple.select 0) tuple_59)))) C))))) C)))
