...
(assert (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_15 (Tuple Int))) (not (= (as set.empty (Set (Tuple Int Int))) (set.filter (lambda ((tuple_16 (Tuple Int Int))) (and (not (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_17 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_17) (+ ((_ tuple.select 0) tuple_15) 0)) (<= ((_ tuple.select 0) tuple_17) (+ ((_ tuple.select 0) tuple_15) 7)))) C)))) (= ((_ tuple.select 0) tuple_15) ((_ tuple.select 0) tuple_16)))) Measure)))) B))))
