...
(assert (not (= (as set.empty (Set (Tuple Int Int Bool Int Bool Int))) (set.filter (lambda ((tuple_94 (Tuple Int Int Bool Int Bool Int))) (= ((_ tuple.select 0) tuple_94) ((_ tuple.select 1) tuple_94))) (rel.product RetryAgreed Measure)))))
