...
(assert (and (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_215 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_215) ((_ tuple.select 2) tuple_215)) (<= ((_ tuple.select 1) tuple_215) ((_ tuple.select 0) tuple_215)))))) (rel.product RetryAgreed not_RetryAgreed))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_214 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_214) ((_ tuple.select 2) tuple_214)) (<= ((_ tuple.select 1) tuple_214) ((_ tuple.select 0) tuple_214)))))) (rel.product SupportCalled not_SupportCalled))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_213 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_213) ((_ tuple.select 2) tuple_213)) (<= ((_ tuple.select 1) tuple_213) ((_ tuple.select 0) tuple_213)))))) (rel.product UserFallen not_UserFallen))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_212 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_212) ((_ tuple.select 2) tuple_212)) (<= ((_ tuple.select 1) tuple_212) ((_ tuple.select 0) tuple_212)))))) (rel.product RefuseRequest not_RefuseRequest))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_211 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_211) ((_ tuple.select 2) tuple_211)) (<= ((_ tuple.select 1) tuple_211) ((_ tuple.select 0) tuple_211)))))) (rel.product CurtainsOpened not_CurtainsOpened))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_210 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_210) ((_ tuple.select 2) tuple_210)) (<= ((_ tuple.select 1) tuple_210) ((_ tuple.select 0) tuple_210)))))) (rel.product CurtainOpenRqt not_CurtainOpenRqt))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_209 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_209) ((_ tuple.select 2) tuple_209)) (<= ((_ tuple.select 1) tuple_209) ((_ tuple.select 0) tuple_209)))))) (rel.product DressingAbandoned not_DressingAbandoned))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_208 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_208) ((_ tuple.select 2) tuple_208)) (<= ((_ tuple.select 1) tuple_208) ((_ tuple.select 0) tuple_208)))))) (rel.product DressingComplete not_DressingComplete))) (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_207 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_207) ((_ tuple.select 2) tuple_207)) (<= ((_ tuple.select 1) tuple_207) ((_ tuple.select 0) tuple_207)))))) (rel.product DressingStarted not_DressingStarted))))))))))) (= (as set.empty (Set (Tuple Int Bool Int Bool Int Int Bool Int Bool Int))) (set.filter (lambda ((tuple_206 (Tuple Int Bool Int Bool Int Int Bool Int Bool Int))) (not (=> (= ((_ tuple.select 0) tuple_206) ((_ tuple.select 5) tuple_206)) (and (= ((_ tuple.select 4) tuple_206) ((_ tuple.select 9) tuple_206)) (and (= ((_ tuple.select 3) tuple_206) ((_ tuple.select 8) tuple_206)) (and (= ((_ tuple.select 2) tuple_206) ((_ tuple.select 7) tuple_206)) (and (= ((_ tuple.select 1) tuple_206) ((_ tuple.select 6) tuple_206)) (= ((_ tuple.select 0) tuple_206) ((_ tuple.select 5) tuple_206))))))))) (rel.product Measure Measure)))))
