...
(assert (not (= (as set.empty (Set (Tuple Int Int Bool Int Bool Int))) (set.filter (lambda ((tuple_82 (Tuple Int Int Bool Int Bool Int))) (= ((_ tuple.select 0) tuple_82) ((_ tuple.select 1) tuple_82))) (rel.product RetryAgreed Measure)))))
