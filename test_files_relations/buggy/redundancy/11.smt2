...
(assert (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_155 (Tuple Int))) (not (= (as set.empty (Set (Tuple Int Bool Int Bool Int))) (set.filter (lambda ((tuple_156 (Tuple Int Bool Int Bool Int))) (and (and (not (not (= (as set.empty (Set (Tuple Int Int))) (set.filter (lambda ((tuple_158 (Tuple Int Int))) (and (= ((_ tuple.select 1) tuple_158) (+ ((_ tuple.select 0) tuple_155) 120)) (= ((_ tuple.select 0) tuple_158) (+ ((_ tuple.select 0) tuple_155) 0)))) not_SupportCalled)))) ((_ tuple.select 3) tuple_156)) (= ((_ tuple.select 0) tuple_155) ((_ tuple.select 0) tuple_156)))) Measure)))) UserFallen))))
