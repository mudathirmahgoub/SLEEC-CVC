...
(assert (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_127 (Tuple Int))) (not (= (as set.empty (Set (Tuple Int Bool Int Bool Int))) (set.filter (lambda ((tuple_128 (Tuple Int Bool Int Bool Int))) (and (not (=> true (or (= (as set.empty (Set (Tuple Int Bool Int Bool Int))) (set.filter (lambda ((tuple_130 (Tuple Int Bool Int Bool Int))) (not (=> (= (+ ((_ tuple.select 0) tuple_128) 1800) ((_ tuple.select 0) tuple_130)) (and (=> (and true (and (not (not ((_ tuple.select 3) tuple_130))) true)) (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_131 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_131) (+ ((_ tuple.select 0) tuple_130) 0)) (<= ((_ tuple.select 0) tuple_131) (+ ((_ tuple.select 0) tuple_130) 0)))) SupportCalled)))) (=> (and (not ((_ tuple.select 3) tuple_130)) true) true))))) Measure)) (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_129 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_129) (+ ((_ tuple.select 0) tuple_127) 0)) (<= ((_ tuple.select 0) tuple_129) (+ ((_ tuple.select 0) tuple_127) 1800)))) RetryAgreed)))))) (= ((_ tuple.select 0) tuple_127) ((_ tuple.select 0) tuple_128)))) Measure)))) DressingAbandoned))))
