...
(assert (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_140 (Tuple Int))) (not (= (as set.empty (Set (Tuple Int Bool Int Bool Int))) (set.filter (lambda ((tuple_141 (Tuple Int Bool Int Bool Int))) (and (and (not (or (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_143 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_143) (+ ((_ tuple.select 0) tuple_140) 0)) (<= ((_ tuple.select 0) tuple_143) (+ ((_ tuple.select 0) tuple_140) 60)))) DressingComplete))) (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_142 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_142) (+ ((_ tuple.select 0) tuple_140) 0)) (<= ((_ tuple.select 0) tuple_142) (+ ((_ tuple.select 0) tuple_140) 120)))) DressingAbandoned))))) (or ((_ tuple.select 1) tuple_141) (< ((_ tuple.select 2) tuple_141) 16))) (= ((_ tuple.select 0) tuple_140) ((_ tuple.select 0) tuple_141)))) Measure)))) DressingStarted))))
