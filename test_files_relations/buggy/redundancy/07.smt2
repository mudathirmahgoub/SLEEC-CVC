...
(assert (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_103 (Tuple Int))) (not (= (as set.empty (Set (Tuple Int Bool Int Bool Int))) (set.filter (lambda ((tuple_104 (Tuple Int Bool Int Bool Int))) (and (not (and (=> (and true (and (not ((_ tuple.select 1) tuple_104)) (and (not (> ((_ tuple.select 4) tuple_104) 2)) true))) (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_105 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_105) (+ ((_ tuple.select 0) tuple_103) 0)) (<= ((_ tuple.select 0) tuple_105) (+ ((_ tuple.select 0) tuple_103) 60)))) CurtainsOpened)))) (and (=> (and ((_ tuple.select 1) tuple_104) (and (not (> ((_ tuple.select 4) tuple_104) 2)) true)) (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_106 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_106) (+ ((_ tuple.select 0) tuple_103) 0)) (<= ((_ tuple.select 0) tuple_106) (+ ((_ tuple.select 0) tuple_103) 30)))) RefuseRequest)))) (=> (and (> ((_ tuple.select 4) tuple_104) 2) true) (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_107 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_107) (+ ((_ tuple.select 0) tuple_103) 0)) (<= ((_ tuple.select 0) tuple_107) (+ ((_ tuple.select 0) tuple_103) 60)))) CurtainsOpened))))))) (= ((_ tuple.select 0) tuple_103) ((_ tuple.select 0) tuple_104)))) Measure)))) CurtainOpenRqt))))
...
(assert (and (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_179 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_179) ((_ tuple.select 2) tuple_179)) (<= ((_ tuple.select 1) tuple_179) ((_ tuple.select 0) tuple_179)))))) (rel.product RetryAgreed not_RetryAgreed))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_178 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_178) ((_ tuple.select 2) tuple_178)) (<= ((_ tuple.select 1) tuple_178) ((_ tuple.select 0) tuple_178)))))) (rel.product SupportCalled not_SupportCalled))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_177 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_177) ((_ tuple.select 2) tuple_177)) (<= ((_ tuple.select 1) tuple_177) ((_ tuple.select 0) tuple_177)))))) (rel.product UserFallen not_UserFallen))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_176 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_176) ((_ tuple.select 2) tuple_176)) (<= ((_ tuple.select 1) tuple_176) ((_ tuple.select 0) tuple_176)))))) (rel.product RefuseRequest not_RefuseRequest))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_175 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_175) ((_ tuple.select 2) tuple_175)) (<= ((_ tuple.select 1) tuple_175) ((_ tuple.select 0) tuple_175)))))) (rel.product CurtainsOpened not_CurtainsOpened))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_174 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_174) ((_ tuple.select 2) tuple_174)) (<= ((_ tuple.select 1) tuple_174) ((_ tuple.select 0) tuple_174)))))) (rel.product CurtainOpenRqt not_CurtainOpenRqt))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_173 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_173) ((_ tuple.select 2) tuple_173)) (<= ((_ tuple.select 1) tuple_173) ((_ tuple.select 0) tuple_173)))))) (rel.product DressingAbandoned not_DressingAbandoned))) (and (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_172 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_172) ((_ tuple.select 2) tuple_172)) (<= ((_ tuple.select 1) tuple_172) ((_ tuple.select 0) tuple_172)))))) (rel.product DressingComplete not_DressingComplete))) (= (as set.empty (Set (Tuple Int Int Int))) (set.filter (lambda ((tuple_171 (Tuple Int Int Int))) (not (not (and (<= ((_ tuple.select 0) tuple_171) ((_ tuple.select 2) tuple_171)) (<= ((_ tuple.select 1) tuple_171) ((_ tuple.select 0) tuple_171)))))) (rel.product DressingStarted not_DressingStarted))))))))))) (= (as set.empty (Set (Tuple Int Bool Int Bool Int Int Bool Int Bool Int))) (set.filter (lambda ((tuple_170 (Tuple Int Bool Int Bool Int Int Bool Int Bool Int))) (not (=> (= ((_ tuple.select 0) tuple_170) ((_ tuple.select 5) tuple_170)) (and (= ((_ tuple.select 4) tuple_170) ((_ tuple.select 9) tuple_170)) (and (= ((_ tuple.select 3) tuple_170) ((_ tuple.select 8) tuple_170)) (and (= ((_ tuple.select 2) tuple_170) ((_ tuple.select 7) tuple_170)) (and (= ((_ tuple.select 1) tuple_170) ((_ tuple.select 6) tuple_170)) (= ((_ tuple.select 0) tuple_170) ((_ tuple.select 5) tuple_170))))))))) (rel.product Measure Measure)))))
(assert (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_180 (Tuple Int))) (not (or (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_182 (Tuple Int))) (and (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_183 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_183) ((_ tuple.select 0) tuple_180)))) DressingStarted)) (> ((_ tuple.select 0) tuple_182) ((_ tuple.select 0) tuple_180)))) DressingStarted))) (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_181 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_181) ((_ tuple.select 0) tuple_180)))) DressingStarted))))) DressingStarted)))
(assert (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_184 (Tuple Int))) (not (or (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_186 (Tuple Int))) (and (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_187 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_187) ((_ tuple.select 0) tuple_184)))) DressingComplete)) (> ((_ tuple.select 0) tuple_186) ((_ tuple.select 0) tuple_184)))) DressingComplete))) (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_185 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_185) ((_ tuple.select 0) tuple_184)))) DressingComplete))))) DressingComplete)))
(assert (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_188 (Tuple Int))) (not (or (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_190 (Tuple Int))) (and (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_191 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_191) ((_ tuple.select 0) tuple_188)))) DressingAbandoned)) (> ((_ tuple.select 0) tuple_190) ((_ tuple.select 0) tuple_188)))) DressingAbandoned))) (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_189 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_189) ((_ tuple.select 0) tuple_188)))) DressingAbandoned))))) DressingAbandoned)))
(assert (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_192 (Tuple Int))) (not (or (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_194 (Tuple Int))) (and (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_195 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_195) ((_ tuple.select 0) tuple_192)))) CurtainOpenRqt)) (> ((_ tuple.select 0) tuple_194) ((_ tuple.select 0) tuple_192)))) CurtainOpenRqt))) (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_193 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_193) ((_ tuple.select 0) tuple_192)))) CurtainOpenRqt))))) CurtainOpenRqt)))
(assert (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_196 (Tuple Int))) (not (or (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_198 (Tuple Int))) (and (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_199 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_199) ((_ tuple.select 0) tuple_196)))) CurtainsOpened)) (> ((_ tuple.select 0) tuple_198) ((_ tuple.select 0) tuple_196)))) CurtainsOpened))) (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_197 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_197) ((_ tuple.select 0) tuple_196)))) CurtainsOpened))))) CurtainsOpened)))
(assert (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_200 (Tuple Int))) (not (or (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_202 (Tuple Int))) (and (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_203 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_203) ((_ tuple.select 0) tuple_200)))) RefuseRequest)) (> ((_ tuple.select 0) tuple_202) ((_ tuple.select 0) tuple_200)))) RefuseRequest))) (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_201 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_201) ((_ tuple.select 0) tuple_200)))) RefuseRequest))))) RefuseRequest)))
(assert (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_204 (Tuple Int))) (not (or (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_206 (Tuple Int))) (and (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_207 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_207) ((_ tuple.select 0) tuple_204)))) UserFallen)) (> ((_ tuple.select 0) tuple_206) ((_ tuple.select 0) tuple_204)))) UserFallen))) (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_205 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_205) ((_ tuple.select 0) tuple_204)))) UserFallen))))) UserFallen)))
(assert (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_208 (Tuple Int))) (not (or (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_210 (Tuple Int))) (and (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_211 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_211) ((_ tuple.select 0) tuple_208)))) SupportCalled)) (> ((_ tuple.select 0) tuple_210) ((_ tuple.select 0) tuple_208)))) SupportCalled))) (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_209 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_209) ((_ tuple.select 0) tuple_208)))) SupportCalled))))) SupportCalled)))
(assert (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_212 (Tuple Int))) (not (or (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_214 (Tuple Int))) (and (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_215 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_215) ((_ tuple.select 0) tuple_212)))) RetryAgreed)) (> ((_ tuple.select 0) tuple_214) ((_ tuple.select 0) tuple_212)))) RetryAgreed))) (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_213 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_213) ((_ tuple.select 0) tuple_212)))) RetryAgreed))))) RetryAgreed)))
...
(assert true)
(assert true)
(assert (= (as set.empty (Set (Tuple Int Bool Int Bool Int))) (set.filter (lambda ((tuple_216 (Tuple Int Bool Int Bool Int))) (not (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_217 (Tuple Int))) (= ((_ tuple.select 0) tuple_217) ((_ tuple.select 0) tuple_216))) time))))) Measure)))
(check-sat)
(get-model)
