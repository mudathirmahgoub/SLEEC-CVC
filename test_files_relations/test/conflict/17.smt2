...
(assert (not (= (as set.empty (Set (Tuple Int Int Bool Int Bool))) (set.filter (lambda ((tuple_249 (Tuple Int Int Bool Int Bool))) (= ((_ tuple.select 0) tuple_249) ((_ tuple.select 1) tuple_249))) (rel.product F Measure)))))
