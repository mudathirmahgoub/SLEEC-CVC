...
(assert (not (= (as set.empty (Set (Tuple Int Int Bool Int Bool))) (set.filter (lambda ((tuple_281 (Tuple Int Int Bool Int Bool))) (= ((_ tuple.select 0) tuple_281) ((_ tuple.select 1) tuple_281))) (rel.product F Measure)))))
