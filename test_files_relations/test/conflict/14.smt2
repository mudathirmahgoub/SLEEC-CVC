...
(assert true)
(assert true)
(assert (= (as set.empty (Set (Tuple Int Bool Int Bool))) (set.filter (lambda ((tuple_318 (Tuple Int Bool Int Bool))) (not (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_319 (Tuple Int))) (= ((_ tuple.select 0) tuple_319) ((_ tuple.select 0) tuple_318))) time))))) Measure)))
(check-sat)
(get-model)
