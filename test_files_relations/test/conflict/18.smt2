...
(assert (not (= (as set.empty (Set (Tuple Int Int Bool Int Bool))) (set.filter (lambda ((tuple_259 (Tuple Int Int Bool Int Bool))) (= ((_ tuple.select 0) tuple_259) ((_ tuple.select 1) tuple_259))) (rel.product H Measure)))))
