...
(assert (not (= (as set.empty (Set (Tuple Int Int Bool Int Bool))) (set.filter (lambda ((tuple_104 (Tuple Int Int Bool Int Bool))) (= ((_ tuple.select 0) tuple_104) ((_ tuple.select 1) tuple_104))) (rel.product C Measure)))))
