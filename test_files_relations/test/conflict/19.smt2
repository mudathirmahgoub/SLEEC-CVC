...
(assert (not (= (as set.empty (Set (Tuple Int Int Bool Int Bool))) (set.filter (lambda ((tuple_271 (Tuple Int Int Bool Int Bool))) (= ((_ tuple.select 0) tuple_271) ((_ tuple.select 1) tuple_271))) (rel.product H Measure)))))
