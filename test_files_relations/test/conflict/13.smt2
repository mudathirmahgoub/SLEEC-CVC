...
(assert (not (= (as set.empty (Set (Tuple Int Int Bool Int Bool))) (set.filter (lambda ((tuple_186 (Tuple Int Int Bool Int Bool))) (= ((_ tuple.select 0) tuple_186) ((_ tuple.select 1) tuple_186))) (rel.product E Measure)))))
