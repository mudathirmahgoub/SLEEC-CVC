...
(assert (not (= (as set.empty (Set (Tuple Int Int Bool Int Bool))) (set.filter (lambda ((tuple_90 (Tuple Int Int Bool Int Bool))) (= ((_ tuple.select 0) tuple_90) ((_ tuple.select 1) tuple_90))) (rel.product C Measure)))))
