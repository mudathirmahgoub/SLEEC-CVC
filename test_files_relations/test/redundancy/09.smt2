...
(assert (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_115 (Tuple Int))) (not (= (as set.empty (Set (Tuple Int Bool Int Bool))) (set.filter (lambda ((tuple_116 (Tuple Int Bool Int Bool))) (and (not (=> true (or (= (as set.empty (Set (Tuple Int Bool Int Bool))) (set.filter (lambda ((tuple_118 (Tuple Int Bool Int Bool))) (not (=> (= (+ ((_ tuple.select 0) tuple_116) 250) ((_ tuple.select 0) tuple_118)) (=> true (or (= (as set.empty (Set (Tuple Int Bool Int Bool))) (set.filter (lambda ((tuple_120 (Tuple Int Bool Int Bool))) (not (=> (= (+ ((_ tuple.select 0) tuple_118) 40) ((_ tuple.select 0) tuple_120)) (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_121 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_121) (+ ((_ tuple.select 0) tuple_120) 0)) (<= ((_ tuple.select 0) tuple_121) (+ ((_ tuple.select 0) tuple_120) 10)))) D)))))) Measure)) (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_119 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_119) (+ ((_ tuple.select 0) tuple_118) 0)) (<= ((_ tuple.select 0) tuple_119) (+ ((_ tuple.select 0) tuple_118) 40)))) D)))))))) Measure)) (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_117 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_117) (+ ((_ tuple.select 0) tuple_115) 0)) (<= ((_ tuple.select 0) tuple_117) (+ ((_ tuple.select 0) tuple_115) 250)))) D)))))) (= ((_ tuple.select 0) tuple_115) ((_ tuple.select 0) tuple_116)))) Measure)))) C))))
