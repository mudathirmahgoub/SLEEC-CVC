...
(assert (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_229 (Tuple Int))) (not (= (as set.empty (Set (Tuple Int Bool Int Bool))) (set.filter (lambda ((tuple_230 (Tuple Int Bool Int Bool))) (and (and (not (and (=> (and true (and (not (> ((_ tuple.select 2) tuple_230) 1)) true)) (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_231 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_231) (+ ((_ tuple.select 0) tuple_229) 0)) (<= ((_ tuple.select 0) tuple_231) (+ ((_ tuple.select 0) tuple_229) 10)))) G)))) (=> (and (> ((_ tuple.select 2) tuple_230) 1) true) (not (= (as set.empty (Set (Tuple Int Int))) (set.filter (lambda ((tuple_233 (Tuple Int Int))) (and (= ((_ tuple.select 1) tuple_233) (+ ((_ tuple.select 0) tuple_229) 10)) (= ((_ tuple.select 0) tuple_233) (+ ((_ tuple.select 0) tuple_229) 0)))) not_G)))))) ((_ tuple.select 1) tuple_230)) (= ((_ tuple.select 0) tuple_229) ((_ tuple.select 0) tuple_230)))) Measure)))) E))))
