...
(assert (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_245 (Tuple Int))) (not (= (as set.empty (Set (Tuple Int Bool Int Bool))) (set.filter (lambda ((tuple_246 (Tuple Int Bool Int Bool))) (and (not (and (=> (and true (and (not ((_ tuple.select 3) tuple_246)) true)) (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_247 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_247) (+ ((_ tuple.select 0) tuple_245) 0)) (<= ((_ tuple.select 0) tuple_247) (+ ((_ tuple.select 0) tuple_245) 5)))) G)))) (=> (and ((_ tuple.select 3) tuple_246) true) (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_248 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_248) (+ ((_ tuple.select 0) tuple_245) 0)) (<= ((_ tuple.select 0) tuple_248) (+ ((_ tuple.select 0) tuple_245) 10)))) H)))))) (= ((_ tuple.select 0) tuple_245) ((_ tuple.select 0) tuple_246)))) Measure)))) F))))
