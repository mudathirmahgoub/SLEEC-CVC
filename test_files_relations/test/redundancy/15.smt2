...
(assert (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_212 (Tuple Int))) (not (= (as set.empty (Set (Tuple Int Bool Int Bool))) (set.filter (lambda ((tuple_213 (Tuple Int Bool Int Bool))) (and (and (not (and (=> (and true (and (not (> ((_ tuple.select 2) tuple_213) 3)) true)) (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_214 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_214) (+ ((_ tuple.select 0) tuple_212) 0)) (<= ((_ tuple.select 0) tuple_214) (+ ((_ tuple.select 0) tuple_212) 10)))) G)))) (=> (and (> ((_ tuple.select 2) tuple_213) 3) true) (not (= (as set.empty (Set (Tuple Int Int))) (set.filter (lambda ((tuple_216 (Tuple Int Int))) (and (= ((_ tuple.select 1) tuple_216) (+ ((_ tuple.select 0) tuple_212) 10)) (= ((_ tuple.select 0) tuple_216) (+ ((_ tuple.select 0) tuple_212) 0)))) not_G)))))) ((_ tuple.select 1) tuple_213)) (= ((_ tuple.select 0) tuple_212) ((_ tuple.select 0) tuple_213)))) Measure)))) E))))
