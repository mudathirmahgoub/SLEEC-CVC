...
(assert (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_278 (Tuple Int))) (not (= (as set.empty (Set (Tuple Int Bool Int Bool))) (set.filter (lambda ((tuple_279 (Tuple Int Bool Int Bool))) (and (not (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_280 (Tuple Int))) (>= ((_ tuple.select 0) tuple_280) ((_ tuple.select 0) tuple_278))) G)))) (= ((_ tuple.select 0) tuple_278) ((_ tuple.select 0) tuple_279)))) Measure)))) F))))
