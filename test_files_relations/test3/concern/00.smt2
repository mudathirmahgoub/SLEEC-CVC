...
(assert (= (as set.empty (Set (Tuple Int Int Int Int))) (set.filter (lambda ((tuple_60 (Tuple Int Int Int Int))) (not (=> (= ((_ tuple.select 0) tuple_60) ((_ tuple.select 2) tuple_60)) (and (= ((_ tuple.select 1) tuple_60) ((_ tuple.select 3) tuple_60)) (= ((_ tuple.select 0) tuple_60) ((_ tuple.select 2) tuple_60)))))) (rel.product Measure Measure))))
