...
(assert (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_7 (Tuple Int))) (not (= (as set.empty (Set (Tuple Int Int))) (set.filter (lambda ((tuple_8 (Tuple Int Int))) (and (not (=> true (or (= (as set.empty (Set (Tuple Int Int))) (set.filter (lambda ((tuple_10 (Tuple Int Int))) (not (=> (= (+ ((_ tuple.select 0) tuple_8) 10) ((_ tuple.select 0) tuple_10)) (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_11 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_11) (+ ((_ tuple.select 0) tuple_10) 0)) (<= ((_ tuple.select 0) tuple_11) (+ ((_ tuple.select 0) tuple_10) 5)))) D)))))) Measure)) (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_9 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_9) (+ ((_ tuple.select 0) tuple_7) 0)) (<= ((_ tuple.select 0) tuple_9) (+ ((_ tuple.select 0) tuple_7) 10)))) B)))))) (= ((_ tuple.select 0) tuple_7) ((_ tuple.select 0) tuple_8)))) Measure)))) A))))
...
(assert (=> (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_49 (Tuple Int))) true) A))) (and (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_52 (Tuple Int))) (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_53 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_53) ((_ tuple.select 0) tuple_52)))) A))) A))) (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_50 (Tuple Int))) (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_51 (Tuple Int))) (not (>= ((_ tuple.select 0) tuple_51) ((_ tuple.select 0) tuple_50)))) A))) A))))))
(assert (=> (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_54 (Tuple Int))) true) B))) (and (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_57 (Tuple Int))) (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_58 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_58) ((_ tuple.select 0) tuple_57)))) B))) B))) (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_55 (Tuple Int))) (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_56 (Tuple Int))) (not (>= ((_ tuple.select 0) tuple_56) ((_ tuple.select 0) tuple_55)))) B))) B))))))
(assert (=> (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_59 (Tuple Int))) true) C))) (and (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_62 (Tuple Int))) (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_63 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_63) ((_ tuple.select 0) tuple_62)))) C))) C))) (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_60 (Tuple Int))) (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_61 (Tuple Int))) (not (>= ((_ tuple.select 0) tuple_61) ((_ tuple.select 0) tuple_60)))) C))) C))))))
(assert (=> (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_64 (Tuple Int))) true) D))) (and (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_67 (Tuple Int))) (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_68 (Tuple Int))) (not (<= ((_ tuple.select 0) tuple_68) ((_ tuple.select 0) tuple_67)))) D))) D))) (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_65 (Tuple Int))) (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_66 (Tuple Int))) (not (>= ((_ tuple.select 0) tuple_66) ((_ tuple.select 0) tuple_65)))) D))) D))))))
