...
(assert (= (as set.empty (Set (Tuple Int Int Int Int))) (set.filter (lambda ((tuple_54 (Tuple Int Int Int Int))) (not (=> (= ((_ tuple.select 0) tuple_54) ((_ tuple.select 2) tuple_54)) (and (= ((_ tuple.select 1) tuple_54) ((_ tuple.select 3) tuple_54)) (= ((_ tuple.select 0) tuple_54) ((_ tuple.select 2) tuple_54)))))) (rel.product Measure Measure))))
...
(assert true)
(assert true)
(assert (= (as set.empty (Set (Tuple Int Int))) (set.filter (lambda ((tuple_55 (Tuple Int Int))) (not (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_56 (Tuple Int))) (= ((_ tuple.select 0) tuple_56) ((_ tuple.select 0) tuple_55))) time))))) Measure)))
(check-sat)
(get-model)
