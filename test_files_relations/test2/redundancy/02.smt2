...
(assert (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_34 (Tuple Int))) (not (= (as set.empty (Set (Tuple Int Int))) (set.filter (lambda ((tuple_35 (Tuple Int Int))) (and (not (not (= (as set.empty (Set (Tuple Int Int))) (set.filter (lambda ((tuple_37 (Tuple Int Int))) (and (= ((_ tuple.select 1) tuple_37) (+ ((_ tuple.select 0) tuple_34) 30)) (= ((_ tuple.select 0) tuple_37) (+ ((_ tuple.select 0) tuple_34) 0)))) not_B)))) (= ((_ tuple.select 0) tuple_34) ((_ tuple.select 0) tuple_35)))) Measure)))) A))))
