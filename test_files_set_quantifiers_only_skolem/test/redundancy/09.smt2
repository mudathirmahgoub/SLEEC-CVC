...
(assert (set.exists ((tuple_115 (Tuple Int))) C (set.exists ((tuple_116 (Tuple Int Bool Int Bool))) Measure (and (not (=> true (or (set.forall ((tuple_118 (Tuple Int Bool Int Bool))) Measure (=> (= (+ ((_ tuple.select 0) tuple_116) 250) ((_ tuple.select 0) tuple_118)) (=> true (or (set.forall ((tuple_120 (Tuple Int Bool Int Bool))) Measure (=> (= (+ ((_ tuple.select 0) tuple_118) 40) ((_ tuple.select 0) tuple_120)) (set.exists ((tuple_121 (Tuple Int))) D (and (>= ((_ tuple.select 0) tuple_121) (+ ((_ tuple.select 0) tuple_120) 0)) (<= ((_ tuple.select 0) tuple_121) (+ ((_ tuple.select 0) tuple_120) 10)))))) (set.exists ((tuple_119 (Tuple Int))) D (and (>= ((_ tuple.select 0) tuple_119) (+ ((_ tuple.select 0) tuple_118) 0)) (<= ((_ tuple.select 0) tuple_119) (+ ((_ tuple.select 0) tuple_118) 40)))))))) (set.exists ((tuple_117 (Tuple Int))) D (and (>= ((_ tuple.select 0) tuple_117) (+ ((_ tuple.select 0) tuple_115) 0)) (<= ((_ tuple.select 0) tuple_117) (+ ((_ tuple.select 0) tuple_115) 250))))))) (= ((_ tuple.select 0) tuple_115) ((_ tuple.select 0) tuple_116))))))
