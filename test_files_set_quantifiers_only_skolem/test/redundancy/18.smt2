...
(assert (set.exists ((tuple_256 (Tuple Int))) H (set.exists ((tuple_257 (Tuple Int Bool Int Bool))) Measure (and (not (set.exists ((tuple_258 (Tuple Int))) F (and (>= ((_ tuple.select 0) tuple_258) (+ ((_ tuple.select 0) tuple_256) 0)) (<= ((_ tuple.select 0) tuple_258) (+ ((_ tuple.select 0) tuple_256) 10))))) (= ((_ tuple.select 0) tuple_256) ((_ tuple.select 0) tuple_257))))))
