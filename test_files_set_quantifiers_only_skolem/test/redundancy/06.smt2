...
(assert (set.exists ((tuple_77 (Tuple Int))) C (set.exists ((tuple_78 (Tuple Int Bool Int Bool))) Measure (and (not (set.exists ((tuple_79 (Tuple Int))) D (and (>= ((_ tuple.select 0) tuple_79) (+ ((_ tuple.select 0) tuple_77) 0)) (<= ((_ tuple.select 0) tuple_79) (+ ((_ tuple.select 0) tuple_77) 300))))) (= ((_ tuple.select 0) tuple_77) ((_ tuple.select 0) tuple_78))))))
