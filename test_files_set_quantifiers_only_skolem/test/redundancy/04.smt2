...
(assert (set.exists ((tuple_51 (Tuple Int))) B (set.exists ((tuple_52 (Tuple Int Bool Int Bool))) Measure (and (and (not (set.exists ((tuple_53 (Tuple Int))) C (and (>= ((_ tuple.select 0) tuple_53) (+ ((_ tuple.select 0) tuple_51) 0)) (<= ((_ tuple.select 0) tuple_53) (+ ((_ tuple.select 0) tuple_51) 0))))) (> ((_ tuple.select 2) tuple_52) 100)) (= ((_ tuple.select 0) tuple_51) ((_ tuple.select 0) tuple_52))))))
