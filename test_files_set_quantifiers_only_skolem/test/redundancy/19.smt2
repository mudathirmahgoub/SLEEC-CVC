...
(assert (set.exists ((tuple_267 (Tuple Int))) H (set.exists ((tuple_268 (Tuple Int Bool Int Bool))) Measure (and (not (set.exists ((tuple_270 (Tuple Int Int))) not_F (and (= ((_ tuple.select 1) tuple_270) (+ ((_ tuple.select 0) tuple_267) 0)) (= ((_ tuple.select 0) tuple_270) (+ ((_ tuple.select 0) tuple_267) 0))))) (= ((_ tuple.select 0) tuple_267) ((_ tuple.select 0) tuple_268))))))
