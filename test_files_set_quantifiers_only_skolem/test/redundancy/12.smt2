...
(assert (set.exists ((tuple_162 (Tuple Int))) C (set.exists ((tuple_163 (Tuple Int Bool Int Bool))) Measure (and (not (=> true (or (set.forall ((tuple_165 (Tuple Int Bool Int Bool))) Measure (=> (= (+ ((_ tuple.select 0) tuple_163) 250) ((_ tuple.select 0) tuple_165)) (=> true (or (set.forall ((tuple_167 (Tuple Int Bool Int Bool))) Measure (=> (= (+ ((_ tuple.select 0) tuple_165) 40) ((_ tuple.select 0) tuple_167)) (=> true (or (set.exists ((tuple_169 (Tuple Int))) D (and (>= ((_ tuple.select 0) tuple_169) (+ ((_ tuple.select 0) tuple_167) 0)) (<= ((_ tuple.select 0) tuple_169) (+ ((_ tuple.select 0) tuple_167) 10)))) (set.exists ((tuple_168 (Tuple Int))) E (and (>= ((_ tuple.select 0) tuple_168) (+ ((_ tuple.select 0) tuple_167) 0)) (<= ((_ tuple.select 0) tuple_168) (+ ((_ tuple.select 0) tuple_167) 0)))))))) (set.exists ((tuple_166 (Tuple Int))) D (and (>= ((_ tuple.select 0) tuple_166) (+ ((_ tuple.select 0) tuple_165) 0)) (<= ((_ tuple.select 0) tuple_166) (+ ((_ tuple.select 0) tuple_165) 40)))))))) (set.exists ((tuple_164 (Tuple Int))) D (and (>= ((_ tuple.select 0) tuple_164) (+ ((_ tuple.select 0) tuple_162) 0)) (<= ((_ tuple.select 0) tuple_164) (+ ((_ tuple.select 0) tuple_162) 250))))))) (= ((_ tuple.select 0) tuple_162) ((_ tuple.select 0) tuple_163))))))
...
(assert (and (and (forall ((H_time_Int_21 Int) (not_H_start_time_Int_22 Int) (not_H_end_time_Int_23 Int)) (=> (and (set.member (tuple not_H_start_time_Int_22 not_H_end_time_Int_23) not_H) (set.member (tuple H_time_Int_21) H)) (not (and (<= H_time_Int_21 not_H_end_time_Int_23) (<= not_H_start_time_Int_22 H_time_Int_21))))) (and (forall ((G_time_Int_18 Int) (not_G_start_time_Int_19 Int) (not_G_end_time_Int_20 Int)) (=> (and (set.member (tuple not_G_start_time_Int_19 not_G_end_time_Int_20) not_G) (set.member (tuple G_time_Int_18) G)) (not (and (<= G_time_Int_18 not_G_end_time_Int_20) (<= not_G_start_time_Int_19 G_time_Int_18))))) (and (forall ((F_time_Int_15 Int) (not_F_start_time_Int_16 Int) (not_F_end_time_Int_17 Int)) (=> (and (set.member (tuple not_F_start_time_Int_16 not_F_end_time_Int_17) not_F) (set.member (tuple F_time_Int_15) F)) (not (and (<= F_time_Int_15 not_F_end_time_Int_17) (<= not_F_start_time_Int_16 F_time_Int_15))))) (and (forall ((E_time_Int_12 Int) (not_E_start_time_Int_13 Int) (not_E_end_time_Int_14 Int)) (=> (and (set.member (tuple not_E_start_time_Int_13 not_E_end_time_Int_14) not_E) (set.member (tuple E_time_Int_12) E)) (not (and (<= E_time_Int_12 not_E_end_time_Int_14) (<= not_E_start_time_Int_13 E_time_Int_12))))) (and (forall ((D_time_Int_9 Int) (not_D_start_time_Int_10 Int) (not_D_end_time_Int_11 Int)) (=> (and (set.member (tuple not_D_start_time_Int_10 not_D_end_time_Int_11) not_D) (set.member (tuple D_time_Int_9) D)) (not (and (<= D_time_Int_9 not_D_end_time_Int_11) (<= not_D_start_time_Int_10 D_time_Int_9))))) (and (forall ((C_time_Int_6 Int) (not_C_start_time_Int_7 Int) (not_C_end_time_Int_8 Int)) (=> (and (set.member (tuple not_C_start_time_Int_7 not_C_end_time_Int_8) not_C) (set.member (tuple C_time_Int_6) C)) (not (and (<= C_time_Int_6 not_C_end_time_Int_8) (<= not_C_start_time_Int_7 C_time_Int_6))))) (and (forall ((B_time_Int_3 Int) (not_B_start_time_Int_4 Int) (not_B_end_time_Int_5 Int)) (=> (and (set.member (tuple not_B_start_time_Int_4 not_B_end_time_Int_5) not_B) (set.member (tuple B_time_Int_3) B)) (not (and (<= B_time_Int_3 not_B_end_time_Int_5) (<= not_B_start_time_Int_4 B_time_Int_3))))) (forall ((A_time_Int_0 Int) (not_A_start_time_Int_1 Int) (not_A_end_time_Int_2 Int)) (=> (and (set.member (tuple not_A_start_time_Int_1 not_A_end_time_Int_2) not_A) (set.member (tuple A_time_Int_0) A)) (not (and (<= A_time_Int_0 not_A_end_time_Int_2) (<= not_A_start_time_Int_1 A_time_Int_0)))))))))))) (set.forall ((tuple_285 (Tuple Int Bool Int Bool Int Bool Int Bool))) (rel.product Measure Measure) (=> (= ((_ tuple.select 0) tuple_285) ((_ tuple.select 4) tuple_285)) (and (= ((_ tuple.select 3) tuple_285) ((_ tuple.select 7) tuple_285)) (and (= ((_ tuple.select 2) tuple_285) ((_ tuple.select 6) tuple_285)) (and (= ((_ tuple.select 1) tuple_285) ((_ tuple.select 5) tuple_285)) (= ((_ tuple.select 0) tuple_285) ((_ tuple.select 4) tuple_285)))))))))
(assert (=> (set.exists ((tuple_286 (Tuple Int))) A true) (and (set.exists ((tuple_289 (Tuple Int))) A (set.forall ((tuple_290 (Tuple Int))) A (<= ((_ tuple.select 0) tuple_290) ((_ tuple.select 0) tuple_289)))) (set.exists ((tuple_287 (Tuple Int))) A (set.forall ((tuple_288 (Tuple Int))) A (>= ((_ tuple.select 0) tuple_288) ((_ tuple.select 0) tuple_287)))))))
(assert (=> (set.exists ((tuple_291 (Tuple Int))) B true) (and (set.exists ((tuple_294 (Tuple Int))) B (set.forall ((tuple_295 (Tuple Int))) B (<= ((_ tuple.select 0) tuple_295) ((_ tuple.select 0) tuple_294)))) (set.exists ((tuple_292 (Tuple Int))) B (set.forall ((tuple_293 (Tuple Int))) B (>= ((_ tuple.select 0) tuple_293) ((_ tuple.select 0) tuple_292)))))))
(assert (=> (set.exists ((tuple_296 (Tuple Int))) C true) (and (set.exists ((tuple_299 (Tuple Int))) C (set.forall ((tuple_300 (Tuple Int))) C (<= ((_ tuple.select 0) tuple_300) ((_ tuple.select 0) tuple_299)))) (set.exists ((tuple_297 (Tuple Int))) C (set.forall ((tuple_298 (Tuple Int))) C (>= ((_ tuple.select 0) tuple_298) ((_ tuple.select 0) tuple_297)))))))
(assert (=> (set.exists ((tuple_301 (Tuple Int))) D true) (and (set.exists ((tuple_304 (Tuple Int))) D (set.forall ((tuple_305 (Tuple Int))) D (<= ((_ tuple.select 0) tuple_305) ((_ tuple.select 0) tuple_304)))) (set.exists ((tuple_302 (Tuple Int))) D (set.forall ((tuple_303 (Tuple Int))) D (>= ((_ tuple.select 0) tuple_303) ((_ tuple.select 0) tuple_302)))))))
(assert (=> (set.exists ((tuple_306 (Tuple Int))) E true) (and (set.exists ((tuple_309 (Tuple Int))) E (set.forall ((tuple_310 (Tuple Int))) E (<= ((_ tuple.select 0) tuple_310) ((_ tuple.select 0) tuple_309)))) (set.exists ((tuple_307 (Tuple Int))) E (set.forall ((tuple_308 (Tuple Int))) E (>= ((_ tuple.select 0) tuple_308) ((_ tuple.select 0) tuple_307)))))))
(assert (=> (set.exists ((tuple_311 (Tuple Int))) F true) (and (set.exists ((tuple_314 (Tuple Int))) F (set.forall ((tuple_315 (Tuple Int))) F (<= ((_ tuple.select 0) tuple_315) ((_ tuple.select 0) tuple_314)))) (set.exists ((tuple_312 (Tuple Int))) F (set.forall ((tuple_313 (Tuple Int))) F (>= ((_ tuple.select 0) tuple_313) ((_ tuple.select 0) tuple_312)))))))
(assert (=> (set.exists ((tuple_316 (Tuple Int))) G true) (and (set.exists ((tuple_319 (Tuple Int))) G (set.forall ((tuple_320 (Tuple Int))) G (<= ((_ tuple.select 0) tuple_320) ((_ tuple.select 0) tuple_319)))) (set.exists ((tuple_317 (Tuple Int))) G (set.forall ((tuple_318 (Tuple Int))) G (>= ((_ tuple.select 0) tuple_318) ((_ tuple.select 0) tuple_317)))))))
(assert (=> (set.exists ((tuple_321 (Tuple Int))) H true) (and (set.exists ((tuple_324 (Tuple Int))) H (set.forall ((tuple_325 (Tuple Int))) H (<= ((_ tuple.select 0) tuple_325) ((_ tuple.select 0) tuple_324)))) (set.exists ((tuple_322 (Tuple Int))) H (set.forall ((tuple_323 (Tuple Int))) H (>= ((_ tuple.select 0) tuple_323) ((_ tuple.select 0) tuple_322)))))))
