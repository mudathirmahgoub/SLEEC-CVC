...
(assert (set.exists ((tuple_195 (Tuple Int))) E (set.exists ((tuple_196 (Tuple Int Bool Int Bool))) Measure (and (and (not (and (=> (and true (and (not (> ((_ tuple.select 2) tuple_196) 2)) true)) (set.exists ((tuple_197 (Tuple Int))) G (and (>= ((_ tuple.select 0) tuple_197) (+ ((_ tuple.select 0) tuple_195) 0)) (<= ((_ tuple.select 0) tuple_197) (+ ((_ tuple.select 0) tuple_195) 10))))) (=> (and (> ((_ tuple.select 2) tuple_196) 2) true) (set.exists ((tuple_199 (Tuple Int Int))) not_G (and (= ((_ tuple.select 1) tuple_199) (+ ((_ tuple.select 0) tuple_195) 10)) (= ((_ tuple.select 0) tuple_199) (+ ((_ tuple.select 0) tuple_195) 0))))))) ((_ tuple.select 1) tuple_196)) (= ((_ tuple.select 0) tuple_195) ((_ tuple.select 0) tuple_196))))))
