...
(assert (set.exists ((tuple_200 (Tuple Int Int Bool Int Bool))) (rel.product E Measure) (and ((_ tuple.select 2) tuple_200) (= ((_ tuple.select 0) tuple_200) ((_ tuple.select 1) tuple_200)))))
