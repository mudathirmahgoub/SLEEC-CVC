...
(assert (set.exists ((tuple_67 (Tuple Int Int Bool Int Bool))) (rel.product A Measure) (and (> ((_ tuple.select 3) tuple_67) 50) (= ((_ tuple.select 0) tuple_67) ((_ tuple.select 1) tuple_67)))))
