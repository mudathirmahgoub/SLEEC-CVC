...
(assert (set.exists ((tuple_7 (Tuple Int))) A (set.exists ((tuple_8 (Tuple Int Int))) Measure (and (not (=> true (or (set.forall ((tuple_10 (Tuple Int Int))) Measure (=> (= (+ ((_ tuple.select 0) tuple_8) 10) ((_ tuple.select 0) tuple_10)) (set.exists ((tuple_11 (Tuple Int))) D (and (>= ((_ tuple.select 0) tuple_11) (+ ((_ tuple.select 0) tuple_10) 0)) (<= ((_ tuple.select 0) tuple_11) (+ ((_ tuple.select 0) tuple_10) 5)))))) (set.exists ((tuple_9 (Tuple Int))) B (and (>= ((_ tuple.select 0) tuple_9) (+ ((_ tuple.select 0) tuple_7) 0)) (<= ((_ tuple.select 0) tuple_9) (+ ((_ tuple.select 0) tuple_7) 10))))))) (= ((_ tuple.select 0) tuple_7) ((_ tuple.select 0) tuple_8))))))
