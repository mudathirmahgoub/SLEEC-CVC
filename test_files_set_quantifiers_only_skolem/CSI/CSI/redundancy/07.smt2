...
(assert (set.exists ((tuple_88 (Tuple Int))) RobotMoving (set.exists ((tuple_89 (Tuple Int Bool Bool Bool Bool Bool Bool Int Int Bool Bool Bool Bool Bool))) Measure (and (and (not (and (=> (and true (and (not ((_ tuple.select 6) tuple_89)) true)) (set.exists ((tuple_90 (Tuple Int))) RobotStopAction (and (>= ((_ tuple.select 0) tuple_90) (+ ((_ tuple.select 0) tuple_88) 0)) (<= ((_ tuple.select 0) tuple_90) (+ ((_ tuple.select 0) tuple_88) 0))))) (=> (and ((_ tuple.select 6) tuple_89) true) (set.exists ((tuple_91 (Tuple Int))) RobotContinueTask (and (>= ((_ tuple.select 0) tuple_91) (+ ((_ tuple.select 0) tuple_88) 0)) (<= ((_ tuple.select 0) tuple_91) (+ ((_ tuple.select 0) tuple_88) 0))))))) ((_ tuple.select 2) tuple_89)) (= ((_ tuple.select 0) tuple_88) ((_ tuple.select 0) tuple_89))))))
