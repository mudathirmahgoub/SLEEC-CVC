...
(assert (set.exists ((tuple_169 (Tuple Int))) PreparingRobot (set.exists ((tuple_170 (Tuple Int Bool Bool Bool Bool Bool Bool Int Int Bool Bool Bool Bool Bool))) Measure (and (not (set.exists ((tuple_171 (Tuple Int))) PrioritizeHumans (and (>= ((_ tuple.select 0) tuple_171) (+ ((_ tuple.select 0) tuple_169) 0)) (<= ((_ tuple.select 0) tuple_171) (+ ((_ tuple.select 0) tuple_169) 0))))) (= ((_ tuple.select 0) tuple_169) ((_ tuple.select 0) tuple_170))))))
