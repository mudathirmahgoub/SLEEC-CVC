...
(assert (set.exists ((tuple_218 (Tuple Int))) RobotWorking (set.exists ((tuple_219 (Tuple Int Bool Bool Bool Bool Bool Bool Int Int Bool Bool Bool Bool Bool))) Measure (and (and (not (set.exists ((tuple_220 (Tuple Int))) ReportIncident (and (>= ((_ tuple.select 0) tuple_220) (+ ((_ tuple.select 0) tuple_218) 0)) (<= ((_ tuple.select 0) tuple_220) (+ ((_ tuple.select 0) tuple_218) 0))))) ((_ tuple.select 13) tuple_219)) (= ((_ tuple.select 0) tuple_218) ((_ tuple.select 0) tuple_219))))))
