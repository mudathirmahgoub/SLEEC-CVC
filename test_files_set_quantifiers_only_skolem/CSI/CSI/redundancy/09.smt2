...
(assert (set.exists ((tuple_115 (Tuple Int))) PreparingRobot (set.exists ((tuple_116 (Tuple Int Bool Bool Bool Bool Bool Bool Int Int Bool Bool Bool Bool Bool))) Measure (and (and (not (and (=> (and true (and (not ((_ tuple.select 10) tuple_116)) true)) (set.exists ((tuple_118 (Tuple Int Int))) not_AssignToRobot (and (= ((_ tuple.select 1) tuple_118) (+ ((_ tuple.select 0) tuple_115) 0)) (= ((_ tuple.select 0) tuple_118) (+ ((_ tuple.select 0) tuple_115) 0))))) (=> (and ((_ tuple.select 10) tuple_116) true) true))) ((_ tuple.select 9) tuple_116)) (= ((_ tuple.select 0) tuple_115) ((_ tuple.select 0) tuple_116))))))
