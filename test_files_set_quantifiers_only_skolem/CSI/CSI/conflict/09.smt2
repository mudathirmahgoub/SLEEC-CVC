...
(assert (set.exists ((tuple_119 (Tuple Int Int Bool Bool Bool Bool Bool Bool Int Int Bool Bool Bool Bool Bool))) (rel.product PreparingRobot Measure) (and ((_ tuple.select 10) tuple_119) (= ((_ tuple.select 0) tuple_119) ((_ tuple.select 1) tuple_119)))))
