...
(assert (set.exists ((tuple_132 (Tuple Int Int Bool Bool Bool Bool Bool Bool Int Int Bool Bool Bool Bool Bool))) (rel.product PreparingRobot Measure) (= ((_ tuple.select 0) tuple_132) ((_ tuple.select 1) tuple_132))))
