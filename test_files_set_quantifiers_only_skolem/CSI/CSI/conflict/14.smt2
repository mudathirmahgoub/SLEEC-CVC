...
(assert (set.exists ((tuple_172 (Tuple Int Int Bool Bool Bool Bool Bool Bool Int Int Bool Bool Bool Bool Bool))) (rel.product PreparingRobot Measure) (= ((_ tuple.select 0) tuple_172) ((_ tuple.select 1) tuple_172))))
