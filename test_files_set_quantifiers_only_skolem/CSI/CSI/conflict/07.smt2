...
(assert (set.exists ((tuple_92 (Tuple Int Int Bool Bool Bool Bool Bool Bool Int Int Bool Bool Bool Bool Bool))) (rel.product RobotMoving Measure) (and ((_ tuple.select 3) tuple_92) (= ((_ tuple.select 0) tuple_92) ((_ tuple.select 1) tuple_92)))))
