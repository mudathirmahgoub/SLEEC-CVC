...
(assert (set.exists ((tuple_107 (Tuple Int Int Bool Bool Bool Bool Bool Bool Int Int Bool Bool Bool Bool Bool))) (rel.product RobotMoving Measure) (= ((_ tuple.select 0) tuple_107) ((_ tuple.select 1) tuple_107))))
