...
(assert (set.exists ((tuple_267 (Tuple Int))) HumanSaysStop (set.exists ((tuple_268 (Tuple Int Bool Bool Bool Bool Bool Bool Int Int Bool Bool Bool Bool Bool))) Measure (and (set.exists ((tuple_270 (Tuple Int Int))) not_RobotStopAction (and (= ((_ tuple.select 1) tuple_270) (+ ((_ tuple.select 0) tuple_267) 0)) (= ((_ tuple.select 0) tuple_270) (+ ((_ tuple.select 0) tuple_267) 0)))) (= ((_ tuple.select 0) tuple_267) ((_ tuple.select 0) tuple_268))))))
