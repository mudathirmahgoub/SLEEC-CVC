...
(assert (set.exists ((tuple_159 (Tuple Int Int Bool Int Bool Int))) (rel.product UserFallen Measure) (and ((_ tuple.select 4) tuple_159) (= ((_ tuple.select 0) tuple_159) ((_ tuple.select 1) tuple_159)))))
