...
(assert (set.exists ((tuple_76 (Tuple Int))) RetryAgreed (set.exists ((tuple_77 (Tuple Int Bool Int Bool Int))) Measure (and (not (and (=> (and true (and (not (= ((_ tuple.select 4) tuple_77) 3)) true)) (set.exists ((tuple_78 (Tuple Int))) DressingStarted (>= ((_ tuple.select 0) tuple_78) ((_ tuple.select 0) tuple_76)))) (=> (and (= ((_ tuple.select 4) tuple_77) 3) true) (=> true (or (set.forall ((tuple_80 (Tuple Int Bool Int Bool Int))) Measure (=> (= (+ ((_ tuple.select 0) tuple_77) 30) ((_ tuple.select 0) tuple_80)) (set.exists ((tuple_81 (Tuple Int))) SupportCalled (and (>= ((_ tuple.select 0) tuple_81) (+ ((_ tuple.select 0) tuple_80) 0)) (<= ((_ tuple.select 0) tuple_81) (+ ((_ tuple.select 0) tuple_80) 30)))))) (set.exists ((tuple_79 (Tuple Int))) DressingStarted (and (>= ((_ tuple.select 0) tuple_79) (+ ((_ tuple.select 0) tuple_76) 0)) (<= ((_ tuple.select 0) tuple_79) (+ ((_ tuple.select 0) tuple_76) 30))))))))) (= ((_ tuple.select 0) tuple_76) ((_ tuple.select 0) tuple_77))))))
