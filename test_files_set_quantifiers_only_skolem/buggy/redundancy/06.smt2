...
(assert (set.exists ((tuple_90 (Tuple Int))) RetryAgreed (set.exists ((tuple_91 (Tuple Int Bool Int Bool Int))) Measure (and (not (or (set.exists ((tuple_93 (Tuple Int))) DressingAbandoned (>= ((_ tuple.select 0) tuple_93) ((_ tuple.select 0) tuple_90))) (set.exists ((tuple_92 (Tuple Int))) DressingComplete (>= ((_ tuple.select 0) tuple_92) ((_ tuple.select 0) tuple_90))))) (= ((_ tuple.select 0) tuple_90) ((_ tuple.select 0) tuple_91))))))
