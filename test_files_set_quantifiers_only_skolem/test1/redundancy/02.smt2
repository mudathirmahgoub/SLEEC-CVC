...
(assert (set.exists ((tuple_25 (Tuple Int))) A (set.exists ((tuple_26 (Tuple Int Int))) Measure (and (and (not (set.exists ((tuple_27 (Tuple Int))) C (and (>= ((_ tuple.select 0) tuple_27) (+ ((_ tuple.select 0) tuple_25) 0)) (<= ((_ tuple.select 0) tuple_27) (+ ((_ tuple.select 0) tuple_25) 15))))) (< ((_ tuple.select 1) tuple_26) 20)) (= ((_ tuple.select 0) tuple_25) ((_ tuple.select 0) tuple_26))))))
