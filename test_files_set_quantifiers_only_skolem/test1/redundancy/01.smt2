...
(assert (set.exists ((tuple_15 (Tuple Int))) B (set.exists ((tuple_16 (Tuple Int Int))) Measure (and (not (set.exists ((tuple_17 (Tuple Int))) C (and (>= ((_ tuple.select 0) tuple_17) (+ ((_ tuple.select 0) tuple_15) 0)) (<= ((_ tuple.select 0) tuple_17) (+ ((_ tuple.select 0) tuple_15) 7))))) (= ((_ tuple.select 0) tuple_15) ((_ tuple.select 0) tuple_16))))))
