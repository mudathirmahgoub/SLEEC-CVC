...
(assert (exists ((UserFallen_time_Int_258 Int)) (and (exists ((Measure_time_Int_259 Int) (Measure_userUnderDressed_Bool_94 Bool) (Measure_roomTemperature_Int_260 Int) (Measure_assentToSupportCalls_Bool_95 Bool) (Measure_userDistressed_Int_261 Int)) (and (and (and (not (not (exists ((SupportCalled_time_Int_262 Int)) (and (and (>= SupportCalled_time_Int_262 (+ UserFallen_time_Int_258 0)) (<= SupportCalled_time_Int_262 (+ UserFallen_time_Int_258 120))) (set.member (tuple SupportCalled_time_Int_262) SupportCalled))))) Measure_assentToSupportCalls_Bool_95) (= UserFallen_time_Int_258 Measure_time_Int_259)) (set.member (tuple Measure_time_Int_259 Measure_userUnderDressed_Bool_94 Measure_roomTemperature_Int_260 Measure_assentToSupportCalls_Bool_95 Measure_userDistressed_Int_261) Measure))) (set.member (tuple UserFallen_time_Int_258) UserFallen))))
...
(assert (forall ((Measure_time_Int_284 Int) (Measure_userUnderDressed_Bool_106 Bool) (Measure_roomTemperature_Int_285 Int) (Measure_assentToSupportCalls_Bool_107 Bool) (Measure_userDistressed_Int_286 Int) (Measure_time_Int_287 Int) (Measure_userUnderDressed_Bool_108 Bool) (Measure_roomTemperature_Int_288 Int) (Measure_assentToSupportCalls_Bool_109 Bool) (Measure_userDistressed_Int_289 Int)) (=> (and (set.member (tuple Measure_time_Int_287 Measure_userUnderDressed_Bool_108 Measure_roomTemperature_Int_288 Measure_assentToSupportCalls_Bool_109 Measure_userDistressed_Int_289) Measure) (set.member (tuple Measure_time_Int_284 Measure_userUnderDressed_Bool_106 Measure_roomTemperature_Int_285 Measure_assentToSupportCalls_Bool_107 Measure_userDistressed_Int_286) Measure)) (=> (= Measure_time_Int_284 Measure_time_Int_287) (and (= Measure_userDistressed_Int_286 Measure_userDistressed_Int_289) (and (= Measure_assentToSupportCalls_Bool_107 Measure_assentToSupportCalls_Bool_109) (and (= Measure_roomTemperature_Int_285 Measure_roomTemperature_Int_288) (and (= Measure_userUnderDressed_Bool_106 Measure_userUnderDressed_Bool_108) (= Measure_time_Int_284 Measure_time_Int_287)))))))))
