...
(assert (set.some (lambda ((tuple_144 (Tuple Int Int Bool Int Bool Int))) (and (or ((_ tuple.select 2) tuple_144) (< ((_ tuple.select 3) tuple_144) 16)) (= ((_ tuple.select 0) tuple_144) ((_ tuple.select 1) tuple_144)))) (rel.product DressingStarted Measure)))
