...
(assert (set.some (lambda ((tuple_157 (Tuple Int Int Bool Int Bool Int))) (and ((_ tuple.select 4) tuple_157) (= ((_ tuple.select 0) tuple_157) ((_ tuple.select 1) tuple_157)))) (rel.product UserFallen Measure)))
