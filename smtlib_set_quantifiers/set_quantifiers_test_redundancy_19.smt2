...
(assert (set.some (lambda ((tuple_258 (Tuple Int))) (set.some (lambda ((tuple_259 (Tuple Int Bool Int Bool))) (and (not (not (set.some (lambda ((tuple_260 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_260) (+ ((_ tuple.select 0) tuple_258) 0)) (<= ((_ tuple.select 0) tuple_260) (+ ((_ tuple.select 0) tuple_258) 0)))) F))) (= ((_ tuple.select 0) tuple_258) ((_ tuple.select 0) tuple_259)))) Measure)) H))
