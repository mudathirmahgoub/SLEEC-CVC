...
(assert (set.some (lambda ((tuple_76 (Tuple Int))) (set.some (lambda ((tuple_77 (Tuple Int Bool Int Bool Int))) (and (not (and (=> (and true (and (not (= ((_ tuple.select 4) tuple_77) 3)) true)) (set.some (lambda ((tuple_78 (Tuple Int))) (>= ((_ tuple.select 0) tuple_78) ((_ tuple.select 0) tuple_76))) DressingStarted)) (=> (and (= ((_ tuple.select 4) tuple_77) 3) true) (=> true (or (set.all (lambda ((tuple_80 (Tuple Int Bool Int Bool Int))) (=> (= (+ ((_ tuple.select 0) tuple_77) 30) ((_ tuple.select 0) tuple_80)) (set.some (lambda ((tuple_81 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_81) (+ ((_ tuple.select 0) tuple_80) 0)) (<= ((_ tuple.select 0) tuple_81) (+ ((_ tuple.select 0) tuple_80) 30)))) SupportCalled))) Measure) (set.some (lambda ((tuple_79 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_79) (+ ((_ tuple.select 0) tuple_76) 0)) (<= ((_ tuple.select 0) tuple_79) (+ ((_ tuple.select 0) tuple_76) 30)))) DressingStarted)))))) (= ((_ tuple.select 0) tuple_76) ((_ tuple.select 0) tuple_77)))) Measure)) RetryAgreed))
