...
(assert (set.some (lambda ((tuple_196 (Tuple Int Int Bool Int Bool))) (and ((_ tuple.select 2) tuple_196) (= ((_ tuple.select 0) tuple_196) ((_ tuple.select 1) tuple_196)))) (rel.product E Measure)))
