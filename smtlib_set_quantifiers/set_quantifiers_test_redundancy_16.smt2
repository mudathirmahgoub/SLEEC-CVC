...
(assert (set.some (lambda ((tuple_222 (Tuple Int))) (set.some (lambda ((tuple_223 (Tuple Int Bool Int Bool))) (and (and (not (and (=> (and true (and (not (> ((_ tuple.select 2) tuple_223) 1)) true)) (set.some (lambda ((tuple_224 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_224) (+ ((_ tuple.select 0) tuple_222) 0)) (<= ((_ tuple.select 0) tuple_224) (+ ((_ tuple.select 0) tuple_222) 10)))) G)) (=> (and (> ((_ tuple.select 2) tuple_223) 1) true) (not (set.some (lambda ((tuple_225 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_225) (+ ((_ tuple.select 0) tuple_222) 0)) (<= ((_ tuple.select 0) tuple_225) (+ ((_ tuple.select 0) tuple_222) 10)))) G))))) ((_ tuple.select 1) tuple_223)) (= ((_ tuple.select 0) tuple_222) ((_ tuple.select 0) tuple_223)))) Measure)) E))
