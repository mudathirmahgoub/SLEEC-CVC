...
(assert (set.some (lambda ((tuple_77 (Tuple Int))) (set.some (lambda ((tuple_78 (Tuple Int Bool Int Bool))) (and (not (set.some (lambda ((tuple_79 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_79) (+ ((_ tuple.select 0) tuple_77) 0)) (<= ((_ tuple.select 0) tuple_79) (+ ((_ tuple.select 0) tuple_77) 300)))) D)) (= ((_ tuple.select 0) tuple_77) ((_ tuple.select 0) tuple_78)))) Measure)) C))
