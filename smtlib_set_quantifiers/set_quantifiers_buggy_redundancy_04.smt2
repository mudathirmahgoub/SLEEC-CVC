...
(assert (set.some (lambda ((tuple_63 (Tuple Int))) (set.some (lambda ((tuple_64 (Tuple Int Bool Int Bool Int))) (and (not (set.some (lambda ((tuple_65 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_65) (+ ((_ tuple.select 0) tuple_63) 1)) (<= ((_ tuple.select 0) tuple_65) (+ ((_ tuple.select 0) tuple_63) 30)))) DressingStarted)) (= ((_ tuple.select 0) tuple_63) ((_ tuple.select 0) tuple_64)))) Measure)) RetryAgreed))
