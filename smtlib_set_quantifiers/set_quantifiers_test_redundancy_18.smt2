...
(assert (set.some (lambda ((tuple_248 (Tuple Int))) (set.some (lambda ((tuple_249 (Tuple Int Bool Int Bool))) (and (not (set.some (lambda ((tuple_250 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_250) (+ ((_ tuple.select 0) tuple_248) 0)) (<= ((_ tuple.select 0) tuple_250) (+ ((_ tuple.select 0) tuple_248) 10)))) F)) (= ((_ tuple.select 0) tuple_248) ((_ tuple.select 0) tuple_249)))) Measure)) H))
