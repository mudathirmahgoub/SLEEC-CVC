...
(assert (set.some (lambda ((tuple_226 (Tuple Int Int Bool Int Bool))) (and ((_ tuple.select 2) tuple_226) (= ((_ tuple.select 0) tuple_226) ((_ tuple.select 1) tuple_226)))) (rel.product E Measure)))
...
(assert (set.all (lambda ((tuple_315 (Tuple Int Bool Int Bool Int Bool Int Bool))) (=> (= ((_ tuple.select 0) tuple_315) ((_ tuple.select 4) tuple_315)) (and (= ((_ tuple.select 3) tuple_315) ((_ tuple.select 7) tuple_315)) (and (= ((_ tuple.select 2) tuple_315) ((_ tuple.select 6) tuple_315)) (and (= ((_ tuple.select 1) tuple_315) ((_ tuple.select 5) tuple_315)) (= ((_ tuple.select 0) tuple_315) ((_ tuple.select 4) tuple_315))))))) (rel.product Measure Measure)))
(assert (=> (set.some (lambda ((tuple_275 (Tuple Int))) true) A) (and (set.some (lambda ((tuple_278 (Tuple Int))) (set.all (lambda ((tuple_279 (Tuple Int))) (<= ((_ tuple.select 0) tuple_279) ((_ tuple.select 0) tuple_278))) A)) A) (set.some (lambda ((tuple_276 (Tuple Int))) (set.all (lambda ((tuple_277 (Tuple Int))) (>= ((_ tuple.select 0) tuple_277) ((_ tuple.select 0) tuple_276))) A)) A))))
(assert (=> (set.some (lambda ((tuple_280 (Tuple Int))) true) B) (and (set.some (lambda ((tuple_283 (Tuple Int))) (set.all (lambda ((tuple_284 (Tuple Int))) (<= ((_ tuple.select 0) tuple_284) ((_ tuple.select 0) tuple_283))) B)) B) (set.some (lambda ((tuple_281 (Tuple Int))) (set.all (lambda ((tuple_282 (Tuple Int))) (>= ((_ tuple.select 0) tuple_282) ((_ tuple.select 0) tuple_281))) B)) B))))
(assert (=> (set.some (lambda ((tuple_285 (Tuple Int))) true) C) (and (set.some (lambda ((tuple_288 (Tuple Int))) (set.all (lambda ((tuple_289 (Tuple Int))) (<= ((_ tuple.select 0) tuple_289) ((_ tuple.select 0) tuple_288))) C)) C) (set.some (lambda ((tuple_286 (Tuple Int))) (set.all (lambda ((tuple_287 (Tuple Int))) (>= ((_ tuple.select 0) tuple_287) ((_ tuple.select 0) tuple_286))) C)) C))))
(assert (=> (set.some (lambda ((tuple_290 (Tuple Int))) true) D) (and (set.some (lambda ((tuple_293 (Tuple Int))) (set.all (lambda ((tuple_294 (Tuple Int))) (<= ((_ tuple.select 0) tuple_294) ((_ tuple.select 0) tuple_293))) D)) D) (set.some (lambda ((tuple_291 (Tuple Int))) (set.all (lambda ((tuple_292 (Tuple Int))) (>= ((_ tuple.select 0) tuple_292) ((_ tuple.select 0) tuple_291))) D)) D))))
(assert (=> (set.some (lambda ((tuple_295 (Tuple Int))) true) E) (and (set.some (lambda ((tuple_298 (Tuple Int))) (set.all (lambda ((tuple_299 (Tuple Int))) (<= ((_ tuple.select 0) tuple_299) ((_ tuple.select 0) tuple_298))) E)) E) (set.some (lambda ((tuple_296 (Tuple Int))) (set.all (lambda ((tuple_297 (Tuple Int))) (>= ((_ tuple.select 0) tuple_297) ((_ tuple.select 0) tuple_296))) E)) E))))
(assert (=> (set.some (lambda ((tuple_300 (Tuple Int))) true) F) (and (set.some (lambda ((tuple_303 (Tuple Int))) (set.all (lambda ((tuple_304 (Tuple Int))) (<= ((_ tuple.select 0) tuple_304) ((_ tuple.select 0) tuple_303))) F)) F) (set.some (lambda ((tuple_301 (Tuple Int))) (set.all (lambda ((tuple_302 (Tuple Int))) (>= ((_ tuple.select 0) tuple_302) ((_ tuple.select 0) tuple_301))) F)) F))))
(assert (=> (set.some (lambda ((tuple_305 (Tuple Int))) true) G) (and (set.some (lambda ((tuple_308 (Tuple Int))) (set.all (lambda ((tuple_309 (Tuple Int))) (<= ((_ tuple.select 0) tuple_309) ((_ tuple.select 0) tuple_308))) G)) G) (set.some (lambda ((tuple_306 (Tuple Int))) (set.all (lambda ((tuple_307 (Tuple Int))) (>= ((_ tuple.select 0) tuple_307) ((_ tuple.select 0) tuple_306))) G)) G))))
(assert (=> (set.some (lambda ((tuple_310 (Tuple Int))) true) H) (and (set.some (lambda ((tuple_313 (Tuple Int))) (set.all (lambda ((tuple_314 (Tuple Int))) (<= ((_ tuple.select 0) tuple_314) ((_ tuple.select 0) tuple_313))) H)) H) (set.some (lambda ((tuple_311 (Tuple Int))) (set.all (lambda ((tuple_312 (Tuple Int))) (>= ((_ tuple.select 0) tuple_312) ((_ tuple.select 0) tuple_311))) H)) H))))
