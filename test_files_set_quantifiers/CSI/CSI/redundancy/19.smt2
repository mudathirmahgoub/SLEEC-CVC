...
(assert (set.exists ((tuple_231 (Tuple Int))) RobotWorking (set.exists ((tuple_232 (Tuple Int Bool Bool Bool Bool Bool Bool Int Int Bool Bool Bool Bool Bool))) Measure (and (and (not (set.exists ((tuple_233 (Tuple Int))) RobotStopAction (and (>= ((_ tuple.select 0) tuple_233) (+ ((_ tuple.select 0) tuple_231) 0)) (<= ((_ tuple.select 0) tuple_233) (+ ((_ tuple.select 0) tuple_231) 0))))) ((_ tuple.select 13) tuple_232)) (= ((_ tuple.select 0) tuple_231) ((_ tuple.select 0) tuple_232))))))
