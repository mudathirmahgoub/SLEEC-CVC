...
(assert (set.exists ((tuple_159 (Tuple Int))) PreparingRobot (set.exists ((tuple_160 (Tuple Int Bool Bool Bool Bool Bool Bool Int Int Bool Bool Bool Bool Bool))) Measure (and (not (set.exists ((tuple_161 (Tuple Int))) MinimizeCobotCollaboration (and (>= ((_ tuple.select 0) tuple_161) (+ ((_ tuple.select 0) tuple_159) 0)) (<= ((_ tuple.select 0) tuple_161) (+ ((_ tuple.select 0) tuple_159) 0))))) (= ((_ tuple.select 0) tuple_159) ((_ tuple.select 0) tuple_160))))))
