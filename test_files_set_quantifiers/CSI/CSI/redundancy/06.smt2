...
(assert (set.exists ((tuple_75 (Tuple Int))) InformHuman (set.exists ((tuple_76 (Tuple Int Bool Bool Bool Bool Bool Bool Int Int Bool Bool Bool Bool Bool))) Measure (and (not (and (=> (and true (and (not ((_ tuple.select 1) tuple_76)) (and (not (not ((_ tuple.select 5) tuple_76))) true))) (set.exists ((tuple_77 (Tuple Int))) RobotMoving (and (>= ((_ tuple.select 0) tuple_77) (+ ((_ tuple.select 0) tuple_75) 0)) (<= ((_ tuple.select 0) tuple_77) (+ ((_ tuple.select 0) tuple_75) 0))))) (and (=> (and ((_ tuple.select 1) tuple_76) (and (not (not ((_ tuple.select 5) tuple_76))) true)) (set.exists ((tuple_78 (Tuple Int))) AdjustRoute (and (>= ((_ tuple.select 0) tuple_78) (+ ((_ tuple.select 0) tuple_75) 0)) (<= ((_ tuple.select 0) tuple_78) (+ ((_ tuple.select 0) tuple_75) 0))))) (=> (and (not ((_ tuple.select 5) tuple_76)) true) (set.exists ((tuple_79 (Tuple Int))) AskPermission (and (>= ((_ tuple.select 0) tuple_79) (+ ((_ tuple.select 0) tuple_75) 0)) (<= ((_ tuple.select 0) tuple_79) (+ ((_ tuple.select 0) tuple_75) 0)))))))) (= ((_ tuple.select 0) tuple_75) ((_ tuple.select 0) tuple_76))))))
