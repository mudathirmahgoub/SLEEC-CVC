...
(assert (set.exists ((tuple_205 (Tuple Int))) PreparingRobot (set.exists ((tuple_206 (Tuple Int Bool Bool Bool Bool Bool Bool Int Int Bool Bool Bool Bool Bool))) Measure (and (and (not (set.exists ((tuple_207 (Tuple Int))) InformHuman (and (>= ((_ tuple.select 0) tuple_207) (+ ((_ tuple.select 0) tuple_205) 0)) (<= ((_ tuple.select 0) tuple_207) (+ ((_ tuple.select 0) tuple_205) 0))))) ((_ tuple.select 12) tuple_206)) (= ((_ tuple.select 0) tuple_205) ((_ tuple.select 0) tuple_206))))))
