...
(assert (set.exists ((tuple_192 (Tuple Int))) RobotWorking (set.exists ((tuple_193 (Tuple Int Bool Bool Bool Bool Bool Bool Int Int Bool Bool Bool Bool Bool))) Measure (and (and (not (set.exists ((tuple_194 (Tuple Int))) ReportIncident (and (>= ((_ tuple.select 0) tuple_194) (+ ((_ tuple.select 0) tuple_192) 0)) (<= ((_ tuple.select 0) tuple_194) (+ ((_ tuple.select 0) tuple_192) 0))))) ((_ tuple.select 11) tuple_193)) (= ((_ tuple.select 0) tuple_192) ((_ tuple.select 0) tuple_193))))))
