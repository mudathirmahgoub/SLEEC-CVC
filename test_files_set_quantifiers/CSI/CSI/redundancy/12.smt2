...
(assert (set.exists ((tuple_149 (Tuple Int))) PreparingRobot (set.exists ((tuple_150 (Tuple Int Bool Bool Bool Bool Bool Bool Int Int Bool Bool Bool Bool Bool))) Measure (and (not (set.exists ((tuple_151 (Tuple Int))) ConsiderAppearance (and (>= ((_ tuple.select 0) tuple_151) (+ ((_ tuple.select 0) tuple_149) 0)) (<= ((_ tuple.select 0) tuple_151) (+ ((_ tuple.select 0) tuple_149) 0))))) (= ((_ tuple.select 0) tuple_149) ((_ tuple.select 0) tuple_150))))))
