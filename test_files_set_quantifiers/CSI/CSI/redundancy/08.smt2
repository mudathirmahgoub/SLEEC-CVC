...
(assert (set.exists ((tuple_103 (Tuple Int))) RobotMoving (set.exists ((tuple_104 (Tuple Int Bool Bool Bool Bool Bool Bool Int Int Bool Bool Bool Bool Bool))) Measure (and (not (and (=> (and true (and (not (and (= ((_ tuple.select 7) tuple_104) 0) (= ((_ tuple.select 8) tuple_104) 0))) true)) (set.exists ((tuple_105 (Tuple Int))) MoveAtSafeSpeed (and (>= ((_ tuple.select 0) tuple_105) (+ ((_ tuple.select 0) tuple_103) 0)) (<= ((_ tuple.select 0) tuple_105) (+ ((_ tuple.select 0) tuple_103) 0))))) (=> (and (and (= ((_ tuple.select 7) tuple_104) 0) (= ((_ tuple.select 8) tuple_104) 0)) true) (set.exists ((tuple_106 (Tuple Int))) IncreaseSpeed (and (>= ((_ tuple.select 0) tuple_106) (+ ((_ tuple.select 0) tuple_103) 0)) (<= ((_ tuple.select 0) tuple_106) (+ ((_ tuple.select 0) tuple_103) 0))))))) (= ((_ tuple.select 0) tuple_103) ((_ tuple.select 0) tuple_104))))))
