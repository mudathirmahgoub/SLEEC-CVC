...
(assert (set.exists ((tuple_182 (Tuple Int Int Bool Bool Bool Bool Bool Bool Int Int Bool Bool Bool Bool Bool))) (rel.product RobotWorking Measure) (and ((_ tuple.select 12) tuple_182) (= ((_ tuple.select 0) tuple_182) ((_ tuple.select 1) tuple_182)))))
