...
(assert (set.exists ((tuple_142 (Tuple Int Int Bool Bool Bool Bool Bool Bool Int Int Bool Bool Bool Bool Bool))) (rel.product PreparingRobot Measure) (= ((_ tuple.select 0) tuple_142) ((_ tuple.select 1) tuple_142))))
