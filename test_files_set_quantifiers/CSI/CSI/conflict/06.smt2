...
(assert (set.exists ((tuple_80 (Tuple Int Int Bool Bool Bool Bool Bool Bool Int Int Bool Bool Bool Bool Bool))) (rel.product InformHuman Measure) (= ((_ tuple.select 0) tuple_80) ((_ tuple.select 1) tuple_80))))
