...
(assert (set.exists ((tuple_208 (Tuple Int Int Bool Bool Bool Bool Bool Bool Int Int Bool Bool Bool Bool Bool))) (rel.product PreparingRobot Measure) (and ((_ tuple.select 13) tuple_208) (= ((_ tuple.select 0) tuple_208) ((_ tuple.select 1) tuple_208)))))
