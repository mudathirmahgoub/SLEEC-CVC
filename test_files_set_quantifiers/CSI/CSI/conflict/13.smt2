...
(assert (set.exists ((tuple_162 (Tuple Int Int Bool Bool Bool Bool Bool Bool Int Int Bool Bool Bool Bool Bool))) (rel.product PreparingRobot Measure) (= ((_ tuple.select 0) tuple_162) ((_ tuple.select 1) tuple_162))))
