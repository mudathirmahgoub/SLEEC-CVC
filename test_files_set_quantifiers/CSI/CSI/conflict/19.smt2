...
(assert (set.exists ((tuple_234 (Tuple Int Int Bool Bool Bool Bool Bool Bool Int Int Bool Bool Bool Bool Bool))) (rel.product RobotWorking Measure) (and ((_ tuple.select 14) tuple_234) (= ((_ tuple.select 0) tuple_234) ((_ tuple.select 1) tuple_234)))))
