...
(assert (set.exists ((tuple_263 (Tuple Int))) TrackHumanLocation (set.exists ((tuple_264 (Tuple Int Bool Bool Bool Bool Bool Bool Int Int Bool Bool Bool Bool Bool))) Measure (and (and (set.exists ((tuple_266 (Tuple Int Int))) not_InformHuman (and (= ((_ tuple.select 1) tuple_266) (+ ((_ tuple.select 0) tuple_263) 0)) (= ((_ tuple.select 0) tuple_266) (+ ((_ tuple.select 0) tuple_263) 0)))) ((_ tuple.select 4) tuple_264)) (= ((_ tuple.select 0) tuple_263) ((_ tuple.select 0) tuple_264))))))
