...
(assert (set.some (lambda ((tuple_211 (Tuple Int Int Bool Int Bool))) (and ((_ tuple.select 2) tuple_211) (= ((_ tuple.select 0) tuple_211) ((_ tuple.select 1) tuple_211)))) (rel.product E Measure)))
