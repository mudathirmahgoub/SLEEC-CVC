...
(assert (set.exists ((tuple_54 (Tuple Int Int Bool Int Bool))) (rel.product B Measure) (and (> ((_ tuple.select 3) tuple_54) 100) (= ((_ tuple.select 0) tuple_54) ((_ tuple.select 1) tuple_54)))))
