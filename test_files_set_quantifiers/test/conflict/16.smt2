...
(assert (set.exists ((tuple_234 (Tuple Int Int Bool Int Bool))) (rel.product E Measure) (and ((_ tuple.select 2) tuple_234) (= ((_ tuple.select 0) tuple_234) ((_ tuple.select 1) tuple_234)))))
