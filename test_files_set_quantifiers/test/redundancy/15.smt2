...
(assert (set.exists ((tuple_212 (Tuple Int))) E (set.exists ((tuple_213 (Tuple Int Bool Int Bool))) Measure (and (and (not (and (=> (and true (and (not (> ((_ tuple.select 2) tuple_213) 3)) true)) (set.exists ((tuple_214 (Tuple Int))) G (and (>= ((_ tuple.select 0) tuple_214) (+ ((_ tuple.select 0) tuple_212) 0)) (<= ((_ tuple.select 0) tuple_214) (+ ((_ tuple.select 0) tuple_212) 10))))) (=> (and (> ((_ tuple.select 2) tuple_213) 3) true) (set.exists ((tuple_216 (Tuple Int Int))) not_G (and (= ((_ tuple.select 1) tuple_216) (+ ((_ tuple.select 0) tuple_212) 10)) (= ((_ tuple.select 0) tuple_216) (+ ((_ tuple.select 0) tuple_212) 0))))))) ((_ tuple.select 1) tuple_213)) (= ((_ tuple.select 0) tuple_212) ((_ tuple.select 0) tuple_213))))))
