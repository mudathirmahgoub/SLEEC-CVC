...
(assert (set.exists ((tuple_229 (Tuple Int))) E (set.exists ((tuple_230 (Tuple Int Bool Int Bool))) Measure (and (and (not (and (=> (and true (and (not (> ((_ tuple.select 2) tuple_230) 1)) true)) (set.exists ((tuple_231 (Tuple Int))) G (and (>= ((_ tuple.select 0) tuple_231) (+ ((_ tuple.select 0) tuple_229) 0)) (<= ((_ tuple.select 0) tuple_231) (+ ((_ tuple.select 0) tuple_229) 10))))) (=> (and (> ((_ tuple.select 2) tuple_230) 1) true) (set.exists ((tuple_233 (Tuple Int Int))) not_G (and (= ((_ tuple.select 1) tuple_233) (+ ((_ tuple.select 0) tuple_229) 10)) (= ((_ tuple.select 0) tuple_233) (+ ((_ tuple.select 0) tuple_229) 0))))))) ((_ tuple.select 1) tuple_230)) (= ((_ tuple.select 0) tuple_229) ((_ tuple.select 0) tuple_230))))))
