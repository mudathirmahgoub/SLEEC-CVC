...
(assert (set.exists ((tuple_133 (Tuple Int))) C (set.exists ((tuple_134 (Tuple Int Bool Int Bool))) Measure (and (not (=> true (or (set.forall ((tuple_136 (Tuple Int Bool Int Bool))) Measure (=> (= (+ ((_ tuple.select 0) tuple_134) 250) ((_ tuple.select 0) tuple_136)) (=> true (or (set.forall ((tuple_138 (Tuple Int Bool Int Bool))) Measure (=> (= (+ ((_ tuple.select 0) tuple_136) 40) ((_ tuple.select 0) tuple_138)) (and (=> (and true (and (not ((_ tuple.select 1) tuple_138)) true)) (set.exists ((tuple_139 (Tuple Int))) D (and (>= ((_ tuple.select 0) tuple_139) (+ ((_ tuple.select 0) tuple_138) 0)) (<= ((_ tuple.select 0) tuple_139) (+ ((_ tuple.select 0) tuple_138) 10))))) (=> (and ((_ tuple.select 1) tuple_138) true) true)))) (set.exists ((tuple_137 (Tuple Int))) D (and (>= ((_ tuple.select 0) tuple_137) (+ ((_ tuple.select 0) tuple_136) 0)) (<= ((_ tuple.select 0) tuple_137) (+ ((_ tuple.select 0) tuple_136) 40)))))))) (set.exists ((tuple_135 (Tuple Int))) D (and (>= ((_ tuple.select 0) tuple_135) (+ ((_ tuple.select 0) tuple_133) 0)) (<= ((_ tuple.select 0) tuple_135) (+ ((_ tuple.select 0) tuple_133) 250))))))) (= ((_ tuple.select 0) tuple_133) ((_ tuple.select 0) tuple_134))))))
