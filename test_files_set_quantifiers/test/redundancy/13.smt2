...
(assert (set.exists ((tuple_180 (Tuple Int))) E (set.exists ((tuple_181 (Tuple Int Bool Int Bool))) Measure (and (not (and (=> (and true (and (not ((_ tuple.select 1) tuple_181)) (and (not (> ((_ tuple.select 2) tuple_181) 2)) true))) (set.exists ((tuple_182 (Tuple Int))) F (and (>= ((_ tuple.select 0) tuple_182) (+ ((_ tuple.select 0) tuple_180) 0)) (<= ((_ tuple.select 0) tuple_182) (+ ((_ tuple.select 0) tuple_180) 5))))) (and (=> (and ((_ tuple.select 1) tuple_181) (and (not (> ((_ tuple.select 2) tuple_181) 2)) true)) (set.exists ((tuple_183 (Tuple Int))) G (and (>= ((_ tuple.select 0) tuple_183) (+ ((_ tuple.select 0) tuple_180) 0)) (<= ((_ tuple.select 0) tuple_183) (+ ((_ tuple.select 0) tuple_180) 10))))) (=> (and (> ((_ tuple.select 2) tuple_181) 2) true) (set.exists ((tuple_185 (Tuple Int Int))) not_G (and (= ((_ tuple.select 1) tuple_185) (+ ((_ tuple.select 0) tuple_180) 20)) (= ((_ tuple.select 0) tuple_185) (+ ((_ tuple.select 0) tuple_180) 0)))))))) (= ((_ tuple.select 0) tuple_180) ((_ tuple.select 0) tuple_181))))))
