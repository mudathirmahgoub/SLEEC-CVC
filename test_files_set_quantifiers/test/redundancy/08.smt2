...
(assert (set.exists ((tuple_99 (Tuple Int))) C (set.exists ((tuple_100 (Tuple Int Bool Int Bool))) Measure (and (not (=> true (or (set.forall ((tuple_102 (Tuple Int Bool Int Bool))) Measure (=> (= (+ ((_ tuple.select 0) tuple_100) 250) ((_ tuple.select 0) tuple_102)) (set.exists ((tuple_103 (Tuple Int))) D (and (>= ((_ tuple.select 0) tuple_103) (+ ((_ tuple.select 0) tuple_102) 0)) (<= ((_ tuple.select 0) tuple_103) (+ ((_ tuple.select 0) tuple_102) 51)))))) (set.exists ((tuple_101 (Tuple Int))) D (and (>= ((_ tuple.select 0) tuple_101) (+ ((_ tuple.select 0) tuple_99) 0)) (<= ((_ tuple.select 0) tuple_101) (+ ((_ tuple.select 0) tuple_99) 250))))))) (= ((_ tuple.select 0) tuple_99) ((_ tuple.select 0) tuple_100))))))
