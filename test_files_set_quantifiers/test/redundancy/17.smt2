...
(assert (set.exists ((tuple_245 (Tuple Int))) F (set.exists ((tuple_246 (Tuple Int Bool Int Bool))) Measure (and (not (and (=> (and true (and (not ((_ tuple.select 3) tuple_246)) true)) (set.exists ((tuple_247 (Tuple Int))) G (and (>= ((_ tuple.select 0) tuple_247) (+ ((_ tuple.select 0) tuple_245) 0)) (<= ((_ tuple.select 0) tuple_247) (+ ((_ tuple.select 0) tuple_245) 5))))) (=> (and ((_ tuple.select 3) tuple_246) true) (set.exists ((tuple_248 (Tuple Int))) H (and (>= ((_ tuple.select 0) tuple_248) (+ ((_ tuple.select 0) tuple_245) 0)) (<= ((_ tuple.select 0) tuple_248) (+ ((_ tuple.select 0) tuple_245) 10))))))) (= ((_ tuple.select 0) tuple_245) ((_ tuple.select 0) tuple_246))))))
