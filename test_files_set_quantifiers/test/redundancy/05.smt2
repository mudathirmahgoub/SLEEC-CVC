...
(assert (set.exists ((tuple_64 (Tuple Int))) A (set.exists ((tuple_65 (Tuple Int Bool Int Bool))) Measure (and (and (not (set.exists ((tuple_66 (Tuple Int))) C (and (>= ((_ tuple.select 0) tuple_66) (+ ((_ tuple.select 0) tuple_64) 0)) (<= ((_ tuple.select 0) tuple_66) (+ ((_ tuple.select 0) tuple_64) 0))))) (> ((_ tuple.select 2) tuple_65) 50)) (= ((_ tuple.select 0) tuple_64) ((_ tuple.select 0) tuple_65))))))
