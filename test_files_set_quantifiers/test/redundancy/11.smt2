...
(assert (set.exists ((tuple_147 (Tuple Int))) C (set.exists ((tuple_148 (Tuple Int Bool Int Bool))) Measure (and (not (set.exists ((tuple_149 (Tuple Int))) E (and (>= ((_ tuple.select 0) tuple_149) (+ ((_ tuple.select 0) tuple_147) 0)) (<= ((_ tuple.select 0) tuple_149) (+ ((_ tuple.select 0) tuple_147) 250))))) (= ((_ tuple.select 0) tuple_147) ((_ tuple.select 0) tuple_148))))))
