...
(assert (set.some (lambda ((tuple_268 (Tuple Int))) (set.some (lambda ((tuple_269 (Tuple Int Bool Int Bool))) (and (not (set.some (lambda ((tuple_270 (Tuple Int))) (>= ((_ tuple.select 0) tuple_270) ((_ tuple.select 0) tuple_268))) G)) (= ((_ tuple.select 0) tuple_268) ((_ tuple.select 0) tuple_269)))) Measure)) F))
