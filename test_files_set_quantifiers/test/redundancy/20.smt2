...
(assert (set.exists ((tuple_278 (Tuple Int))) F (set.exists ((tuple_279 (Tuple Int Bool Int Bool))) Measure (and (not (set.exists ((tuple_280 (Tuple Int))) G (>= ((_ tuple.select 0) tuple_280) ((_ tuple.select 0) tuple_278)))) (= ((_ tuple.select 0) tuple_278) ((_ tuple.select 0) tuple_279))))))
