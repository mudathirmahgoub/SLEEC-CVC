...
(assert (set.exists ((tuple_87 (Tuple Int))) C (set.exists ((tuple_88 (Tuple Int Bool Int Bool))) Measure (and (not (set.exists ((tuple_89 (Tuple Int))) D (and (>= ((_ tuple.select 0) tuple_89) (+ ((_ tuple.select 0) tuple_87) 0)) (<= ((_ tuple.select 0) tuple_89) (+ ((_ tuple.select 0) tuple_87) 301))))) (= ((_ tuple.select 0) tuple_87) ((_ tuple.select 0) tuple_88))))))
