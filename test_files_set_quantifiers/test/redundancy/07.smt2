...
(assert (set.some (lambda ((tuple_87 (Tuple Int))) (set.some (lambda ((tuple_88 (Tuple Int Bool Int Bool))) (and (not (set.some (lambda ((tuple_89 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_89) (+ ((_ tuple.select 0) tuple_87) 0)) (<= ((_ tuple.select 0) tuple_89) (+ ((_ tuple.select 0) tuple_87) 301)))) D)) (= ((_ tuple.select 0) tuple_87) ((_ tuple.select 0) tuple_88)))) Measure)) C))
