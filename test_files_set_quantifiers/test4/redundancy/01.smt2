...
(assert (set.exists ((tuple_21 (Tuple Int))) C (set.exists ((tuple_22 (Tuple Int Int))) Measure (and (not (=> true (or (set.forall ((tuple_24 (Tuple Int Int))) Measure (=> (= (+ ((_ tuple.select 0) tuple_22) 10) ((_ tuple.select 0) tuple_24)) (set.exists ((tuple_25 (Tuple Int))) B (and (>= ((_ tuple.select 0) tuple_25) (+ ((_ tuple.select 0) tuple_24) 0)) (<= ((_ tuple.select 0) tuple_25) (+ ((_ tuple.select 0) tuple_24) 5)))))) (set.exists ((tuple_23 (Tuple Int))) A (and (>= ((_ tuple.select 0) tuple_23) (+ ((_ tuple.select 0) tuple_21) 1)) (<= ((_ tuple.select 0) tuple_23) (+ ((_ tuple.select 0) tuple_21) 10))))))) (= ((_ tuple.select 0) tuple_21) ((_ tuple.select 0) tuple_22))))))
