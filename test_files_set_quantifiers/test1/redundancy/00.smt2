...
(assert (set.exists ((tuple_5 (Tuple Int))) A (set.exists ((tuple_6 (Tuple Int Int))) Measure (and (not (set.exists ((tuple_7 (Tuple Int))) B (and (>= ((_ tuple.select 0) tuple_7) (+ ((_ tuple.select 0) tuple_5) 0)) (<= ((_ tuple.select 0) tuple_7) (+ ((_ tuple.select 0) tuple_5) 7))))) (= ((_ tuple.select 0) tuple_5) ((_ tuple.select 0) tuple_6))))))
