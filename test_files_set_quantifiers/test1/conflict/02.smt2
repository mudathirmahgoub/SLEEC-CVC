...
(assert (set.exists ((tuple_28 (Tuple Int Int Int))) (rel.product A Measure) (and (< ((_ tuple.select 2) tuple_28) 20) (= ((_ tuple.select 0) tuple_28) ((_ tuple.select 1) tuple_28)))))
