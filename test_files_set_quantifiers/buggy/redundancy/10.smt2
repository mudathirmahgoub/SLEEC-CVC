...
(assert (set.exists ((tuple_140 (Tuple Int))) DressingStarted (set.exists ((tuple_141 (Tuple Int Bool Int Bool Int))) Measure (and (and (not (or (set.exists ((tuple_143 (Tuple Int))) DressingComplete (and (>= ((_ tuple.select 0) tuple_143) (+ ((_ tuple.select 0) tuple_140) 0)) (<= ((_ tuple.select 0) tuple_143) (+ ((_ tuple.select 0) tuple_140) 60)))) (set.exists ((tuple_142 (Tuple Int))) DressingAbandoned (and (>= ((_ tuple.select 0) tuple_142) (+ ((_ tuple.select 0) tuple_140) 0)) (<= ((_ tuple.select 0) tuple_142) (+ ((_ tuple.select 0) tuple_140) 120)))))) (or ((_ tuple.select 1) tuple_141) (< ((_ tuple.select 2) tuple_141) 16))) (= ((_ tuple.select 0) tuple_140) ((_ tuple.select 0) tuple_141))))))
