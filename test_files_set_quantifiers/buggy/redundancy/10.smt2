...
(assert (set.some (lambda ((tuple_140 (Tuple Int))) (set.some (lambda ((tuple_141 (Tuple Int Bool Int Bool Int))) (and (and (not (or (set.some (lambda ((tuple_143 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_143) (+ ((_ tuple.select 0) tuple_140) 0)) (<= ((_ tuple.select 0) tuple_143) (+ ((_ tuple.select 0) tuple_140) 60)))) DressingComplete) (set.some (lambda ((tuple_142 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_142) (+ ((_ tuple.select 0) tuple_140) 0)) (<= ((_ tuple.select 0) tuple_142) (+ ((_ tuple.select 0) tuple_140) 120)))) DressingAbandoned))) (or ((_ tuple.select 1) tuple_141) (< ((_ tuple.select 2) tuple_141) 16))) (= ((_ tuple.select 0) tuple_140) ((_ tuple.select 0) tuple_141)))) Measure)) DressingStarted))
