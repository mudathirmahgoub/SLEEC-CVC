...
(assert (set.exists ((tuple_155 (Tuple Int))) UserFallen (set.exists ((tuple_156 (Tuple Int Bool Int Bool Int))) Measure (and (and (not (set.exists ((tuple_158 (Tuple Int Int))) not_SupportCalled (and (= ((_ tuple.select 1) tuple_158) (+ ((_ tuple.select 0) tuple_155) 120)) (= ((_ tuple.select 0) tuple_158) (+ ((_ tuple.select 0) tuple_155) 0))))) ((_ tuple.select 3) tuple_156)) (= ((_ tuple.select 0) tuple_155) ((_ tuple.select 0) tuple_156))))))
