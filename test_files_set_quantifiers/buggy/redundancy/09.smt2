...
(assert (set.exists ((tuple_127 (Tuple Int))) DressingAbandoned (set.exists ((tuple_128 (Tuple Int Bool Int Bool Int))) Measure (and (not (=> true (or (set.forall ((tuple_130 (Tuple Int Bool Int Bool Int))) Measure (=> (= (+ ((_ tuple.select 0) tuple_128) 1800) ((_ tuple.select 0) tuple_130)) (and (=> (and true (and (not (not ((_ tuple.select 3) tuple_130))) true)) (set.exists ((tuple_131 (Tuple Int))) SupportCalled (and (>= ((_ tuple.select 0) tuple_131) (+ ((_ tuple.select 0) tuple_130) 0)) (<= ((_ tuple.select 0) tuple_131) (+ ((_ tuple.select 0) tuple_130) 0))))) (=> (and (not ((_ tuple.select 3) tuple_130)) true) true)))) (set.exists ((tuple_129 (Tuple Int))) RetryAgreed (and (>= ((_ tuple.select 0) tuple_129) (+ ((_ tuple.select 0) tuple_127) 0)) (<= ((_ tuple.select 0) tuple_129) (+ ((_ tuple.select 0) tuple_127) 1800))))))) (= ((_ tuple.select 0) tuple_127) ((_ tuple.select 0) tuple_128))))))
