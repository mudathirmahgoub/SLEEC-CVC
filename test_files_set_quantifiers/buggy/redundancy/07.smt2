...
(assert (set.exists ((tuple_103 (Tuple Int))) CurtainOpenRqt (set.exists ((tuple_104 (Tuple Int Bool Int Bool Int))) Measure (and (not (and (=> (and true (and (not ((_ tuple.select 1) tuple_104)) (and (not (> ((_ tuple.select 4) tuple_104) 2)) true))) (set.exists ((tuple_105 (Tuple Int))) CurtainsOpened (and (>= ((_ tuple.select 0) tuple_105) (+ ((_ tuple.select 0) tuple_103) 0)) (<= ((_ tuple.select 0) tuple_105) (+ ((_ tuple.select 0) tuple_103) 60))))) (and (=> (and ((_ tuple.select 1) tuple_104) (and (not (> ((_ tuple.select 4) tuple_104) 2)) true)) (set.exists ((tuple_106 (Tuple Int))) RefuseRequest (and (>= ((_ tuple.select 0) tuple_106) (+ ((_ tuple.select 0) tuple_103) 0)) (<= ((_ tuple.select 0) tuple_106) (+ ((_ tuple.select 0) tuple_103) 30))))) (=> (and (> ((_ tuple.select 4) tuple_104) 2) true) (set.exists ((tuple_107 (Tuple Int))) CurtainsOpened (and (>= ((_ tuple.select 0) tuple_107) (+ ((_ tuple.select 0) tuple_103) 0)) (<= ((_ tuple.select 0) tuple_107) (+ ((_ tuple.select 0) tuple_103) 60)))))))) (= ((_ tuple.select 0) tuple_103) ((_ tuple.select 0) tuple_104))))))
