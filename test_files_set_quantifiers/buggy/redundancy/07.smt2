...
(assert (set.some (lambda ((tuple_103 (Tuple Int))) (set.some (lambda ((tuple_104 (Tuple Int Bool Int Bool Int))) (and (not (and (=> (and true (and (not ((_ tuple.select 1) tuple_104)) (and (not (> ((_ tuple.select 4) tuple_104) 2)) true))) (set.some (lambda ((tuple_105 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_105) (+ ((_ tuple.select 0) tuple_103) 0)) (<= ((_ tuple.select 0) tuple_105) (+ ((_ tuple.select 0) tuple_103) 60)))) CurtainsOpened)) (and (=> (and ((_ tuple.select 1) tuple_104) (and (not (> ((_ tuple.select 4) tuple_104) 2)) true)) (set.some (lambda ((tuple_106 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_106) (+ ((_ tuple.select 0) tuple_103) 0)) (<= ((_ tuple.select 0) tuple_106) (+ ((_ tuple.select 0) tuple_103) 30)))) RefuseRequest)) (=> (and (> ((_ tuple.select 4) tuple_104) 2) true) (set.some (lambda ((tuple_107 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_107) (+ ((_ tuple.select 0) tuple_103) 0)) (<= ((_ tuple.select 0) tuple_107) (+ ((_ tuple.select 0) tuple_103) 60)))) CurtainsOpened))))) (= ((_ tuple.select 0) tuple_103) ((_ tuple.select 0) tuple_104)))) Measure)) CurtainOpenRqt))
