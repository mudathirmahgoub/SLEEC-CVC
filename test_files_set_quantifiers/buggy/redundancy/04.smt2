...
(assert (set.exists ((tuple_63 (Tuple Int))) RetryAgreed (set.exists ((tuple_64 (Tuple Int Bool Int Bool Int))) Measure (and (not (set.exists ((tuple_65 (Tuple Int))) DressingStarted (and (>= ((_ tuple.select 0) tuple_65) (+ ((_ tuple.select 0) tuple_63) 1)) (<= ((_ tuple.select 0) tuple_65) (+ ((_ tuple.select 0) tuple_63) 30))))) (= ((_ tuple.select 0) tuple_63) ((_ tuple.select 0) tuple_64))))))
