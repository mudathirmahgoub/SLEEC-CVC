...
(assert (set.some (lambda ((tuple_115 (Tuple Int))) (set.some (lambda ((tuple_116 (Tuple Int Bool Int Bool Int))) (and (not (and (=> (and true (and (not (not ((_ tuple.select 3) tuple_116))) true)) (set.some (lambda ((tuple_117 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_117) (+ ((_ tuple.select 0) tuple_115) 0)) (<= ((_ tuple.select 0) tuple_117) (+ ((_ tuple.select 0) tuple_115) 0)))) SupportCalled)) (=> (and (not ((_ tuple.select 3) tuple_116)) true) true))) (= ((_ tuple.select 0) tuple_115) ((_ tuple.select 0) tuple_116)))) Measure)) UserFallen))
