...
(assert (set.exists ((tuple_115 (Tuple Int))) UserFallen (set.exists ((tuple_116 (Tuple Int Bool Int Bool Int))) Measure (and (not (and (=> (and true (and (not (not ((_ tuple.select 3) tuple_116))) true)) (set.exists ((tuple_117 (Tuple Int))) SupportCalled (and (>= ((_ tuple.select 0) tuple_117) (+ ((_ tuple.select 0) tuple_115) 0)) (<= ((_ tuple.select 0) tuple_117) (+ ((_ tuple.select 0) tuple_115) 0))))) (=> (and (not ((_ tuple.select 3) tuple_116)) true) true))) (= ((_ tuple.select 0) tuple_115) ((_ tuple.select 0) tuple_116))))))
