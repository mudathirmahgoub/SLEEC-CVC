...
(assert (set.exists ((tuple_132 (Tuple Int Int Bool Int Bool Int))) (rel.product DressingAbandoned Measure) (= ((_ tuple.select 0) tuple_132) ((_ tuple.select 1) tuple_132))))
