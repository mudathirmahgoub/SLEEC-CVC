...
(assert (not (= (as set.empty (Set (Tuple Int Int Bool Int Bool))) (set.filter (lambda ((tuple_261 (Tuple Int Int Bool Int Bool))) (= ((_ tuple.select 0) tuple_261) ((_ tuple.select 1) tuple_261))) (rel.product H Measure)))))
