...
(assert (set.some (lambda ((tuple_234 (Tuple Int Int Bool Int Bool))) (and ((_ tuple.select 2) tuple_234) (= ((_ tuple.select 0) tuple_234) ((_ tuple.select 1) tuple_234)))) (rel.product E Measure)))
