...
(assert (not (= (as set.empty (Set (Tuple Int Int Bool Int Bool))) (set.filter (lambda ((tuple_226 (Tuple Int Int Bool Int Bool))) (and ((_ tuple.select 2) tuple_226) (= ((_ tuple.select 0) tuple_226) ((_ tuple.select 1) tuple_226)))) (rel.product E Measure)))))
