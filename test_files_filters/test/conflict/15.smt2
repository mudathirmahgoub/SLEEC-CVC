...
(assert (set.some (lambda ((tuple_217 (Tuple Int Int Bool Int Bool))) (and ((_ tuple.select 2) tuple_217) (= ((_ tuple.select 0) tuple_217) ((_ tuple.select 1) tuple_217)))) (rel.product E Measure)))
...
(assert (and (and (forall ((H_time_Int_21 Int) (not_H_start_time_Int_22 Int) (not_H_end_time_Int_23 Int)) (=> (and (set.member (tuple not_H_start_time_Int_22 not_H_end_time_Int_23) not_H) (set.member (tuple H_time_Int_21) H)) (not (and (<= H_time_Int_21 not_H_end_time_Int_23) (<= not_H_start_time_Int_22 H_time_Int_21))))) (and (forall ((G_time_Int_18 Int) (not_G_start_time_Int_19 Int) (not_G_end_time_Int_20 Int)) (=> (and (set.member (tuple not_G_start_time_Int_19 not_G_end_time_Int_20) not_G) (set.member (tuple G_time_Int_18) G)) (not (and (<= G_time_Int_18 not_G_end_time_Int_20) (<= not_G_start_time_Int_19 G_time_Int_18))))) (and (forall ((F_time_Int_15 Int) (not_F_start_time_Int_16 Int) (not_F_end_time_Int_17 Int)) (=> (and (set.member (tuple not_F_start_time_Int_16 not_F_end_time_Int_17) not_F) (set.member (tuple F_time_Int_15) F)) (not (and (<= F_time_Int_15 not_F_end_time_Int_17) (<= not_F_start_time_Int_16 F_time_Int_15))))) (and (forall ((E_time_Int_12 Int) (not_E_start_time_Int_13 Int) (not_E_end_time_Int_14 Int)) (=> (and (set.member (tuple not_E_start_time_Int_13 not_E_end_time_Int_14) not_E) (set.member (tuple E_time_Int_12) E)) (not (and (<= E_time_Int_12 not_E_end_time_Int_14) (<= not_E_start_time_Int_13 E_time_Int_12))))) (and (forall ((D_time_Int_9 Int) (not_D_start_time_Int_10 Int) (not_D_end_time_Int_11 Int)) (=> (and (set.member (tuple not_D_start_time_Int_10 not_D_end_time_Int_11) not_D) (set.member (tuple D_time_Int_9) D)) (not (and (<= D_time_Int_9 not_D_end_time_Int_11) (<= not_D_start_time_Int_10 D_time_Int_9))))) (and (forall ((C_time_Int_6 Int) (not_C_start_time_Int_7 Int) (not_C_end_time_Int_8 Int)) (=> (and (set.member (tuple not_C_start_time_Int_7 not_C_end_time_Int_8) not_C) (set.member (tuple C_time_Int_6) C)) (not (and (<= C_time_Int_6 not_C_end_time_Int_8) (<= not_C_start_time_Int_7 C_time_Int_6))))) (and (forall ((B_time_Int_3 Int) (not_B_start_time_Int_4 Int) (not_B_end_time_Int_5 Int)) (=> (and (set.member (tuple not_B_start_time_Int_4 not_B_end_time_Int_5) not_B) (set.member (tuple B_time_Int_3) B)) (not (and (<= B_time_Int_3 not_B_end_time_Int_5) (<= not_B_start_time_Int_4 B_time_Int_3))))) (forall ((A_time_Int_0 Int) (not_A_start_time_Int_1 Int) (not_A_end_time_Int_2 Int)) (=> (and (set.member (tuple not_A_start_time_Int_1 not_A_end_time_Int_2) not_A) (set.member (tuple A_time_Int_0) A)) (not (and (<= A_time_Int_0 not_A_end_time_Int_2) (<= not_A_start_time_Int_1 A_time_Int_0)))))))))))) (set.all (lambda ((tuple_325 (Tuple Int Bool Int Bool Int Bool Int Bool))) (=> (= ((_ tuple.select 0) tuple_325) ((_ tuple.select 4) tuple_325)) (and (= ((_ tuple.select 3) tuple_325) ((_ tuple.select 7) tuple_325)) (and (= ((_ tuple.select 2) tuple_325) ((_ tuple.select 6) tuple_325)) (and (= ((_ tuple.select 1) tuple_325) ((_ tuple.select 5) tuple_325)) (= ((_ tuple.select 0) tuple_325) ((_ tuple.select 4) tuple_325))))))) (rel.product Measure Measure))))
(assert (=> (set.some (lambda ((tuple_285 (Tuple Int))) true) A) (and (set.some (lambda ((tuple_288 (Tuple Int))) (set.all (lambda ((tuple_289 (Tuple Int))) (<= ((_ tuple.select 0) tuple_289) ((_ tuple.select 0) tuple_288))) A)) A) (set.some (lambda ((tuple_286 (Tuple Int))) (set.all (lambda ((tuple_287 (Tuple Int))) (>= ((_ tuple.select 0) tuple_287) ((_ tuple.select 0) tuple_286))) A)) A))))
(assert (=> (set.some (lambda ((tuple_290 (Tuple Int))) true) B) (and (set.some (lambda ((tuple_293 (Tuple Int))) (set.all (lambda ((tuple_294 (Tuple Int))) (<= ((_ tuple.select 0) tuple_294) ((_ tuple.select 0) tuple_293))) B)) B) (set.some (lambda ((tuple_291 (Tuple Int))) (set.all (lambda ((tuple_292 (Tuple Int))) (>= ((_ tuple.select 0) tuple_292) ((_ tuple.select 0) tuple_291))) B)) B))))
(assert (=> (set.some (lambda ((tuple_295 (Tuple Int))) true) C) (and (set.some (lambda ((tuple_298 (Tuple Int))) (set.all (lambda ((tuple_299 (Tuple Int))) (<= ((_ tuple.select 0) tuple_299) ((_ tuple.select 0) tuple_298))) C)) C) (set.some (lambda ((tuple_296 (Tuple Int))) (set.all (lambda ((tuple_297 (Tuple Int))) (>= ((_ tuple.select 0) tuple_297) ((_ tuple.select 0) tuple_296))) C)) C))))
(assert (=> (set.some (lambda ((tuple_300 (Tuple Int))) true) D) (and (set.some (lambda ((tuple_303 (Tuple Int))) (set.all (lambda ((tuple_304 (Tuple Int))) (<= ((_ tuple.select 0) tuple_304) ((_ tuple.select 0) tuple_303))) D)) D) (set.some (lambda ((tuple_301 (Tuple Int))) (set.all (lambda ((tuple_302 (Tuple Int))) (>= ((_ tuple.select 0) tuple_302) ((_ tuple.select 0) tuple_301))) D)) D))))
(assert (=> (set.some (lambda ((tuple_305 (Tuple Int))) true) E) (and (set.some (lambda ((tuple_308 (Tuple Int))) (set.all (lambda ((tuple_309 (Tuple Int))) (<= ((_ tuple.select 0) tuple_309) ((_ tuple.select 0) tuple_308))) E)) E) (set.some (lambda ((tuple_306 (Tuple Int))) (set.all (lambda ((tuple_307 (Tuple Int))) (>= ((_ tuple.select 0) tuple_307) ((_ tuple.select 0) tuple_306))) E)) E))))
(assert (=> (set.some (lambda ((tuple_310 (Tuple Int))) true) F) (and (set.some (lambda ((tuple_313 (Tuple Int))) (set.all (lambda ((tuple_314 (Tuple Int))) (<= ((_ tuple.select 0) tuple_314) ((_ tuple.select 0) tuple_313))) F)) F) (set.some (lambda ((tuple_311 (Tuple Int))) (set.all (lambda ((tuple_312 (Tuple Int))) (>= ((_ tuple.select 0) tuple_312) ((_ tuple.select 0) tuple_311))) F)) F))))
(assert (=> (set.some (lambda ((tuple_315 (Tuple Int))) true) G) (and (set.some (lambda ((tuple_318 (Tuple Int))) (set.all (lambda ((tuple_319 (Tuple Int))) (<= ((_ tuple.select 0) tuple_319) ((_ tuple.select 0) tuple_318))) G)) G) (set.some (lambda ((tuple_316 (Tuple Int))) (set.all (lambda ((tuple_317 (Tuple Int))) (>= ((_ tuple.select 0) tuple_317) ((_ tuple.select 0) tuple_316))) G)) G))))
(assert (=> (set.some (lambda ((tuple_320 (Tuple Int))) true) H) (and (set.some (lambda ((tuple_323 (Tuple Int))) (set.all (lambda ((tuple_324 (Tuple Int))) (<= ((_ tuple.select 0) tuple_324) ((_ tuple.select 0) tuple_323))) H)) H) (set.some (lambda ((tuple_321 (Tuple Int))) (set.all (lambda ((tuple_322 (Tuple Int))) (>= ((_ tuple.select 0) tuple_322) ((_ tuple.select 0) tuple_321))) H)) H))))
