...
(assert (set.some (lambda ((tuple_180 (Tuple Int))) (set.some (lambda ((tuple_181 (Tuple Int Bool Int Bool))) (and (not (and (=> (and true (and (not ((_ tuple.select 1) tuple_181)) (and (not (> ((_ tuple.select 2) tuple_181) 2)) true))) (set.some (lambda ((tuple_182 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_182) (+ ((_ tuple.select 0) tuple_180) 0)) (<= ((_ tuple.select 0) tuple_182) (+ ((_ tuple.select 0) tuple_180) 5)))) F)) (and (=> (and ((_ tuple.select 1) tuple_181) (and (not (> ((_ tuple.select 2) tuple_181) 2)) true)) (set.some (lambda ((tuple_183 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_183) (+ ((_ tuple.select 0) tuple_180) 0)) (<= ((_ tuple.select 0) tuple_183) (+ ((_ tuple.select 0) tuple_180) 10)))) G)) (=> (and (> ((_ tuple.select 2) tuple_181) 2) true) (set.some (lambda ((tuple_185 (Tuple Int Int))) (and (= ((_ tuple.select 1) tuple_185) (+ ((_ tuple.select 0) tuple_180) 20)) (= ((_ tuple.select 0) tuple_185) (+ ((_ tuple.select 0) tuple_180) 0)))) not_G))))) (= ((_ tuple.select 0) tuple_180) ((_ tuple.select 0) tuple_181)))) Measure)) E))
