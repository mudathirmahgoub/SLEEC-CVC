...
(assert (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_258 (Tuple Int))) (not (= (as set.empty (Set (Tuple Int Bool Int Bool))) (set.filter (lambda ((tuple_259 (Tuple Int Bool Int Bool))) (and (not (not (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_260 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_260) (+ ((_ tuple.select 0) tuple_258) 0)) (<= ((_ tuple.select 0) tuple_260) (+ ((_ tuple.select 0) tuple_258) 0)))) F))))) (= ((_ tuple.select 0) tuple_258) ((_ tuple.select 0) tuple_259)))) Measure)))) H))))
