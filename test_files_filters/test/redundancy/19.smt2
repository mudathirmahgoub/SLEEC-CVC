...
(assert (set.some (lambda ((tuple_267 (Tuple Int))) (set.some (lambda ((tuple_268 (Tuple Int Bool Int Bool))) (and (not (set.some (lambda ((tuple_270 (Tuple Int Int))) (and (= ((_ tuple.select 1) tuple_270) (+ ((_ tuple.select 0) tuple_267) 0)) (= ((_ tuple.select 0) tuple_270) (+ ((_ tuple.select 0) tuple_267) 0)))) not_F)) (= ((_ tuple.select 0) tuple_267) ((_ tuple.select 0) tuple_268)))) Measure)) H))
