...
(assert (set.some (lambda ((tuple_256 (Tuple Int))) (set.some (lambda ((tuple_257 (Tuple Int Bool Int Bool))) (and (not (set.some (lambda ((tuple_258 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_258) (+ ((_ tuple.select 0) tuple_256) 0)) (<= ((_ tuple.select 0) tuple_258) (+ ((_ tuple.select 0) tuple_256) 10)))) F)) (= ((_ tuple.select 0) tuple_256) ((_ tuple.select 0) tuple_257)))) Measure)) H))
