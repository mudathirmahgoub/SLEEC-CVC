...
(assert (set.some (lambda ((tuple_245 (Tuple Int))) (set.some (lambda ((tuple_246 (Tuple Int Bool Int Bool))) (and (not (and (=> (and true (and (not ((_ tuple.select 3) tuple_246)) true)) (set.some (lambda ((tuple_247 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_247) (+ ((_ tuple.select 0) tuple_245) 0)) (<= ((_ tuple.select 0) tuple_247) (+ ((_ tuple.select 0) tuple_245) 5)))) G)) (=> (and ((_ tuple.select 3) tuple_246) true) (set.some (lambda ((tuple_248 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_248) (+ ((_ tuple.select 0) tuple_245) 0)) (<= ((_ tuple.select 0) tuple_248) (+ ((_ tuple.select 0) tuple_245) 10)))) H)))) (= ((_ tuple.select 0) tuple_245) ((_ tuple.select 0) tuple_246)))) Measure)) F))
