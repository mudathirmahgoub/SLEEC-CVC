...
(assert (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_222 (Tuple Int))) (not (= (as set.empty (Set (Tuple Int Bool Int Bool))) (set.filter (lambda ((tuple_223 (Tuple Int Bool Int Bool))) (and (and (not (and (=> (and true (and (not (> ((_ tuple.select 2) tuple_223) 1)) true)) (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_224 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_224) (+ ((_ tuple.select 0) tuple_222) 0)) (<= ((_ tuple.select 0) tuple_224) (+ ((_ tuple.select 0) tuple_222) 10)))) G)))) (=> (and (> ((_ tuple.select 2) tuple_223) 1) true) (not (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_225 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_225) (+ ((_ tuple.select 0) tuple_222) 0)) (<= ((_ tuple.select 0) tuple_225) (+ ((_ tuple.select 0) tuple_222) 10)))) G))))))) ((_ tuple.select 1) tuple_223)) (= ((_ tuple.select 0) tuple_222) ((_ tuple.select 0) tuple_223)))) Measure)))) E))))
