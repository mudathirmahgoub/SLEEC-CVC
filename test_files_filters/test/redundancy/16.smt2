...
(assert (set.some (lambda ((tuple_229 (Tuple Int))) (set.some (lambda ((tuple_230 (Tuple Int Bool Int Bool))) (and (and (not (and (=> (and true (and (not (> ((_ tuple.select 2) tuple_230) 1)) true)) (set.some (lambda ((tuple_231 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_231) (+ ((_ tuple.select 0) tuple_229) 0)) (<= ((_ tuple.select 0) tuple_231) (+ ((_ tuple.select 0) tuple_229) 10)))) G)) (=> (and (> ((_ tuple.select 2) tuple_230) 1) true) (set.some (lambda ((tuple_233 (Tuple Int Int))) (and (= ((_ tuple.select 1) tuple_233) (+ ((_ tuple.select 0) tuple_229) 10)) (= ((_ tuple.select 0) tuple_233) (+ ((_ tuple.select 0) tuple_229) 0)))) not_G)))) ((_ tuple.select 1) tuple_230)) (= ((_ tuple.select 0) tuple_229) ((_ tuple.select 0) tuple_230)))) Measure)) E))
