...
(assert (set.some (lambda ((tuple_195 (Tuple Int))) (set.some (lambda ((tuple_196 (Tuple Int Bool Int Bool))) (and (and (not (and (=> (and true (and (not (> ((_ tuple.select 2) tuple_196) 2)) true)) (set.some (lambda ((tuple_197 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_197) (+ ((_ tuple.select 0) tuple_195) 0)) (<= ((_ tuple.select 0) tuple_197) (+ ((_ tuple.select 0) tuple_195) 10)))) G)) (=> (and (> ((_ tuple.select 2) tuple_196) 2) true) (set.some (lambda ((tuple_199 (Tuple Int Int))) (and (= ((_ tuple.select 1) tuple_199) (+ ((_ tuple.select 0) tuple_195) 10)) (= ((_ tuple.select 0) tuple_199) (+ ((_ tuple.select 0) tuple_195) 0)))) not_G)))) ((_ tuple.select 1) tuple_196)) (= ((_ tuple.select 0) tuple_195) ((_ tuple.select 0) tuple_196)))) Measure)) E))
