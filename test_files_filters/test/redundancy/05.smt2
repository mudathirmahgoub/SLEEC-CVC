...
(assert (set.some (lambda ((tuple_64 (Tuple Int))) (set.some (lambda ((tuple_65 (Tuple Int Bool Int Bool))) (and (and (not (set.some (lambda ((tuple_66 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_66) (+ ((_ tuple.select 0) tuple_64) 0)) (<= ((_ tuple.select 0) tuple_66) (+ ((_ tuple.select 0) tuple_64) 0)))) C)) (> ((_ tuple.select 2) tuple_65) 50)) (= ((_ tuple.select 0) tuple_64) ((_ tuple.select 0) tuple_65)))) Measure)) A))
