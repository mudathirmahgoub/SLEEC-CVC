...
(assert (not (= (as set.empty (Set (Tuple Int Int Bool Int Bool Int))) (set.filter (lambda ((tuple_118 (Tuple Int Int Bool Int Bool Int))) (= ((_ tuple.select 0) tuple_118) ((_ tuple.select 1) tuple_118))) (rel.product UserFallen Measure)))))
