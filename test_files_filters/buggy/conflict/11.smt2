...
(assert (set.some (lambda ((tuple_159 (Tuple Int Int Bool Int Bool Int))) (and ((_ tuple.select 4) tuple_159) (= ((_ tuple.select 0) tuple_159) ((_ tuple.select 1) tuple_159)))) (rel.product UserFallen Measure)))
