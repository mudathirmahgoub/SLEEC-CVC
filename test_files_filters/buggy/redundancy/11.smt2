...
(assert (set.some (lambda ((tuple_155 (Tuple Int))) (set.some (lambda ((tuple_156 (Tuple Int Bool Int Bool Int))) (and (and (not (set.some (lambda ((tuple_158 (Tuple Int Int))) (and (= ((_ tuple.select 1) tuple_158) (+ ((_ tuple.select 0) tuple_155) 120)) (= ((_ tuple.select 0) tuple_158) (+ ((_ tuple.select 0) tuple_155) 0)))) not_SupportCalled)) ((_ tuple.select 3) tuple_156)) (= ((_ tuple.select 0) tuple_155) ((_ tuple.select 0) tuple_156)))) Measure)) UserFallen))
