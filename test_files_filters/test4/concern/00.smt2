...
(assert (set.some (lambda ((tuple_40 (Tuple Int))) (set.some (lambda ((tuple_41 (Tuple Int Int))) (and (set.some (lambda ((tuple_43 (Tuple Int Int))) (and (= ((_ tuple.select 1) tuple_43) (+ ((_ tuple.select 0) tuple_40) 30)) (= ((_ tuple.select 0) tuple_43) (+ ((_ tuple.select 0) tuple_40) 1)))) not_D) (= ((_ tuple.select 0) tuple_40) ((_ tuple.select 0) tuple_41)))) Measure)) C))
