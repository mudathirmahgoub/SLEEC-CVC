...
(assert (not (= (as set.empty (Set (Tuple Int Int Bool Int Bool))) (set.filter (lambda ((tuple_170 (Tuple Int Int Bool Int Bool))) (= ((_ tuple.select 0) tuple_170) ((_ tuple.select 1) tuple_170))) (rel.product C Measure)))))
