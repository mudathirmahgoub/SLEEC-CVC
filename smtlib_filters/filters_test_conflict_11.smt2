...
(assert (not (= (as set.empty (Set (Tuple Int Int Bool Int Bool))) (set.filter (lambda ((tuple_150 (Tuple Int Int Bool Int Bool))) (= ((_ tuple.select 0) tuple_150) ((_ tuple.select 1) tuple_150))) (rel.product C Measure)))))
