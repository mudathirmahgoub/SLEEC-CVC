...
(assert (not (= (as set.empty (Set (Tuple Int Int Bool Int Bool))) (set.filter (lambda ((tuple_241 (Tuple Int Int Bool Int Bool))) (= ((_ tuple.select 0) tuple_241) ((_ tuple.select 1) tuple_241))) (rel.product F Measure)))))
