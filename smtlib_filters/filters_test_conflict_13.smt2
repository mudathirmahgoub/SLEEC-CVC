...
(assert (not (= (as set.empty (Set (Tuple Int Int Bool Int Bool))) (set.filter (lambda ((tuple_184 (Tuple Int Int Bool Int Bool))) (= ((_ tuple.select 0) tuple_184) ((_ tuple.select 1) tuple_184))) (rel.product E Measure)))))
