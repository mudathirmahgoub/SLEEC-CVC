...
(assert (not (= (as set.empty (Set (Tuple Int Int Bool Int Bool))) (set.filter (lambda ((tuple_140 (Tuple Int Int Bool Int Bool))) (= ((_ tuple.select 0) tuple_140) ((_ tuple.select 1) tuple_140))) (rel.product C Measure)))))
