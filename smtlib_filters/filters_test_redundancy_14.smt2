...
(assert (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_192 (Tuple Int))) (not (= (as set.empty (Set (Tuple Int Bool Int Bool))) (set.filter (lambda ((tuple_193 (Tuple Int Bool Int Bool))) (and (and (not (and (=> (and true (and (not (> ((_ tuple.select 2) tuple_193) 2)) true)) (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_194 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_194) (+ ((_ tuple.select 0) tuple_192) 0)) (<= ((_ tuple.select 0) tuple_194) (+ ((_ tuple.select 0) tuple_192) 10)))) G)))) (=> (and (> ((_ tuple.select 2) tuple_193) 2) true) (not (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_195 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_195) (+ ((_ tuple.select 0) tuple_192) 0)) (<= ((_ tuple.select 0) tuple_195) (+ ((_ tuple.select 0) tuple_192) 10)))) G))))))) ((_ tuple.select 1) tuple_193)) (= ((_ tuple.select 0) tuple_192) ((_ tuple.select 0) tuple_193)))) Measure)))) E))))
