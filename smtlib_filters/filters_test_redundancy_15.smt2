...
(assert (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_207 (Tuple Int))) (not (= (as set.empty (Set (Tuple Int Bool Int Bool))) (set.filter (lambda ((tuple_208 (Tuple Int Bool Int Bool))) (and (and (not (and (=> (and true (and (not (> ((_ tuple.select 2) tuple_208) 3)) true)) (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_209 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_209) (+ ((_ tuple.select 0) tuple_207) 0)) (<= ((_ tuple.select 0) tuple_209) (+ ((_ tuple.select 0) tuple_207) 10)))) G)))) (=> (and (> ((_ tuple.select 2) tuple_208) 3) true) (not (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_210 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_210) (+ ((_ tuple.select 0) tuple_207) 0)) (<= ((_ tuple.select 0) tuple_210) (+ ((_ tuple.select 0) tuple_207) 10)))) G))))))) ((_ tuple.select 1) tuple_208)) (= ((_ tuple.select 0) tuple_207) ((_ tuple.select 0) tuple_208)))) Measure)))) E))))
