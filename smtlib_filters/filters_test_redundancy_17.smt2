...
(assert (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_237 (Tuple Int))) (not (= (as set.empty (Set (Tuple Int Bool Int Bool))) (set.filter (lambda ((tuple_238 (Tuple Int Bool Int Bool))) (and (not (and (=> (and true (and (not ((_ tuple.select 3) tuple_238)) true)) (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_239 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_239) (+ ((_ tuple.select 0) tuple_237) 0)) (<= ((_ tuple.select 0) tuple_239) (+ ((_ tuple.select 0) tuple_237) 5)))) G)))) (=> (and ((_ tuple.select 3) tuple_238) true) (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_240 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_240) (+ ((_ tuple.select 0) tuple_237) 0)) (<= ((_ tuple.select 0) tuple_240) (+ ((_ tuple.select 0) tuple_237) 10)))) H)))))) (= ((_ tuple.select 0) tuple_237) ((_ tuple.select 0) tuple_238)))) Measure)))) F))))
