...
(assert (not (= (as set.empty (Set (Tuple Int Int Bool Int Bool))) (set.filter (lambda ((tuple_122 (Tuple Int Int Bool Int Bool))) (= ((_ tuple.select 0) tuple_122) ((_ tuple.select 1) tuple_122))) (rel.product C Measure)))))
