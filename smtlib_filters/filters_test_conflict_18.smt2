...
(assert (not (= (as set.empty (Set (Tuple Int Int Bool Int Bool))) (set.filter (lambda ((tuple_251 (Tuple Int Int Bool Int Bool))) (= ((_ tuple.select 0) tuple_251) ((_ tuple.select 1) tuple_251))) (rel.product H Measure)))))
