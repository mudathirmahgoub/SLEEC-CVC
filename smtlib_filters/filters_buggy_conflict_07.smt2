...
(assert (not (= (as set.empty (Set (Tuple Int Int Bool Int Bool Int))) (set.filter (lambda ((tuple_108 (Tuple Int Int Bool Int Bool Int))) (= ((_ tuple.select 0) tuple_108) ((_ tuple.select 1) tuple_108))) (rel.product CurtainOpenRqt Measure)))))
