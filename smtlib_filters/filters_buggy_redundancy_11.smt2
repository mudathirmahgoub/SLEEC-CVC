...
(assert (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_154 (Tuple Int))) (not (= (as set.empty (Set (Tuple Int Bool Int Bool Int))) (set.filter (lambda ((tuple_155 (Tuple Int Bool Int Bool Int))) (and (and (not (not (not (= (as set.empty (Set (Tuple Int))) (set.filter (lambda ((tuple_156 (Tuple Int))) (and (>= ((_ tuple.select 0) tuple_156) (+ ((_ tuple.select 0) tuple_154) 0)) (<= ((_ tuple.select 0) tuple_156) (+ ((_ tuple.select 0) tuple_154) 120)))) SupportCalled))))) ((_ tuple.select 3) tuple_155)) (= ((_ tuple.select 0) tuple_154) ((_ tuple.select 0) tuple_155)))) Measure)))) UserFallen))))
